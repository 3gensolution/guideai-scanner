var Ba=Object.defineProperty;var Oa=(k,U,Q)=>U in k?Ba(k,U,{enumerable:!0,configurable:!0,writable:!0,value:Q}):k[U]=Q;var x=(k,U,Q)=>Oa(k,typeof U!="symbol"?U+"":U,Q);(function(){"use strict";const k={cdnUrl:"https://cdn.jsdelivr.net/gh/3gensolution/guideai-scanner@cdn-v0.1.0/cdn/guideai.js",apiUrl:"https://api.3guideai.com",idleTimeout:2e4,sessionTimeoutMs:18e5,geolocationMode:"off",chipDismissSeconds:300,batchSize:50,batchIntervalMs:3e4,bubblePosition:"bottom-right",bubbleLabelText:"Help",bubbleIcon:"robot",bubbleImageUrl:"",bubbleDrift:{spring:.005,damping:.92,minTargetInterval:4e3,maxTargetInterval:8e3,enabled:!0},bubbleMode:"drift",bubbleCrawl:{speed:40,climbWalls:!0,cornerPauseMs:1500,persistentSpeech:!0,messages:["Need help? Click me!","I can guide you around.","Try asking me anything!"],messageIntervalMs:8e3},widgetMode:"guide",theme:{},feedbackPromptDelayMs:3e4,feedbackPromptMinPageViews:2,announcementSurface:"modal"};function U(n){const e=n.getAttribute("data-site-id")??"",t=n.getAttribute("data-token")??"";if(!e||!t)throw new Error("[GuideAI] Missing required data-site-id or data-token on script tag.");return{siteId:e,token:t,cdnUrl:n.getAttribute("data-cdn-url")??k.cdnUrl,apiUrl:n.getAttribute("data-api-url")??k.apiUrl,idleTimeout:parseInt(n.getAttribute("data-idle-timeout")??"",10)||k.idleTimeout,sessionTimeoutMs:parseInt(n.getAttribute("data-session-timeout-ms")??"",10)||k.sessionTimeoutMs,geolocationMode:n.getAttribute("data-geolocation")??k.geolocationMode,chipDismissSeconds:parseInt(n.getAttribute("data-chip-dismiss-seconds")??"",10)||k.chipDismissSeconds,batchSize:parseInt(n.getAttribute("data-batch-size")??"",10)||k.batchSize,batchIntervalMs:parseInt(n.getAttribute("data-batch-interval-ms")??"",10)||k.batchIntervalMs,autoAdvanceOnTargetClick:n.getAttribute("data-auto-advance-on-target-click")!=="false",guidesEnabled:n.getAttribute("data-guides-enabled")!=="false",bubbleEnabled:n.getAttribute("data-bubble-enabled")!=="false",bubblePosition:n.getAttribute("data-bubble-position")??k.bubblePosition,bubbleLabelText:n.getAttribute("data-bubble-label")??k.bubbleLabelText,bubbleIcon:n.getAttribute("data-bubble-icon")??k.bubbleIcon,bubbleImageUrl:n.getAttribute("data-bubble-image")??k.bubbleImageUrl,bubbleDrift:{...k.bubbleDrift},bubbleMode:n.getAttribute("data-bubble-mode")??k.bubbleMode,bubbleCrawl:{...k.bubbleCrawl},widgetMode:n.getAttribute("data-widget-mode")??k.widgetMode,theme:{...k.theme},recordingEnabled:n.getAttribute("data-recording")==="true",feedbackAutoPromptEnabled:n.getAttribute("data-feedback-auto-prompt")!=="false",feedbackPromptDelayMs:parseInt(n.getAttribute("data-feedback-prompt-delay-ms")??"",10)||k.feedbackPromptDelayMs,feedbackPromptMinPageViews:parseInt(n.getAttribute("data-feedback-prompt-min-pageviews")??"",10)||k.feedbackPromptMinPageViews,extensionMode:n.getAttribute("data-extension-mode")==="true",announcementSurface:n.getAttribute("data-announcement-surface")??k.announcementSurface,announcementCloseOnBackdrop:n.getAttribute("data-announcement-close-on-backdrop")!=="false"}}class Q{constructor(e,t){this.crypto=null,this.baseUrl=e.replace(/\/+$/,""),this.token=t}setCryptoManager(e){this.crypto=e}headers(){return{"Content-Type":"application/json","X-API-Key":this.token}}async get(e){const t=`${this.baseUrl}${e}`,i=await fetch(t,{method:"GET",headers:this.headers()});if(!i.ok)throw new Error(`[GuideAI] GET ${e} failed: ${i.status}`);return i.json()}async post(e,t){var o;const i=`${this.baseUrl}${e}`;let r;if(t!==void 0&&((o=this.crypto)!=null&&o.isReady())){const a=this.crypto.encrypt(t);r=JSON.stringify(a||t)}else t!==void 0&&(r=JSON.stringify(t));const s=await fetch(i,{method:"POST",headers:this.headers(),body:r});if(!s.ok)throw new Error(`[GuideAI] POST ${e} failed: ${s.status}`);return s.json()}postKeepalive(e,t){var s;const i=`${this.baseUrl}${e}`;let r;if((s=this.crypto)!=null&&s.isReady()){const o=this.crypto.encrypt(t);r=JSON.stringify(o||t)}else r=JSON.stringify(t);try{fetch(i,{method:"POST",headers:this.headers(),body:r,keepalive:!0})}catch{}}}const bt="guideai-kb-v1";class Li{constructor(){this.cacheAvailable=typeof caches<"u"}async get(e){if(!this.cacheAvailable)return null;try{return await(await caches.open(bt)).match(e)??null}catch{return null}}async put(e,t){if(this.cacheAvailable)try{await(await caches.open(bt)).put(e,t.clone())}catch{}}async getOrFetch(e,t){const i=await this.get(e),r=async()=>{try{const s=await fetch(e,{method:"GET",headers:t});return s.ok?(await this.put(e,s.clone()),s):null}catch{return null}};return i?(r(),i):r()}}class Ii{constructor(e,t,i){this.bubbleSettings=null,this.helpSupportEnabled=!1,this.widgetMode=null,this.bubbleMode=null,this.url=`${e.replace(/\/+$/,"")}/cdn/knowledge-base/${t}`,this.token=i,this.cache=new Li}async load(){try{const e={Accept:"application/json","X-API-Key":this.token},t=await this.cache.getOrFetch(this.url,e);if(!t)return null;const i=await t.json();return i.bubble_settings&&typeof i.bubble_settings=="object"&&(this.bubbleSettings=i.bubble_settings,(this.bubbleSettings.mode==="crawl"||this.bubbleSettings.mode==="drift")&&(this.bubbleMode=this.bubbleSettings.mode)),i.help_support_enabled&&(this.helpSupportEnabled=!0),i.widget_mode&&["guide","support","combined"].includes(i.widget_mode)&&(this.widgetMode=i.widget_mode),this.normalize(i)}catch(e){return typeof console<"u"&&console.warn("[GuideAI] Failed to load knowledge base:",e),null}}normalize(e){const t=e.elements??[],i=e.routes??[];return{id:e.id??"",site_id:e.site_id??"",version:e.version??1,framework:e.framework??"",scanned_at:e.scanned_at??"",routes:i.map(r=>({path:r.path??"",page_title:r.page_title,component_name:r.component_name,source_file:r.source_file,dynamic_segments:r.dynamic_segments??[],auth_required:r.auth_required??!1,headings:r.headings??[]})),elements:t.map((r,s)=>{var o,a,l,c;return{id:r.id??`el_${s}`,route_path:r.route_path??r.route??"",tag:r.tag??"",text:r.text,aria_label:r.aria_label,placeholder:(o=r.attributes)==null?void 0:o.placeholder,name:(a=r.attributes)==null?void 0:a.name,data_guideai:(l=r.attributes)==null?void 0:l["data-guideai"],data_testid:(c=r.attributes)==null?void 0:c["data-testid"],fingerprint:r.fingerprint??{tier1_stable:{score:0},tier2_text:{variants:[],score:0},tier3_structural:{tag:r.tag??"",dom_depth:0,score:0},tier4_context:{score:0},tier5_position:{score:0},total_score:0}}})}}}class Mi{constructor(e,t,i){this.queue=[],this.flushTimer=null,this.unloadHandler=null,this.visibilityHandler=null,this.sender=e,this.batchSize=t,this.batchIntervalMs=i,this.flushTimer=setInterval(()=>this.flush(),this.batchIntervalMs),this.unloadHandler=()=>this.flushBeacon(),window.addEventListener("beforeunload",this.unloadHandler),this.visibilityHandler=()=>{document.visibilityState==="hidden"&&this.flushBeacon()},document.addEventListener("visibilitychange",this.visibilityHandler)}push(e){this.queue.push(e),this.queue.length>=this.batchSize&&this.flush()}flush(){if(this.queue.length===0)return;const e=this.queue.splice(0);this.sender.send(e).catch(()=>{this.queue.unshift(...e)})}flushBeacon(){if(this.queue.length===0)return;const e=this.queue.splice(0);this.sender.sendKeepalive(e)}destroy(){this.flushTimer&&(clearInterval(this.flushTimer),this.flushTimer=null),this.unloadHandler&&(window.removeEventListener("beforeunload",this.unloadHandler),this.unloadHandler=null),this.visibilityHandler&&(document.removeEventListener("visibilitychange",this.visibilityHandler),this.visibilityHandler=null)}}const ue="[REDACTED]",Pi=[{regex:/\b\d{4}[\s-]?\d{4}[\s-]?\d{4}[\s-]?\d{1,7}\b/g,replacement:ue},{regex:/\b\d{3}-\d{2}-\d{4}\b/g,replacement:ue},{regex:/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b/g,replacement:ue},{regex:/\b\+?1?[-.\s]?\(?\d{3}\)?[-.\s]?\d{3}[-.\s]?\d{4}\b/g,replacement:ue}],Ri=["password","passwd","secret","token","api_key","apikey","api-key","credit_card","card_number","card-number","cvv","cvc","ccv","ssn","social_security","pin"],Hi=new Set(["email","full_name","name","phone"]);function yt(n){if(!n)return n;let e=n;for(const{regex:t,replacement:i}of Pi)e=e.replace(t,i);return e}function he(n){const e={...n};for(const t of Object.keys(e)){const i=t.toLowerCase();if(Ri.some(s=>i.includes(s))){e[t]=ue;continue}const r=e[t];typeof r=="string"?Hi.has(i)?e[t]=r:e[t]=yt(r):Array.isArray(r)?e[t]=r.map(s=>typeof s=="string"?yt(s):s&&typeof s=="object"&&!Array.isArray(s)?he(s):s):r&&typeof r=="object"&&!Array.isArray(r)&&(e[t]=he(r))}return e}const Ni="guideai_anon_id_";function $i(n){const e=Ni+n;try{let t=localStorage.getItem(e);return t||(t=vt(),localStorage.setItem(e,t)),t}catch{return vt()}}function vt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16)})}function Di(n){const e=navigator.userAgent||"",{browser:t,version:i}=Bi(e),r=Oi(e),s=zi(),o=`guideai_visits_${n}`,a=`guideai_first_visit_${n}`;let l=1,c=!1,d;try{const g=localStorage.getItem(o);g&&(l=(parseInt(g,10)||0)+1,c=!0),localStorage.setItem(o,String(l)),d=localStorage.getItem(a)||void 0,d||(d=new Date().toISOString(),localStorage.setItem(a,d))}catch{}let u,h,p;try{const g=navigator;g.connection&&(u=g.connection.effectiveType,h=g.connection.downlink,p=g.connection.rtt)}catch{}let m="";try{m=Intl.DateTimeFormat().resolvedOptions().timeZone}catch{}const f=Fi();return{browser:t,browser_version:i,os:r,device_type:s,screen_width:screen.width||0,screen_height:screen.height||0,viewport_width:window.innerWidth||0,viewport_height:window.innerHeight||0,pixel_ratio:window.devicePixelRatio||1,device_memory:navigator.deviceMemory,hardware_concurrency:navigator.hardwareConcurrency,touch_capable:"ontouchstart"in window||navigator.maxTouchPoints>0,connection_type:u,connection_downlink:h,connection_rtt:p,timezone:m,language:navigator.language||"",languages:Array.from(navigator.languages||[]),is_returning:c,session_number:l,first_visit_at:d,referrer:document.referrer||"",entry_url:location.href,platform_hints:f}}function Bi(n){const e=[["Edge",/Edg[e/](\d+[\d.]*)/],["Opera",/OPR\/(\d+[\d.]*)/],["Chrome",/Chrome\/(\d+[\d.]*)/],["Firefox",/Firefox\/(\d+[\d.]*)/],["Safari",/Version\/(\d+[\d.]*).*Safari/],["IE",/(?:MSIE |Trident.*rv:)(\d+[\d.]*)/]];for(const[t,i]of e){const r=n.match(i);if(r)return{browser:t,version:r[1]}}return{browser:"Unknown",version:""}}function Oi(n){return/Windows/.test(n)?"Windows":/Mac OS X|macOS/.test(n)?"macOS":/CrOS/.test(n)?"ChromeOS":/Linux/.test(n)?"Linux":/Android/.test(n)?"Android":/iPhone|iPad|iPod/.test(n)?"iOS":"Unknown"}function zi(){const n=navigator.userAgent||"",e=navigator.maxTouchPoints||0,t=screen.width||window.innerWidth;return/iPhone|iPod|Android.*Mobile|webOS|BlackBerry|Opera Mini/i.test(n)?"mobile":/iPad|Android(?!.*Mobile)|Tablet/i.test(n)||e>0&&t>=768?"tablet":(e===0||t>1024,"desktop")}function Fi(){const n=[],e=window;try{(e.ethereum||e.web3||e.solana||e.phantom)&&n.push("web3"),e.M&&typeof e.M=="object"&&e.M.cfg&&n.push("moodle"),(e.$A||e.sforce||document.querySelector("lightning-app, force-aloha-page"))&&n.push("salesforce"),(document.querySelector("[data-reactroot], [data-reactid]")||e.__REACT_DEVTOOLS_GLOBAL_HOOK__)&&n.push("react"),(document.querySelector("[ng-app], [data-ng-app], [ng-version]")||e.ng)&&n.push("angular"),(document.querySelector("[data-v-]")||e.__VUE__)&&n.push("vue"),(e.wp||document.querySelector('meta[name="generator"][content*="WordPress"]'))&&n.push("wordpress"),e.Shopify&&n.push("shopify"),e.matchMedia&&e.matchMedia("(display-mode: standalone)").matches&&n.push("pwa")}catch{}return n}const xt="guideai_session_";function ae(){return new Date().toISOString()}function wt(n){if(!n)return null;try{const e=JSON.parse(n);if(e&&typeof e.id=="string"&&typeof e.last_seen_at=="string")return{id:e.id,started_at:typeof e.started_at=="string"?e.started_at:e.last_seen_at,last_seen_at:e.last_seen_at}}catch{return{id:n,started_at:ae(),last_seen_at:ae()}}return null}function kt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16)})}function Gi(n,e){const t=Date.parse(n.last_seen_at);return Number.isFinite(t)?Date.now()-t>e:!0}function qi(n,e){const t=xt+n;try{const i=wt(sessionStorage.getItem(t));if(i&&!Gi(i,e)){const s={...i,last_seen_at:ae()};return sessionStorage.setItem(t,JSON.stringify(s)),{id:s.id,isNew:!1}}const r={id:kt(),started_at:ae(),last_seen_at:ae()};return sessionStorage.setItem(t,JSON.stringify(r)),{id:r.id,isNew:!0}}catch{return{id:kt(),isNew:!0}}}function Ui(n){const e=xt+n;try{const t=wt(sessionStorage.getItem(e));if(!t)return;sessionStorage.setItem(e,JSON.stringify({...t,last_seen_at:ae()}))}catch{}}const _t="guideai_geo_",Vi=1440*6e4;function Et(){return new Date().toISOString()}function Wi(n){if(!n)return!1;const e=Date.parse(n);return Number.isFinite(e)?Date.now()-e<Vi:!1}function St(n){try{const e=sessionStorage.getItem(_t+n);if(!e)return null;const t=JSON.parse(e);return typeof t.geo_lat!="number"||typeof t.geo_lng!="number"||!Wi(t.geo_captured_at)?null:{geo_lat:t.geo_lat,geo_lng:t.geo_lng,geo_accuracy_m:typeof t.geo_accuracy_m=="number"?t.geo_accuracy_m:void 0,geo_captured_at:t.geo_captured_at??Et(),geo_source:"browser"}}catch{return null}}function ji(n,e){try{sessionStorage.setItem(_t+n,JSON.stringify(e))}catch{}}async function Ki(){try{const n=navigator.permissions;return n!=null&&n.query?(await n.query({name:"geolocation"})).state??"unknown":"unknown"}catch{return"unknown"}}function Yi(n=2e3){return new Promise((e,t)=>{if(!navigator.geolocation)return t(new Error("Geolocation unavailable"));navigator.geolocation.getCurrentPosition(e,t,{enableHighAccuracy:!1,timeout:n,maximumAge:10*6e4})})}async function Xi(n,e){if(e==="off")return null;const t=St(n);if(t)return t;if(!navigator.geolocation)return null;const i=await Ki();if(e==="granted-only"&&i!=="granted"||i==="denied")return null;try{const r=await Yi(),s={geo_lat:r.coords.latitude,geo_lng:r.coords.longitude,geo_accuracy_m:r.coords.accuracy,geo_captured_at:Et(),geo_source:"browser"};return ji(n,s),s}catch{return null}}const O=160,Ji=200,_e=180;function Qi(){const n=location.pathname||"/",e=location.search||"",t=location.hash||"";return{page_title:I(document.title,O)||void 0,pathname:n,search:e||void 0,hash:t||void 0,url_origin:location.origin||void 0,url_host:location.host||void 0,referrer_host:Zi(),viewport_width:window.innerWidth||void 0,viewport_height:window.innerHeight||void 0,screen_width:screen.width||void 0,screen_height:screen.height||void 0,scroll_x:Math.round(window.scrollX||0),scroll_y:Math.round(window.scrollY||0),document_lang:document.documentElement.lang||void 0,platform_hints:er()}}function le(n){if(!n||!(n instanceof Element))return{};const e=n,i=tr(e)||e,r=i.closest("form");return{element_text:I(ir(i),O)||void 0,element_tag:i.tagName.toLowerCase(),metadata:dr({element_id:i.id||void 0,element_class:lr(i.className),element_role:i.getAttribute("role")||void 0,element_href:ar(i),element_name:i.getAttribute("name")||void 0,element_type:i.getAttribute("type")||void 0,element_aria_label:I(i.getAttribute("aria-label")||"",O)||void 0,element_placeholder:I(i.getAttribute("placeholder")||"",O)||void 0,element_data_guideai:i.getAttribute("data-guideai")||void 0,element_data_testid:i.getAttribute("data-testid")||i.getAttribute("data-test-id")||void 0,element_selector_hint:cr(i),parent_text:I(rr(i),O)||void 0,nearest_heading:I(nr(i),O)||void 0,section_title:I(sr(i),O)||void 0,form_id:(r==null?void 0:r.id)||void 0,form_name:(r==null?void 0:r.getAttribute("name"))||void 0,form_action:Ct((r==null?void 0:r.getAttribute("action"))||""),input_label:I(or(i),O)||void 0})}}function Zi(){if(document.referrer)try{return new URL(document.referrer).host||void 0}catch{return}}function er(){const n=[],e=window;try{(e.ethereum||e.web3||e.solana||e.phantom)&&n.push("web3"),e.M&&typeof e.M=="object"&&e.M.cfg&&n.push("moodle"),(e.$A||e.sforce||document.querySelector("lightning-app, force-aloha-page"))&&n.push("salesforce"),(e.__REACT_DEVTOOLS_GLOBAL_HOOK__||document.querySelector("[data-reactroot], [data-reactid]"))&&n.push("react"),(e.ng||document.querySelector("[ng-app], [data-ng-app], [ng-version]"))&&n.push("angular"),(e.__VUE__||document.querySelector("[data-v-]"))&&n.push("vue"),e.Shopify&&n.push("shopify"),(e.wp||document.querySelector('meta[name="generator"][content*="WordPress"]'))&&n.push("wordpress")}catch{return[]}return n.slice(0,6)}function tr(n){let e=n;for(let t=0;e&&t<5;t++){const i=e.tagName.toLowerCase(),r=e.getAttribute("role");if(["a","button","input","select","textarea","summary"].includes(i)||r==="button"||r==="link"||r==="tab"||r==="menuitem"||e.onclick||e.getAttribute("tabindex")!==null)return e;e=e.parentElement}return null}function ir(n){return(n.getAttribute("aria-label")||n.getAttribute("placeholder")||n.innerText||n.textContent||"").trim().replace(/\s+/g," ")}function rr(n){const e=n.parentElement;return!e||e===document.body?"":(e.textContent||"").trim().replace(/\s+/g," ")}function nr(n){var r,s;let e=n;for(let o=0;e&&o<5;o++){const a=e.querySelector(":scope > h1, :scope > h2, :scope > h3, :scope > h4, :scope > h5, :scope > h6");if((r=a==null?void 0:a.textContent)!=null&&r.trim())return a.textContent.trim().replace(/\s+/g," ");e=e.parentElement}const t=n.closest('section, article, [role="region"], [role="tabpanel"]'),i=t==null?void 0:t.querySelector("h1, h2, h3, h4, h5, h6");return((s=i==null?void 0:i.textContent)==null?void 0:s.trim().replace(/\s+/g," "))||""}function sr(n){var i;const e=n.closest('section, article, aside, nav, [role="region"], [role="tabpanel"], [class*="card"], [class*="panel"]');if(!e)return"";const t=e.querySelector('h1, h2, h3, h4, h5, h6, [role="heading"], .card-title, .section-title, strong');return((i=t==null?void 0:t.textContent)==null?void 0:i.trim().replace(/\s+/g," "))||e.getAttribute("aria-label")||""}function or(n){var t,i;if(n.id)try{const r=document.querySelector(`label[for="${CSS.escape(n.id)}"]`);if((t=r==null?void 0:r.textContent)!=null&&t.trim())return r.textContent.trim().replace(/\s+/g," ")}catch{}const e=n.closest("label");return e&&e!==n&&((i=e.textContent)!=null&&i.trim())?e.textContent.trim().replace(/\s+/g," "):""}function ar(n){const e=n.href||n.getAttribute("href")||"";if(e)return Ct(e)||void 0}function Ct(n){if(n)try{const e=new URL(n,location.origin);return`${e.pathname}${e.search}${e.hash}`.slice(0,O)}catch{return I(n,O)||void 0}}function lr(n){if(n)return I(n.split(/\s+/).filter(Boolean).slice(0,4).join(" "),Ji)||void 0}function cr(n){const e=n.getAttribute("data-guideai");if(e)return`[data-guideai="${e}"]`;const t=n.getAttribute("data-testid")||n.getAttribute("data-test-id");if(t)return`[data-testid="${t}"]`;if(n.id)return`#${n.id}`;const i=n.getAttribute("name");if(i)return I(`${n.tagName.toLowerCase()}[name="${i}"]`,_e)||void 0;const r=n.tagName.toLowerCase(),s=n.getAttribute("role");if(s)return I(`${r}[role="${s}"]`,_e)||void 0;if(r==="a"){const o=n.getAttribute("href");if(o)return I(`a[href="${o}"]`,_e)||void 0}return I(r,_e)||void 0}function dr(n){return Object.fromEntries(Object.entries(n).filter(([,e])=>e==null?!1:typeof e=="string"?e.trim().length>0:Array.isArray(e)?e.length>0:!0))}function I(n,e){const t=n.trim().replace(/\s+/g," ");return t.length<=e?t:t.slice(0,e)}const Tt="/api/v1/events";class ur{constructor(e,t,i){this.api=e,this.siteId=t,this.sessionId=i}async send(e){if(e.length===0)return;const i=e.map(r=>this.enrich(r)).map(r=>he(r));try{await this.api.post(Tt,{events:i})}catch(r){typeof console<"u"&&console.warn("[GuideAI] Failed to send events:",r)}}sendKeepalive(e){if(e.length===0)return;const i=e.map(r=>this.enrich(r)).map(r=>he(r));this.api.postKeepalive(Tt,{events:i})}prepareForEncrypt(e){return e.map(i=>this.enrich(i)).map(i=>he(i))}enrich(e){var o;Ui(this.siteId);let t=e.user_id;if(!t)try{t=sessionStorage.getItem(`guideai_user_id_${this.siteId}`)||void 0}catch{}let i;try{const a=sessionStorage.getItem(`guideai_account_${this.siteId}`);a&&(i=(o=JSON.parse(a))==null?void 0:o.id)}catch{}const r=St(this.siteId)??void 0,s={...Qi(),...e.metadata,...i?{account_id:i}:{},...r||{}};return{site_id:this.siteId,session_id:this.sessionId,anonymous_id:e.anonymous_id??$i(this.siteId),event_type:"click",url:location.href,timestamp:new Date().toISOString(),...e,...t?{user_id:t}:{},metadata:s}}}const hr=3,At=500;class gr{constructor(e){this.clickMap=new WeakMap,this.handler=null,this.callback=e}start(){this.handler=e=>{e.target&&this.trackClick(e)},document.addEventListener("click",this.handler,{capture:!0,passive:!0})}destroy(){this.handler&&(document.removeEventListener("click",this.handler,{capture:!0}),this.handler=null)}trackClick(e){const t=e.target,i=Date.now();let r=this.clickMap.get(t);r||(r={timestamps:[]},this.clickMap.set(t,r)),r.timestamps.push(i),r.timestamps=r.timestamps.filter(s=>i-s<=At),r.timestamps.length>=hr&&(this.fireRageClick(t,r.timestamps.length),r.timestamps=[],document.dispatchEvent(new CustomEvent("guideai:frustration")))}fireRageClick(e,t){const i=le(e),r="metadata"in i?i.metadata:{};this.callback({event_type:"rage_click",url:location.href,element_text:i.element_text||this.truncate(e.innerText??e.textContent??"",100),element_tag:i.element_tag||e.tagName.toLowerCase(),click_count:t,timestamp:new Date().toISOString(),metadata:{...r,rage_window_ms:At}})}truncate(e,t){return e.length>t?e.slice(0,t):e}}const Lt=300;class pr{constructor(e){this.handler=null,this.callback=e}start(){this.handler=e=>{e.target&&this.checkClick(e)},document.addEventListener("click",this.handler,{capture:!0,passive:!0})}destroy(){this.handler&&(document.removeEventListener("click",this.handler,{capture:!0}),this.handler=null)}checkClick(e){const t=e.target,i=t.tagName.toLowerCase();if(["html","body"].includes(i)||!(i==="a"||i==="button"||i==="input"||i==="select"||i==="textarea"||t.getAttribute("role")==="button"||t.getAttribute("role")==="link"||t.getAttribute("tabindex")!==null||t.onclick!==null||t.closest('a, button, [role="button"]')!==null))return;const s=location.href;let o=!1;const a=new MutationObserver(()=>{o=!0});a.observe(document.body,{childList:!0,subtree:!0,attributes:!0,characterData:!0}),setTimeout(()=>{a.disconnect();const l=location.href,c=s!==l,d=document.querySelector('[role="dialog"]')!==null||document.querySelector('[role="alertdialog"]')!==null||document.querySelector(".modal.show, .modal.active, dialog[open]")!==null;!o&&!c&&!d&&this.fireDeadClick(t)},Lt)}fireDeadClick(e){const t=le(e),i="metadata"in t?t.metadata:{};this.callback({event_type:"dead_click",url:location.href,element_text:t.element_text||this.truncate(e.innerText??e.textContent??"",100),element_tag:t.element_tag||e.tagName.toLowerCase(),had_response:!1,timestamp:new Date().toISOString(),metadata:{...i,observation_window_ms:Lt}}),document.dispatchEvent(new CustomEvent("guideai:frustration"))}truncate(e,t){return e.length>t?e.slice(0,t):e}}const Oe=[".error",".field-error",".form-error",".invalid-feedback",".validation-error",".has-error",'[role="alert"]','[aria-invalid="true"]'].join(",");class fr{constructor(e){this.observer=null,this.existingErrors=new Set,this.debounceTimer=null,this.pendingErrors=[],this.callback=e}start(){this.snapshotExisting(),this.observer=new MutationObserver(e=>{for(const t of e){if(t.type==="childList")for(let i=0;i<t.addedNodes.length;i++){const r=t.addedNodes[i];r.nodeType===Node.ELEMENT_NODE&&this.checkElement(r)}t.type==="attributes"&&t.target.nodeType===Node.ELEMENT_NODE&&this.checkElement(t.target)}}),this.observer.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","role","aria-invalid"]})}destroy(){this.observer&&(this.observer.disconnect(),this.observer=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null),this.existingErrors.clear(),this.pendingErrors=[]}snapshotExisting(){const e=document.querySelectorAll(Oe);for(let t=0;t<e.length;t++)this.existingErrors.add(e[t])}checkElement(e){if(this.existingErrors.has(e))return;const t=e.matches(Oe);let i=[];t&&i.push(e);const r=e.querySelectorAll(Oe);for(let s=0;s<r.length;s++)this.existingErrors.has(r[s])||i.push(r[s]);i.length!==0&&(this.pendingErrors.push(...i),this.scheduleFlush())}scheduleFlush(){this.debounceTimer||(this.debounceTimer=setTimeout(()=>{this.flushErrors(),this.debounceTimer=null},100))}flushErrors(){if(this.pendingErrors.length===0)return;const e=new Set(this.pendingErrors);this.pendingErrors=[];for(const t of e){this.existingErrors.add(t);const i=t.innerText??t.textContent??"",r=t.closest("form"),s=le(t),o="metadata"in s?s.metadata:{};this.callback({event_type:"form_error",url:location.href,element_text:s.element_text||this.truncate(i,200),element_tag:s.element_tag||t.tagName.toLowerCase(),timestamp:new Date().toISOString(),metadata:{...o,form_name:(r==null?void 0:r.getAttribute("name"))??(r==null?void 0:r.id)??void 0,error_class:t.className}})}document.dispatchEvent(new CustomEvent("guideai:frustration"))}truncate(e,t){return e.length>t?e.slice(0,t):e}}class mr{constructor(e){this.enrichers={},this.popstateHandler=null,this.hashchangeHandler=null,this.origPushState=null,this.origReplaceState=null,this.destroyed=!1,this.callback=e,this.currentUrl=location.href,this.pageEnteredAt=Date.now()}setEnrichers(e){this.enrichers=e}start(){this.origPushState=history.pushState.bind(history),history.pushState=(...e)=>{this.origPushState(...e),this.onUrlChange("push")},this.origReplaceState=history.replaceState.bind(history),history.replaceState=(...e)=>{this.origReplaceState(...e),this.onUrlChange("replace")},this.popstateHandler=()=>this.onUrlChange("popstate"),window.addEventListener("popstate",this.popstateHandler),this.hashchangeHandler=()=>this.onUrlChange("hash"),window.addEventListener("hashchange",this.hashchangeHandler)}destroy(){this.destroyed=!0,this.origPushState&&(history.pushState=this.origPushState),this.origReplaceState&&(history.replaceState=this.origReplaceState),this.popstateHandler&&(window.removeEventListener("popstate",this.popstateHandler),this.popstateHandler=null),this.hashchangeHandler&&(window.removeEventListener("hashchange",this.hashchangeHandler),this.hashchangeHandler=null)}firePageExit(){this.emitPageExit("unload")}onUrlChange(e){var r,s;if(this.destroyed)return;const t=location.href;if(t===this.currentUrl)return;const i=this.currentUrl;this.emitPageExit(e),(s=(r=this.enrichers).resetPageMetrics)==null||s.call(r),this.currentUrl=t,this.pageEnteredAt=Date.now(),this.callback({event_type:"page_view",url:t,previous_url:i,timestamp:new Date().toISOString(),metadata:{navigation_type:e,page_title:document.title}})}emitPageExit(e){const i={time_on_page_ms:Date.now()-this.pageEnteredAt,exit_trigger:e,page_title:document.title};if(this.enrichers.getScrollData)try{const r=this.enrichers.getScrollData();i.max_scroll_depth_pct=r.max_scroll_depth_pct}catch{}if(this.enrichers.getEngagementData)try{const r=this.enrichers.getEngagementData();i.active_time_ms=r.active_time_ms,i.idle_time_ms=r.idle_time_ms}catch{}if(this.enrichers.flushAbandoned)try{this.enrichers.flushAbandoned()}catch{}this.callback({event_type:"page_exit",url:this.currentUrl,timestamp:new Date().toISOString(),metadata:i})}}const br=[25,50,75,90];class yr{constructor(e){this.maxDepthPct=0,this.firedThresholds=new Set,this.scrollHandler=null,this.rafId=null,this.pending=!1,this.destroyed=!1,this.callback=e}start(){this.scrollHandler=()=>{this.pending||this.destroyed||(this.pending=!0,this.rafId=requestAnimationFrame(()=>{this.pending=!1,this.measure()}))},window.addEventListener("scroll",this.scrollHandler,{passive:!0}),document.addEventListener("scroll",this.scrollHandler,{passive:!0,capture:!0})}destroy(){this.destroyed=!0,this.scrollHandler&&(window.removeEventListener("scroll",this.scrollHandler),document.removeEventListener("scroll",this.scrollHandler,{capture:!0}),this.scrollHandler=null),this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}reset(){this.maxDepthPct=0,this.firedThresholds.clear()}getPageScrollData(){return{max_scroll_depth_pct:this.maxDepthPct}}measure(){const e=Math.max(document.body.scrollHeight||0,document.documentElement.scrollHeight||0),t=window.innerHeight||document.documentElement.clientHeight||0,i=window.scrollY||document.documentElement.scrollTop||0;if(e<=t){this.maxDepthPct=100;return}const r=e-t,s=Math.min(100,Math.round(i/r*100));s>this.maxDepthPct&&(this.maxDepthPct=s);for(const o of br)s>=o&&!this.firedThresholds.has(o)&&(this.firedThresholds.add(o),this.callback({event_type:"scroll",url:location.href,timestamp:new Date().toISOString(),metadata:{scroll_depth_pct:o,max_depth_pct:this.maxDepthPct,page_height:e,viewport_height:t}}))}}const vr=3e4,xr=5e3;class wr{constructor(){this.activeTimeMs=0,this.idleTimeMs=0,this.heartbeatTimer=null,this.visibilityHandler=null,this.activityHandler=null,this.isPageVisible=!0,this.destroyed=!1,this.lastActivityAt=Date.now(),this.lastHeartbeatAt=Date.now()}start(){this.activityHandler=()=>{this.lastActivityAt=Date.now()};const e={passive:!0,capture:!0};document.addEventListener("mousemove",this.activityHandler,e),document.addEventListener("keydown",this.activityHandler,e),document.addEventListener("touchstart",this.activityHandler,e),document.addEventListener("scroll",this.activityHandler,e),document.addEventListener("click",this.activityHandler,e),this.visibilityHandler=()=>{this.isPageVisible=!document.hidden,this.isPageVisible&&(this.lastActivityAt=Date.now())},document.addEventListener("visibilitychange",this.visibilityHandler),this.heartbeatTimer=setInterval(()=>this.heartbeat(),xr)}destroy(){this.destroyed=!0;const e={capture:!0};this.activityHandler&&(document.removeEventListener("mousemove",this.activityHandler,e),document.removeEventListener("keydown",this.activityHandler,e),document.removeEventListener("touchstart",this.activityHandler,e),document.removeEventListener("scroll",this.activityHandler,e),document.removeEventListener("click",this.activityHandler,e),this.activityHandler=null),this.visibilityHandler&&(document.removeEventListener("visibilitychange",this.visibilityHandler),this.visibilityHandler=null),this.heartbeatTimer&&(clearInterval(this.heartbeatTimer),this.heartbeatTimer=null)}reset(){this.heartbeat(),this.activeTimeMs=0,this.idleTimeMs=0,this.lastActivityAt=Date.now(),this.lastHeartbeatAt=Date.now()}getEngagementData(){return this.heartbeat(),{active_time_ms:this.activeTimeMs,idle_time_ms:this.idleTimeMs}}heartbeat(){if(this.destroyed)return;const e=Date.now(),t=e-this.lastHeartbeatAt;this.lastHeartbeatAt=e;const i=e-this.lastActivityAt;!this.isPageVisible||i>vr?this.idleTimeMs+=t:this.activeTimeMs+=t}}class kr{constructor(e){this.clickHandler=null,this.dblClickHandler=null,this.contextHandler=null,this.destroyed=!1,this.callback=e}start(){this.clickHandler=e=>{this.destroyed||!e.target||this.emitClick(e,"click")},this.dblClickHandler=e=>{this.destroyed||!e.target||this.emitClick(e,"double_click")},this.contextHandler=e=>{this.destroyed||!e.target||this.emitClick(e,"right_click")},document.addEventListener("click",this.clickHandler,{capture:!0,passive:!0}),document.addEventListener("dblclick",this.dblClickHandler,{capture:!0,passive:!0}),document.addEventListener("contextmenu",this.contextHandler,{capture:!0,passive:!0})}destroy(){this.destroyed=!0;const e={capture:!0};this.clickHandler&&(document.removeEventListener("click",this.clickHandler,e),this.clickHandler=null),this.dblClickHandler&&(document.removeEventListener("dblclick",this.dblClickHandler,e),this.dblClickHandler=null),this.contextHandler&&(document.removeEventListener("contextmenu",this.contextHandler,e),this.contextHandler=null)}emitClick(e,t){var d,u;const i=e.target,s=this.findClickableAncestor(i)||i,o=((d=s.tagName)==null?void 0:d.toLowerCase())||"",a=this.classifyClick(s,o),l=le(s),c="metadata"in l?l.metadata:{};this.callback({event_type:t,url:location.href,element_text:l.element_text||this.truncate(((u=s.textContent)==null?void 0:u.trim())||"",100),element_tag:l.element_tag||o,timestamp:new Date().toISOString(),metadata:{...c,click_type:a,viewport_x:Math.round(e.clientX),viewport_y:Math.round(e.clientY),page_x:Math.round(e.pageX),page_y:Math.round(e.pageY)}})}findClickableAncestor(e){var i;let t=e;for(let r=0;t&&r<5;r++){const s=(i=t.tagName)==null?void 0:i.toLowerCase();if(s==="a"||s==="button"||s==="input"||s==="select"||s==="textarea")return t;const o=t.getAttribute("role");if(o==="button"||o==="link"||o==="tab"||o==="menuitem"||t.onclick||t.getAttribute("tabindex"))return t;t=t.parentElement}return null}classifyClick(e,t){const i=e.getAttribute("role")||"",r=e.getAttribute("type")||"",s=e.getAttribute("href");return t==="a"||i==="link"?"link":e.closest("nav")||i==="navigation"?"navigation":i==="tab"||e.closest('[role="tablist"]')?"tab":r==="checkbox"||r==="radio"||i==="switch"?"toggle":t==="select"||i==="listbox"||i==="combobox"?"dropdown":t==="input"||t==="textarea"?"form_field":t==="button"||i==="button"?r==="submit"||e.classList.contains("cta")||e.classList.contains("primary")?"cta":"button":s?"link":"other"}truncate(e,t){return e.length>t?e.slice(0,t):e}}class _r{constructor(e){this.formStates=new WeakMap,this.activeForms=new Set,this.focusHandler=null,this.submitHandler=null,this.pasteHandler=null,this.destroyed=!1,this.callback=e}start(){this.focusHandler=e=>{this.destroyed||!e.target||this.onFieldFocus(e.target)},this.submitHandler=e=>{this.destroyed||!e.target||this.onFormSubmit(e.target)},this.pasteHandler=e=>{this.destroyed||!e.target||this.onPaste(e.target)},document.addEventListener("focusin",this.focusHandler,{capture:!0,passive:!0}),document.addEventListener("submit",this.submitHandler,{capture:!0}),document.addEventListener("paste",this.pasteHandler,{capture:!0,passive:!0})}destroy(){this.destroyed=!0,this.focusHandler&&(document.removeEventListener("focusin",this.focusHandler,{capture:!0}),this.focusHandler=null),this.submitHandler&&(document.removeEventListener("submit",this.submitHandler,{capture:!0}),this.submitHandler=null),this.pasteHandler&&(document.removeEventListener("paste",this.pasteHandler,{capture:!0}),this.pasteHandler=null),this.activeForms.clear()}flushAbandoned(){for(const e of this.activeForms){const t=this.formStates.get(e);if(t&&!t.submitted&&t.fieldsInteracted.size>0){const i=e;this.callback({event_type:"form_abandon",url:location.href,timestamp:new Date().toISOString(),metadata:{form_id:t.formId,total_fields:t.totalFields,fields_interacted:t.fieldsInteracted.size,field_order:t.fieldOrder.slice(0,20),last_field:t.lastFieldName,time_spent_ms:Date.now()-t.startedAt,had_paste:t.hasPaste,form_action:i.getAttribute("action")||void 0,form_method:i.getAttribute("method")||void 0}})}}this.activeForms.clear()}onFieldFocus(e){var c;const t=(c=e.tagName)==null?void 0:c.toLowerCase();if(t!=="input"&&t!=="textarea"&&t!=="select")return;const i=e.getAttribute("type");if(i==="hidden"||i==="submit"||i==="button")return;const r=e.closest("form")||e.closest('[role="form"]')||document.body,s=this.getFieldName(e),o=le(e),a="metadata"in o?o.metadata:{};let l=this.formStates.get(r);if(!l){const d=r.querySelectorAll("input, textarea, select"),u=r.id||r.getAttribute("name")||`form_${Date.now()}`;l={formId:u,startedAt:Date.now(),totalFields:d.length,fieldsInteracted:new Set,fieldOrder:[],lastFieldName:s,hasPaste:!1,submitted:!1},this.formStates.set(r,l),this.activeForms.add(r),this.callback({event_type:"form_start",url:location.href,timestamp:new Date().toISOString(),metadata:{form_id:u,total_fields:d.length,first_field:s,...a}})}l.fieldsInteracted.has(s)||(l.fieldsInteracted.add(s),l.fieldOrder.push(s)),l.lastFieldName=s}onFormSubmit(e){const t=this.formStates.get(e);t&&(t.submitted=!0,this.activeForms.delete(e),this.callback({event_type:"form_submit",url:location.href,timestamp:new Date().toISOString(),metadata:{form_id:t.formId,total_fields:t.totalFields,fields_interacted:t.fieldsInteracted.size,field_order:t.fieldOrder.slice(0,20),time_to_submit_ms:Date.now()-t.startedAt,had_paste:t.hasPaste,form_action:e.getAttribute("action")||void 0,form_method:e.getAttribute("method")||void 0}}))}onPaste(e){const t=e.closest("form")||e.closest('[role="form"]')||document.body,i=this.formStates.get(t);i&&(i.hasPaste=!0)}getFieldName(e){return e.getAttribute("name")||e.getAttribute("aria-label")||e.id||e.getAttribute("placeholder")||e.tagName.toLowerCase()}}const It=5e3,Er=1e3;class Sr{constructor(e){this.recentErrors=new Map,this.errorHandler=null,this.rejectionHandler=null,this.destroyed=!1,this.callback=e}start(){const e=window.onerror;this.errorHandler=(t,i,r,s,o)=>(this.destroyed||this.handleError(String(t),i||"",r||0,s||0,o==null?void 0:o.stack),typeof e=="function"?e(t,i,r,s,o):!1),window.onerror=this.errorHandler,this.rejectionHandler=t=>{if(this.destroyed)return;const i=t.reason,r=i instanceof Error?i.message:String(i),s=i instanceof Error?i.stack:void 0;this.handleError(r,"",0,0,s,!0)},window.addEventListener("unhandledrejection",this.rejectionHandler)}destroy(){this.destroyed=!0,this.errorHandler&&(window.onerror===this.errorHandler&&(window.onerror=null),this.errorHandler=null),this.rejectionHandler&&(window.removeEventListener("unhandledrejection",this.rejectionHandler),this.rejectionHandler=null),this.recentErrors.clear()}handleError(e,t,i,r,s,o=!1){if(t.includes("guideai")||s&&s.includes("guideai"))return;const a=`${e}|${t}|${i}`,l=Date.now(),c=this.recentErrors.get(a);if(!(c&&l-c<It)){if(this.recentErrors.set(a,l),this.recentErrors.size>50)for(const[d,u]of this.recentErrors)l-u>It&&this.recentErrors.delete(d);this.callback({event_type:"js_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_message:this.truncate(e,500),error_source:this.extractFilename(t),error_line:i,error_col:r,error_stack:s?this.sanitizeStack(s):void 0,is_unhandled_rejection:o||void 0}})}}extractFilename(e){if(!e)return"";try{const t=new URL(e),i=t.pathname.split("/");return i[i.length-1]||t.pathname}catch{return e.split("/").pop()||e}}sanitizeStack(e){const t=e.replace(/file:\/\/[^\s)]+/g,"[local]").replace(/\/Users\/[^\s:)]+/g,"[path]").replace(/\/home\/[^\s:)]+/g,"[path]").replace(/C:\\[^\s:)]+/g,"[path]");return this.truncate(t,Er)}truncate(e,t){return e.length>t?e.slice(0,t)+"…":e}}const Cr=1e4;class Tr{constructor(e){this.reportTimer=null,this.paintObserver=null,this.lcpObserver=null,this.longTaskObserver=null,this.resourceErrorHandler=null,this.origFetch=null,this.origXhrOpen=null,this.fcpMs=0,this.lcpMs=0,this.longTaskCount=0,this.destroyed=!1,this.callback=e}start(){try{this.paintObserver=new PerformanceObserver(e=>{for(const t of e.getEntries())t.name==="first-contentful-paint"&&(this.fcpMs=Math.round(t.startTime))}),this.paintObserver.observe({type:"paint",buffered:!0})}catch{}try{this.lcpObserver=new PerformanceObserver(e=>{const t=e.getEntries();t.length>0&&(this.lcpMs=Math.round(t[t.length-1].startTime))}),this.lcpObserver.observe({type:"largest-contentful-paint",buffered:!0})}catch{}try{this.longTaskObserver=new PerformanceObserver(e=>{this.longTaskCount+=e.getEntries().length}),this.longTaskObserver.observe({type:"longtask"})}catch{}this.resourceErrorHandler=e=>{if(this.destroyed)return;const t=e.target;if(!t||!t.tagName)return;const i=t.tagName.toLowerCase();if(i==="img"||i==="script"||i==="link"){const r=t.src||t.src||t.href||"";if(r.includes("guideai"))return;this.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{resource_tag:i,resource_url:this.extractPathname(r),error_type:"resource_load_failed"}})}},window.addEventListener("error",this.resourceErrorHandler,{capture:!0}),this.interceptFetch(),this.interceptXhr(),this.reportTimer=setTimeout(()=>this.emitPerformanceReport(),Cr)}destroy(){this.destroyed=!0,this.reportTimer&&(clearTimeout(this.reportTimer),this.reportTimer=null),this.paintObserver&&(this.paintObserver.disconnect(),this.paintObserver=null),this.lcpObserver&&(this.lcpObserver.disconnect(),this.lcpObserver=null),this.longTaskObserver&&(this.longTaskObserver.disconnect(),this.longTaskObserver=null),this.resourceErrorHandler&&(window.removeEventListener("error",this.resourceErrorHandler,{capture:!0}),this.resourceErrorHandler=null),this.origFetch&&(window.fetch=this.origFetch,this.origFetch=null),this.origXhrOpen&&(XMLHttpRequest.prototype.open=this.origXhrOpen,this.origXhrOpen=null)}interceptFetch(){try{this.origFetch=window.fetch.bind(window);const e=this;window.fetch=function(...t){var s;const i=typeof t[0]=="string"?t[0]:((s=t[0])==null?void 0:s.url)||"",r=Date.now();return e.origFetch(...t).then(o=>{var a;return!e.destroyed&&o.status>=400&&!i.includes("guideai")&&!i.includes("/api/v1/events")&&e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"http_error",request_url:e.extractPathname(i),status_code:o.status,duration_ms:Date.now()-r,method:((a=t[1])==null?void 0:a.method)||"GET"}}),o},o=>{var a;throw!e.destroyed&&!i.includes("guideai")&&!i.includes("/api/v1/events")&&e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"fetch_failed",request_url:e.extractPathname(i),error_message:(o==null?void 0:o.message)||"Network request failed",duration_ms:Date.now()-r,method:((a=t[1])==null?void 0:a.method)||"GET"}}),o})}}catch{}}interceptXhr(){try{this.origXhrOpen=XMLHttpRequest.prototype.open;const e=this;XMLHttpRequest.prototype.open=function(t,i,...r){const s=String(i);if(!s.includes("guideai")&&!s.includes("/api/v1/events")){const o=Date.now();this.addEventListener("load",function(){!e.destroyed&&this.status>=400&&e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"xhr_http_error",request_url:e.extractPathname(s),status_code:this.status,duration_ms:Date.now()-o,method:t}})}),this.addEventListener("error",function(){e.destroyed||e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"xhr_failed",request_url:e.extractPathname(s),duration_ms:Date.now()-o,method:t}})}),this.addEventListener("timeout",function(){e.destroyed||e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"xhr_timeout",request_url:e.extractPathname(s),duration_ms:Date.now()-o,method:t}})})}return e.origXhrOpen.apply(this,[t,i,...r])}}catch{}}emitPerformanceReport(){var t,i,r;if(this.destroyed)return;const e={fcp_ms:this.fcpMs||void 0,lcp_ms:this.lcpMs||void 0,long_task_count:this.longTaskCount};try{const s=performance.getEntriesByType("navigation")[0];s&&(e.ttfb_ms=Math.round(s.responseStart-s.requestStart),e.dom_load_ms=Math.round(s.domContentLoadedEventEnd-s.startTime),e.page_load_ms=Math.round(s.loadEventEnd-s.startTime),e.dns_ms=Math.round(s.domainLookupEnd-s.domainLookupStart),e.connect_ms=Math.round(s.connectEnd-s.connectStart),e.transfer_size=s.transferSize)}catch{}(t=this.paintObserver)==null||t.disconnect(),(i=this.lcpObserver)==null||i.disconnect(),(r=this.longTaskObserver)==null||r.disconnect(),this.callback({event_type:"performance",url:location.href,timestamp:new Date().toISOString(),metadata:e})}extractPathname(e){try{return new URL(e).pathname}catch{return e}}}const ze=['[role="alert"]','[role="alertdialog"]','[role="status"]','[aria-live="assertive"]','[aria-live="polite"]',".error-message",".error-banner",".error-toast",".error-notification",".error-alert",".error-dialog",".error-text",".error-msg",".alert-error",".alert-danger",".alert-warning",".toast",".toast-error",".toast-warning",".Toastify__toast--error",".Toastify__toast--warning",".notistack-MuiContent-error",".notistack-MuiContent-warning",".react-hot-toast",".MuiAlert-standardError",".MuiAlert-standardWarning",".MuiAlert-filledError",".MuiAlert-filledWarning",".MuiSnackbar-root",".ant-message-error",".ant-message-warning",".ant-notification-notice-error",".ant-notification-notice-warning",".ant-alert-error",".ant-alert-warning",".alert-danger",".alert-warning",".invalid-feedback:not(.d-none)",".is-invalid",'[data-status="error"]','[data-status="warning"]',".alert.alert-danger",".moodle-exception-message","#notice.error",".notifyproblem",".notifyerror",".slds-notify--error",".slds-notify--warning",".slds-notify_alert",".slds-theme_error",'lightning-notice[variant="error"]',"force-record-layout-item .error",".web3modal-modal-card .error",".walletconnect-modal__text--error",'[class*="wallet-error"]','[class*="transaction-error"]','[class*="connect-error"]','[data-state="error"]',"dialog[open]"].join(","),Mt=[/\bunable to\b/i,/\bfailed to\b/i,/\bcannot\b.*\b(?:connect|load|save|send|process|complete|fetch|login|sign[- ]?in)\b/i,/\bcould not\b/i,/\bsomething went wrong\b/i,/\bunexpected error\b/i,/\binternal (?:server )?error\b/i,/\bservice unavailable\b/i,/\brequest (?:timed out|timeout)\b/i,/\btry again\b/i,/\bplease try\b/i,/\bconnection (?:lost|failed|refused|error)\b/i,/\bnetwork error\b/i,/\bno internet\b/i,/\boffline\b/i,/\baccess denied\b/i,/\bpermission denied\b/i,/\bunauthorized\b/i,/\bforbidden\b/i,/\bnot found\b/i,/\b(?:invalid|incorrect|wrong) (?:password|credentials|email|username|input)\b/i,/\bsession (?:expired|timed out)\b/i,/\blogin failed\b/i,/\bauthentication failed\b/i,/\bpayment (?:failed|declined|error)\b/i,/\binsufficient (?:funds|balance)\b/i,/\brate limit\b/i,/\btoo many (?:requests|attempts)\b/i,/\baccount (?:locked|suspended|disabled)\b/i,/\btransaction (?:failed|rejected|reverted)\b/i,/\bwallet (?:not found|disconnected|rejected)\b/i,/\buser rejected\b/i,/\bgas (?:estimation failed|too low)\b/i,/\bnonce too\b/i,/\bcontract (?:error|reverted)\b/i,/\bmetamask\b.*\b(?:error|rejected|denied)\b/i,/\bsubmission (?:failed|error)\b/i,/\bgrade (?:error|failed)\b/i,/\benrolment (?:error|failed)\b/i,/\bcourse (?:not available|error)\b/i,/\b(?:error |status )(?:4\d{2}|5\d{2})\b/i,/\b(?:404|500|502|503)\b.*\b(?:error|not found|unavailable)\b/i],Fe=5,Pt=500,Rt=3e3;class Ar{constructor(e){this.observer=null,this.existingElements=new WeakSet,this.recentErrors=new Map,this.debounceTimer=null,this.pendingElements=[],this.destroyed=!1,this.callback=e}start(){this.snapshotExisting(),this.observer=new MutationObserver(e=>{if(!this.destroyed)for(const t of e){if(t.type==="childList")for(let i=0;i<t.addedNodes.length;i++){const r=t.addedNodes[i];r.nodeType===Node.ELEMENT_NODE&&this.inspectElement(r)}t.type==="attributes"&&t.target.nodeType===Node.ELEMENT_NODE&&this.inspectElement(t.target)}}),this.observer.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","role","aria-live","data-status","data-state","style"]})}destroy(){this.destroyed=!0,this.observer&&(this.observer.disconnect(),this.observer=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null),this.recentErrors.clear(),this.pendingElements=[]}snapshotExisting(){try{const e=document.querySelectorAll(ze);for(let t=0;t<e.length;t++)this.existingElements.add(e[t])}catch{}}inspectElement(e){var i;if(this.existingElements.has(e)||(i=e.closest)!=null&&i.call(e,"[data-guideai-root]"))return;if(this.isErrorElement(e)){this.pendingElements.push(e),this.scheduleFlush();return}try{const r=e.querySelectorAll(ze);for(let s=0;s<r.length;s++)this.existingElements.has(r[s])||this.pendingElements.push(r[s]);this.pendingElements.length>0&&this.scheduleFlush()}catch{}}isErrorElement(e){try{if(e.matches(ze)){const t=e.getAttribute("role");return t==="status"||t==="dialog"||e.tagName==="DIALOG"?this.hasErrorText(e):!0}}catch{}return!!this.looksLikeErrorByText(e)}hasErrorText(e){const t=this.getVisibleText(e);return t.length<Fe?!1:Mt.some(i=>i.test(t))}looksLikeErrorByText(e){const t=e,i=this.getVisibleText(e);if(i.length<Fe||i.length>Pt||!this.isVisible(t)||!Mt.some(a=>a.test(i)))return!1;const r=String(e.className||"").toLowerCase(),s=/error|alert|warn|danger|fail|toast|notify|snack|banner/i.test(r),o=this.hasErrorStyling(t);return s||o}hasErrorStyling(e){try{const t=window.getComputedStyle(e),i=t.color||"",r=t.backgroundColor||"",s=o=>{const a=o.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;const l=parseInt(a[1],10),c=parseInt(a[2],10),d=parseInt(a[3],10);return l>150&&c<100&&d<100};return s(i)||s(r)}catch{return!1}}isVisible(e){try{if(e.offsetParent===null&&e.tagName!=="BODY")return!1;const t=window.getComputedStyle(e);return!(t.display==="none"||t.visibility==="hidden"||t.opacity==="0")}catch{return!0}}getVisibleText(e){return(e.innerText??e.textContent??"").trim().slice(0,Pt)}scheduleFlush(){this.debounceTimer||(this.debounceTimer=setTimeout(()=>{this.flush(),this.debounceTimer=null},150))}flush(){if(this.pendingElements.length===0)return;const e=[...new Set(this.pendingElements)];this.pendingElements=[];const t=Date.now();for(const i of e){this.existingElements.add(i);const r=this.getVisibleText(i);if(r.length<Fe)continue;const s=r.slice(0,100),o=this.recentErrors.get(s);if(o&&t-o<Rt)continue;this.recentErrors.set(s,t);const a=this.classifyError(r,i),l=le(i),c="metadata"in l?l.metadata:{};this.callback({event_type:"ui_error",url:location.href,element_text:l.element_text||r.slice(0,300),element_tag:l.element_tag||i.tagName.toLowerCase(),timestamp:new Date().toISOString(),metadata:{...c,error_category:a,error_text:r.slice(0,300),container_type:this.getContainerType(i),is_modal:!!i.closest('dialog, [role="dialog"], [role="alertdialog"], .modal'),is_toast:!!i.closest('.toast, .Toastify, .notistack, .react-hot-toast, [class*="snackbar"], [class*="notification"]')}})}if(this.recentErrors.size>100)for(const[i,r]of this.recentErrors)t-r>Rt&&this.recentErrors.delete(i)}classifyError(e,t){const i=e.toLowerCase();return/login|sign.?in|credential|password|auth/i.test(i)?"authentication":/permission|denied|forbidden|unauthorized|access/i.test(i)?"authorization":/network|connect|internet|offline/i.test(i)?"network":/timeout|timed.?out/i.test(i)?"timeout":/payment|declined|insufficient|billing/i.test(i)?"payment":/not found|404|missing/i.test(i)?"not_found":/server error|500|502|503|unavailable/i.test(i)?"server":/rate limit|too many/i.test(i)?"rate_limit":/session|expired/i.test(i)?"session":/wallet|metamask|transaction|gas|nonce|contract/i.test(i)?"web3":/valid|invalid|required|format|must be/i.test(i)?"validation":/upload|file|size|too large/i.test(i)?"file":/enrol|course|grade|quiz|submission|assignment/i.test(i)?"lms":"general"}getContainerType(e){const t=e.getAttribute("role");if(t==="alertdialog")return"alert_dialog";if(t==="alert")return"alert";if(t==="dialog"||e.tagName==="DIALOG")return"dialog";if(t==="status")return"status";const i=String(e.className||"").toLowerCase();return/toast/i.test(i)?"toast":/snack/i.test(i)?"snackbar":/banner/i.test(i)?"banner":/modal/i.test(i)?"modal":/notif/i.test(i)?"notification":/alert/i.test(i)?"alert":"inline"}truncate(e,t){return e.length>t?e.slice(0,t):e}}const Ge=n=>`guideai_visitor_${n}`,qe=n=>`guideai_account_${n}`,Ht=n=>`guideai_user_id_${n}`,Lr=new Set(["identify","feature_used","product_view","add_to_cart","remove_from_cart","checkout_start","purchase","search","signup","login","share","subscribe","unsubscribe","feedback","rating","signup_started","signup_completed","trial_started","trial_abandoned","login_success","onboarding_started","onboarding_completed","setup_completed","key_action_completed","invite_sent","invite_accepted","upgrade_cta_clicked","addon_interest_clicked","demo_requested","lead_submitted","pricing_page_view","feedback_submitted","support_ticket_created","wallet_connect","wallet_disconnect","transaction_sign","transaction_confirm","token_swap","nft_view","nft_purchase","course_start","course_complete","lesson_view","quiz_start","quiz_complete","assignment_submit"]),Ir=50,Ee=500;class Mr{constructor(){this.eventBuffer=null,this.siteId=""}configure(e,t){this.eventBuffer=e,this.siteId=t}track(e,t){if(!this.eventBuffer||!e)return;const i=this.sanitizeMetadata(t||{}),r=Lr.has(e),s={event_type:r?e:"custom",url:location.href,timestamp:new Date().toISOString(),metadata:{...i,...r?{}:{custom_event_name:e}}};this.eventBuffer.push(s)}trackFeature(e,t,i){if(!this.eventBuffer||!e)return;const r=this.sanitizeMetadata(i||{}),s={event_type:"feature_used",url:location.href,timestamp:new Date().toISOString(),metadata:{...r,feature_key:e,...t?{feature_label:t}:{}}};this.eventBuffer.push(s)}identify(e){if(e)try{sessionStorage.setItem(Ht(this.siteId),e)}catch{}}getUserId(){try{return sessionStorage.getItem(Ht(this.siteId))}catch{return null}}initializeVisitor(e){var r;if(!((r=e==null?void 0:e.visitor)!=null&&r.id)){typeof console<"u"&&console.warn("[GuideAI] initialize() requires visitor.id");return}const{visitor:t,account:i}=e;this.identify(t.id);try{sessionStorage.setItem(Ge(this.siteId),JSON.stringify(t))}catch{}if(i!=null&&i.id)try{sessionStorage.setItem(qe(this.siteId),JSON.stringify(i))}catch{}if(this.eventBuffer){const s={visitor:{...t}};i&&(s.account={...i}),this.eventBuffer.push({event_type:"identify",url:location.href,timestamp:new Date().toISOString(),user_id:t.id,metadata:s})}}updateOptions(e){const{visitor:t,account:i}=e;if(t){const s={...this.getVisitorData(),...t};t.id&&this.identify(t.id);try{sessionStorage.setItem(Ge(this.siteId),JSON.stringify(s))}catch{}}if(i){const s={...this.getAccountData(),...i};try{sessionStorage.setItem(qe(this.siteId),JSON.stringify(s))}catch{}}if(this.eventBuffer){const r=this.getVisitorData(),s=this.getAccountData(),o={};r&&(o.visitor=r),s&&(o.account=s),this.eventBuffer.push({event_type:"identify",url:location.href,timestamp:new Date().toISOString(),user_id:(r==null?void 0:r.id)||this.getUserId()||void 0,metadata:o})}}getVisitorData(){try{const e=sessionStorage.getItem(Ge(this.siteId));return e?JSON.parse(e):null}catch{return null}}getAccountData(){try{const e=sessionStorage.getItem(qe(this.siteId));return e?JSON.parse(e):null}catch{return null}}sanitizeMetadata(e){const t={};let i=0;for(const[r,s]of Object.entries(e)){if(i>=Ir)break;if(s!=null){if(typeof s=="string")t[r]=s.length>Ee?s.slice(0,Ee):s;else if(typeof s=="number"||typeof s=="boolean")t[r]=s;else try{const o=JSON.stringify(s);t[r]=o.length>Ee?o.slice(0,Ee):o}catch{t[r]="[complex]"}i++}}return t}}const Pr=new Set(["password","credit-card","ssn"]),Rr=new Set(["SCRIPT","NOSCRIPT"]);class Hr{constructor(){this.nodeIdCounter=1,this.nodeIdMap=new WeakMap}getNodeId(e){let t=this.nodeIdMap.get(e);return t||(t=this.nodeIdCounter++,this.nodeIdMap.set(e,t)),t}serializeDocument(){return this.serializeNode(document.documentElement)}serializeNode(e){try{const t=this.getNodeId(e);if(e.nodeType===Node.TEXT_NODE){const a=e.parentElement;return a&&this.shouldMask(a)?{id:t,type:3,text:"[masked]"}:{id:t,type:3,text:e.textContent??""}}if(e.nodeType===Node.COMMENT_NODE)return{id:t,type:8,text:""};if(e.nodeType!==Node.ELEMENT_NODE)return null;const i=e,r=i.tagName;if(Rr.has(r))return{id:t,type:1,tag:r,attrs:{},children:[]};const s=this.sanitizeAttributes(i),o=[];for(let a=0;a<i.childNodes.length;a++){const l=this.serializeNode(i.childNodes[a]);l&&o.push(l)}return{id:t,type:1,tag:r,attrs:s,children:o}}catch{return null}}shouldMask(e){var t;if(e.hasAttribute("data-guideai-mask"))return!0;if(e.tagName==="INPUT"){const i=(t=e.type)==null?void 0:t.toLowerCase();if(Pr.has(i))return!0}return!1}sanitizeAttributes(e){var i;const t={};for(let r=0;r<e.attributes.length;r++){const s=e.attributes[r],o=s.name;o.startsWith("on")||o.startsWith("data-guideai-internal")||(t[o]=s.value)}if(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.tagName==="SELECT"){const r=e;if(((i=r.type)==null?void 0:i.toLowerCase())==="password")t.value="***";else if(this.shouldMask(e))t.value="[masked]";else{const o=r.value||"";t.value=o?`[${o.length} chars]`:""}}return t}reset(){this.nodeIdCounter=1,this.nodeIdMap=new WeakMap}}class Nr{constructor(e,t){this.serializer=e,this.callback=t,this.observer=null}start(){try{this.observer=new MutationObserver(e=>{try{const t=this.processMutations(e);t.length>0&&this.callback(t)}catch{}}),this.observer.observe(document.documentElement,{childList:!0,attributes:!0,characterData:!0,subtree:!0,attributeOldValue:!0})}catch{}}stop(){var e;(e=this.observer)==null||e.disconnect(),this.observer=null}processMutations(e){const t=[];for(const i of e)if(!this.isGuideAINode(i.target))switch(i.type){case"childList":{for(let r=0;r<i.addedNodes.length;r++){const s=i.addedNodes[r];if(this.isGuideAINode(s))continue;const o=this.serializer.serializeNode(s);o&&t.push({type:"add",targetId:o.id,parentId:i.target?this.serializer.getNodeId(i.target):void 0,nextSiblingId:i.nextSibling?this.serializer.getNodeId(i.nextSibling):void 0,data:o})}for(let r=0;r<i.removedNodes.length;r++){const s=i.removedNodes[r];this.isGuideAINode(s)||t.push({type:"remove",targetId:this.serializer.getNodeId(s),parentId:i.target?this.serializer.getNodeId(i.target):void 0})}break}case"attributes":{const r=i.target,s=i.attributeName??"";t.push({type:"attr",targetId:this.serializer.getNodeId(i.target),attr:{name:s,value:r.getAttribute(s)}});break}case"characterData":{t.push({type:"text",targetId:this.serializer.getNodeId(i.target),text:i.target.textContent??""});break}}return t}isGuideAINode(e){if(!e)return!1;const t=e.nodeType===Node.ELEMENT_NODE?e:e.parentElement;return t?t.id==="guideai-shadow-host"||t.closest("#guideai-shadow-host")!==null:!1}}class $r{constructor(){this.lastX=0,this.lastY=0,this.timer=null,this.hasMoved=!1,this.handler=null,this.cb=null}start(e){this.cb=e,this.handler=t=>{this.lastX=t.clientX,this.lastY=t.clientY,this.hasMoved=!0},document.addEventListener("mousemove",this.handler,{passive:!0}),this.timer=setInterval(()=>{this.hasMoved&&this.cb&&(this.cb({x:this.lastX,y:this.lastY}),this.hasMoved=!1)},50)}stop(){this.handler&&(document.removeEventListener("mousemove",this.handler),this.handler=null),this.timer&&(clearInterval(this.timer),this.timer=null)}}class Dr{constructor(){this.timer=null,this.lastX=0,this.lastY=0,this.changed=!1,this.handler=null,this.cb=null}start(e){this.cb=e,this.handler=()=>{this.lastX=window.scrollX,this.lastY=window.scrollY,this.changed=!0},window.addEventListener("scroll",this.handler,{passive:!0}),this.timer=setInterval(()=>{this.changed&&this.cb&&(this.cb({x:this.lastX,y:this.lastY}),this.changed=!1)},100)}stop(){this.handler&&(window.removeEventListener("scroll",this.handler),this.handler=null),this.timer&&(clearInterval(this.timer),this.timer=null)}}class Br{constructor(){this.handler=null,this.getNodeId=null}start(e,t){this.getNodeId=t,this.handler=i=>{var r;try{const s=i.target;if(!s||!("value"in s))return;const o=s,a=(r=o.type)==null?void 0:r.toLowerCase();let l;a==="password"?l="***":s.hasAttribute("data-guideai-mask")?l="[masked]":l=`[${(o.value||"").length} chars]`,e({targetId:t(s),value:l,tag:s.tagName})}catch{}},document.addEventListener("input",this.handler,{capture:!0,passive:!0})}stop(){this.handler&&(document.removeEventListener("input",this.handler,{capture:!0}),this.handler=null)}}class Or{constructor(){this.handler=null,this.timer=null,this.cb=null}start(e){this.cb=e,this.handler=()=>{this.timer&&clearTimeout(this.timer),this.timer=setTimeout(()=>{this.cb&&this.cb({width:window.innerWidth,height:window.innerHeight})},200)},window.addEventListener("resize",this.handler,{passive:!0})}stop(){this.handler&&(window.removeEventListener("resize",this.handler),this.handler=null),this.timer&&(clearTimeout(this.timer),this.timer=null)}}class zr{constructor(e){this.sender=e,this.events=[],this.chunkIndex=0,this.byteSize=0,this.flushTimer=null,this.MAX_BYTES=50*1024,this.FLUSH_INTERVAL=5e3,this.flushTimer=setInterval(()=>this.flush(),this.FLUSH_INTERVAL)}push(e){try{this.events.push(e),this.byteSize+=this.estimateSize(e),this.byteSize>=this.MAX_BYTES&&this.flush()}catch{}}flush(){if(this.events.length!==0)try{const e=this.events.splice(0);this.sender.send(e,this.chunkIndex++),this.byteSize=0}catch{}}destroy(){this.flushTimer&&(clearInterval(this.flushTimer),this.flushTimer=null),this.flush()}estimateSize(e){try{return e.type==="snapshot"?5e3:e.type==="mutation"?500:e.type==="mouse"?30:e.type==="click"?50:e.type==="scroll"?30:e.type==="input"?100:e.type==="resize"?30:100}catch{return 100}}}class Fr{constructor(e,t){this.sessionId=e,this.api=t}async send(e,t){try{const i={chunks:[{session_id:this.sessionId,chunk_index:t,data:{events:e},timestamp:new Date().toISOString()}]};this.api.postKeepalive("/api/v1/recordings",i)}catch{}}}class Gr{constructor(e,t){this.startTime=0,this.destroyed=!1,this.clickHandler=null,this.sender=new Fr(t,e),this.buffer=new zr(this.sender),this.serializer=new Hr,this.mouseObserver=new $r,this.scrollObserver=new Dr,this.inputObserver=new Br,this.resizeObserver=new Or,this.mutationObserver=new Nr(this.serializer,i=>{this.pushEvent({type:"mutation",timestamp:this.elapsed(),data:i})})}start(){try{if(this.destroyed)return;this.startTime=Date.now();const e=this.serializer.serializeDocument();this.pushEvent({type:"snapshot",timestamp:0,data:e}),this.mutationObserver.start(),this.mouseObserver.start(t=>{this.pushEvent({type:"mouse",timestamp:this.elapsed(),data:t})}),this.scrollObserver.start(t=>{this.pushEvent({type:"scroll",timestamp:this.elapsed(),data:t})}),this.inputObserver.start(t=>{this.pushEvent({type:"input",timestamp:this.elapsed(),data:t})},t=>this.serializer.getNodeId(t)),this.resizeObserver.start(t=>{this.pushEvent({type:"resize",timestamp:this.elapsed(),data:t})}),this.clickHandler=t=>{try{const i=t.target;this.pushEvent({type:"click",timestamp:this.elapsed(),data:{x:t.clientX,y:t.clientY,targetId:this.serializer.getNodeId(i),tag:i==null?void 0:i.tagName}})}catch{}},document.addEventListener("click",this.clickHandler,{capture:!0,passive:!0})}catch(e){typeof console<"u"&&console.warn("[GuideAI] Recording start error:",e)}}destroy(){this.destroyed=!0;try{this.mutationObserver.stop(),this.mouseObserver.stop(),this.scrollObserver.stop(),this.inputObserver.stop(),this.resizeObserver.stop(),this.clickHandler&&(document.removeEventListener("click",this.clickHandler,{capture:!0}),this.clickHandler=null),this.buffer.destroy()}catch{}}pushEvent(e){this.destroyed||this.buffer.push(e)}elapsed(){return Date.now()-this.startTime}}function A(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}function qr(n){return n.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function _(n,e,t){return{site_id:n,session_id:"",event_type:e,url:location.href,timestamp:new Date().toISOString(),metadata:t??{}}}function Ue(n,e,t,i,r){const s=_(n,e,r);return s.guide_id=t,i!==void 0&&(s.step_index=i,s.total_steps=r==null?void 0:r.total_steps),s}function Ve(n,e,t,i,r){return{site_id:n,session_id:"",event_type:"guide_step_action",url:location.href,guide_id:e,step_index:t,timestamp:new Date().toISOString(),metadata:r?{action:i,detail:r}:{action:i}}}function We(n,e,t,i,r,s,o,a){return{site_id:n,session_id:"",event_type:"guide_step",url:location.href,guide_id:e,step_index:t,total_steps:i,timestamp:new Date().toISOString(),metadata:{step_title:r,action_type:s,has_target:o,interactive:a}}}const Nt="guideai_chip_dismissals",Ur=15e3,Vr=150,Wr=48,$t=300*1e3;class jr{constructor(e,t,i,r){this.activeChips=new Map,this.dismissTimers=new Map,this.focusedIndex=-1,this.onKeyDown=null,this.config=e,this.eventBuffer=t,this.shadowRoot=i,this.positionProvider=r}showChips(e){const t=this.getDismissals(),i=Date.now(),r=e.filter(a=>{const l=t.find(c=>c.chipId===a.id);return!l||i-l.dismissedAt>$t});r.sort((a,l)=>a.priority-l.priority);const s=r.slice(0,3);let o=this.activeChips.size;s.forEach((a,l)=>{if(this.activeChips.has(a.id))return;const c=l*Vr;setTimeout(()=>{this.renderChip(a,o+l)},c)})}removeAll(){this.activeChips.forEach(e=>e.remove()),this.activeChips.clear(),this.dismissTimers.forEach(e=>clearTimeout(e)),this.dismissTimers.clear(),this.removeKeyboardListeners()}renderChip(e,t){var a;const i=document.createElement("div");i.className="guideai-chip",i.setAttribute("data-chip-id",e.id),i.setAttribute("role","option"),i.setAttribute("tabindex","-1"),i.setAttribute("aria-label",`${e.emoji} ${e.label}`),i.innerHTML=`
    ...
    `,o.addEventListener("click",this.onClick),o.addEventListener("keydown",a=>{(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),this.onClick())}),this.shadowRoot.appendChild(o),this.beaconEl=o,o.style.opacity="0",requestAnimationFrame(()=>{o.style.transition="opacity 300ms ease",o.style.opacity="1"})}updateBadge(e){if(!this.beaconEl)return;const t=this.beaconEl.querySelector(".guideai-beacon-badge");if(e>0)if(t)t.textContent=String(e);else{const i=document.createElement("div");i.className="guideai-beacon-badge",i.textContent=String(e),this.beaconEl.appendChild(i)}else t&&t.remove();this.beaconEl.setAttribute("aria-label",`${e} new announcement${e!==1?"s":""}`)}hide(){if(!this.beaconEl)return;this.beaconEl.style.opacity="0";const e=this.beaconEl;setTimeout(()=>{e.remove()},300),this.beaconEl=null}destroy(){this.destroyed=!0,this.hide()}isVisible(){return this.beaconEl!==null}}const je="guideai_announcement_dismissals_v2",Jr="guideai_announcement_dismissals";class Qr{constructor(e,t,i){this.announcements=[],this.listModalEl=null,this.bannerEl=null,this.destroyed=!1,this.routePoller=null,this.lastPathname=location.pathname,this.dismissals={},this.tickTimer=null,this.api=e,this.config=t,this.shadowRoot=i,this.renderer=new Xr(i,()=>this.handleBeaconClick())}init(e){this.announcements=e,this.dismissals=this.loadDismissals(),this.routePoller=setInterval(()=>{if(this.destroyed)return;const t=location.pathname;t!==this.lastPathname&&(this.lastPathname=t,this.updateBeacon())},750),this.tickTimer=setInterval(()=>{this.destroyed||this.updateBeacon()},3e4),this.updateBeacon()}updateAnnouncements(e){this.announcements=e,this.dismissals=this.loadDismissals(),this.updateBeacon()}updateBeacon(){if(this.destroyed)return;const e=this.getUnreadAnnouncements(),t=e.filter(s=>this.getSurface(s)==="banner"),i=e.filter(s=>this.getSurface(s)!=="banner");t.length>0?this.showBanner(t):this.hideBanner();const r=i.length;if(r>0){const s={position:"bottom-right",icon:"🤖",animate:!0};this.renderer.show(r,s)}else this.renderer.hide()}handleBeaconClick(){if(this.listModalEl)return;const e=this.getUnreadAnnouncements().filter(t=>this.getSurface(t)!=="banner");e.length!==0&&this.showAnnouncementCarousel(e)}showAnnouncementCarousel(e){let t=0;const i=document.createElement("div");i.className="guideai-announcement",i.setAttribute("role","dialog"),i.setAttribute("aria-label","Announcements");const r=()=>{const s=e[t],o=e.length>1,a=this.getSurface(s)==="drawer"?"guideai-announcement-card--drawer":"",{imgSrc:l,restHtml:c}=this.splitHtmlFirstImage(s.message);i.innerHTML=`
        ...
        <div class="guideai-announcement-card ${a}">
          ...
          ${l?`<div class="guideai-announcement-media"><img src="${A(l)}" alt="" /></div>`:""}
          <div class="guideai-announcement-body ${l?"guideai-announcement-body--with-media":""}">
            <h3 class="guideai-announcement-title">${A(s.title)}</h3>
      ...
      `;const d=i.querySelector(".guideai-announcement-close");d==null||d.addEventListener("click",()=>{this.closeListModal()});const u=i.querySelector(".guideai-announcement-backdrop");this.config.announcementCloseOnBackdrop&&(u==null||u.addEventListener("click",()=>{this.closeListModal()}));const h=i.querySelector(".guideai-announcement-cta");h==null||h.addEventListener("click",()=>{document.dispatchEvent(new CustomEvent("guideai:chip-click",{detail:{guideId:s.linked_guide_id}})),this.dismissAnnouncement(s.id)});const p=i.querySelector(".guideai-announcement-dismiss");if(p==null||p.addEventListener("click",()=>{e.splice(t,1),this.saveDismissal(s.id),e.length===0?(this.closeListModal(),this.updateBeacon()):(t>=e.length&&(t=e.length-1),r(),this.updateBeacon())}),o){const m=i.querySelector(".guideai-announcement-prev");m==null||m.addEventListener("click",()=>{t>0&&(t--,r())});const f=i.querySelector(".guideai-announcement-next");f==null||f.addEventListener("click",()=>{t<e.length-1&&(t++,r())})}};this.shadowRoot.appendChild(i),this.listModalEl=i,r(),i.style.opacity="0",requestAnimationFrame(()=>{i.style.transition="opacity 250ms ease",i.style.opacity="1"})}dismissAnnouncement(e){this.saveDismissal(e),this.closeListModal(),this.updateBeacon()}closeListModal(){if(!this.listModalEl)return;this.listModalEl.style.opacity="0";const e=this.listModalEl;setTimeout(()=>e.remove(),250),this.listModalEl=null}getUnreadCount(){return this.getUnreadAnnouncements().length}getUnreadAnnouncements(){const e=location.pathname;return this.announcements.filter(i=>{var r;if(!this.routeMatch(i.page_url_pattern,e)||this.isDismissed(i.id,i.updated_at))return!1;if(i.trigger_type==="scheduled"){const s=(r=i.trigger_config)==null?void 0:r.scheduled_at;if(typeof s!="string"||!s.trim())return!1;const o=new Date(s).getTime();if(!Number.isFinite(o)||o>Date.now())return!1}return!0}).sort((i,r)=>{const s=new Date(i.updated_at).getTime(),o=new Date(r.updated_at).getTime();return Number.isFinite(s)&&Number.isFinite(o)?o-s:String(r.updated_at).localeCompare(String(i.updated_at))})}isDismissed(e,t){return this.dismissals[e]===t}routeMatch(e,t){if(!e)return!1;const i=e.trim();if(!i)return!1;const r=t.trim()||"/";if(i===r)return!0;const s=o=>o.length>1&&o.endsWith("/")?o.slice(0,-1):o;return s(i)===s(r)}loadDismissals(){try{const e=localStorage.getItem(je);if(e){const r=JSON.parse(e);if(r&&typeof r=="object"&&!Array.isArray(r))return r}const t=localStorage.getItem(Jr);if(!t)return{};const i=JSON.parse(t);if(Array.isArray(i)){const r={};for(const s of i){const o=this.announcements.find(a=>a.id===s);o&&(r[s]=o.updated_at)}return localStorage.setItem(je,JSON.stringify(r)),r}return{}}catch{return{}}}saveDismissal(e){try{const t=this.announcements.find(r=>r.id===e);if(!t)return;const i={...this.dismissals,[e]:t.updated_at};this.dismissals=i,localStorage.setItem(je,JSON.stringify(i))}catch{}}destroy(){this.destroyed=!0,this.renderer.destroy(),this.closeListModal(),this.hideBanner(),this.routePoller&&(clearInterval(this.routePoller),this.routePoller=null),this.tickTimer&&(clearInterval(this.tickTimer),this.tickTimer=null)}getSurface(e){var i;const t=(i=e.trigger_config)==null?void 0:i.surface;return t==="banner"||t==="drawer"||t==="modal"?t:this.config.announcementSurface==="drawer"?"drawer":"modal"}splitHtmlFirstImage(e){try{const i=new DOMParser().parseFromString(e??"","text/html"),r=i.querySelector("img"),s=(r==null?void 0:r.getAttribute("src"))??null;return r&&r.remove(),{imgSrc:s,restHtml:i.body.innerHTML||""}}catch{return{imgSrc:null,restHtml:e??""}}}showBanner(e){var d;if(e.length===0){this.hideBanner();return}const t=e[0];if(!this.bannerEl){const u=document.createElement("div");u.id="guideai-announcement-banner",u.style.position="relative",u.style.zIndex="2147483640",u.style.width="100%",u.style.background="#0f172a",u.style.color="#ffffff",u.style.boxShadow="0 1px 0 rgba(0,0,0,0.08)",document.body.prepend(u),this.bannerEl=u}const{imgSrc:i,restHtml:r}=this.splitHtmlFirstImage(t.message),s=((d=t.trigger_config)==null?void 0:d.banner_image_position)==="end"?"end":"start",o=i?`<div class="guideai-announcement-banner-media" style="height:100%;flex:0 0 auto;display:flex;align-items:stretch;">
           <img src="${A(i)}" alt="" style="height:100%;width:auto;max-width:340px;object-fit:cover;display:block;" />
         </div>`:"",a=`
      <div style="flex:1;min-width:0;align-self:center;">
        <div style="font-weight:800;font-size:14px;line-height:1.2;margin-bottom:4px;color:#0b1220;">${A(t.title)}</div>
        <div style="font-size:13px;line-height:1.35;color:#0b1220;word-break:break-word;">${r}</div>
      </div>
    `;this.bannerEl.innerHTML=`
      <div style="max-width:100%;margin:0 auto;max-height:300px;overflow:hidden;background:#ffffff;border-bottom:1px solid rgba(15,23,42,0.08);">
        <div style="display:flex;gap:14px;align-items:stretch;max-height:300px;">
          ${s==="start"?o:""}
    ...
    `;const l=this.bannerEl.querySelector(".guideai-announcement-banner-close");l==null||l.addEventListener("click",()=>{this.dismissAnnouncement(t.id)});const c=this.bannerEl.querySelector(".guideai-announcement-banner-cta");c==null||c.addEventListener("click",()=>{document.dispatchEvent(new CustomEvent("guideai:chip-click",{detail:{guideId:t.linked_guide_id}})),this.dismissAnnouncement(t.id)})}hideBanner(){this.bannerEl&&(this.bannerEl.remove(),this.bannerEl=null)}}const Zr="/api/v1/announcements";class en{constructor(e,t,i,r){this.announcements=[],this.destroyed=!1,this.api=e,this.config=t,this.eventBuffer=i,this.shadowRoot=r,this.beaconManager=new Qr(e,t,r)}async init(){try{const e=await this.api.get(`${Zr}/active`);this.announcements=Array.isArray(e)?e:[]}catch{this.announcements=[]}this.announcements.length!==0&&this.beaconManager.init(this.announcements)}destroy(){this.destroyed=!0,this.beaconManager.destroy()}}const Dt={robot:`<svg viewBox="0 0 64 64" width="28" height="28" fill="none">
  ...
  <g class="guideai-crawl-leg-right">
    ...
    `;const r=i.querySelector(".guideai-chat-walkthrough-btn"),s=i.querySelector("input");r==null||r.addEventListener("click",()=>{var a,l,c;const o=((a=s==null?void 0:s.value)==null?void 0:a.trim())||t;(c=(l=this.callbacks)==null?void 0:l.onSaveWalkthrough)==null||c.call(l,o),r.textContent="Saved!",r.disabled=!0,s&&(s.disabled=!0)}),this.messagesEl.appendChild(i),requestAnimationFrame(()=>this.scrollToBottom())}showSupportButton(){if(!this.el)return;const e=this.el.querySelector(".guideai-chat-support-btn-wrap");e&&(e.style.display="")}isOpen(){return this.el!==null}showPauseButton(){this.pauseBtn&&(this.pauseBtn.style.display="",this.guidePaused=!1,this.updatePauseButton())}hidePauseButton(){this.pauseBtn&&(this.pauseBtn.style.display="none")}updatePauseButton(){this.pauseBtn&&(this.guidePaused?(this.pauseBtn.innerHTML=`${pn} Resume`,this.pauseBtn.setAttribute("aria-label","Resume guide")):(this.pauseBtn.innerHTML=`${zt} Pause`,this.pauseBtn.setAttribute("aria-label","Pause guide")))}handleSend(){if(!this.inputEl||!this.callbacks)return;const e=this.inputEl.value.trim();e&&(this.inputEl.value="",this.callbacks.onSend(e))}scrollToBottom(){this.messagesEl&&this.messagesEl.scrollTo({top:this.messagesEl.scrollHeight,behavior:"smooth"})}}const mn=["a[href]","button","input","select","textarea",'[role="button"]','[role="link"]','[role="tab"]','[role="menuitem"]',"[tabindex]"].join(","),Ft=50,Gt=30,qt=80;function Ut(){var i;const n=[],e=[],t=document.querySelectorAll(mn);for(let r=0;r<t.length&&!(n.length>=Ft&&e.length>=Gt);r++){const s=t[r];if(s.closest(".guideai-bubble, .guideai-chat, .guideai-chip")||s.closest("[data-guideai-shadow]"))continue;const o=s.tagName.toLowerCase(),a=te(s.getAttribute("aria-label")||s.placeholder||((i=s.textContent)==null?void 0:i.trim())||"");if(!a&&o!=="input"&&o!=="select"&&o!=="textarea")continue;const l=bn(s);if(l&&n.length<Ft)n.push({tag:o,text:a,selector:Wt(s),role:s.getAttribute("role")||void 0,type:s.type||void 0,placeholder:s.placeholder||void 0});else if(!l&&e.length<Gt){const c=yn(s);c&&e.push({tag:o,text:a,selector:Wt(s),role:s.getAttribute("role")||void 0,type:s.type||void 0,placeholder:s.placeholder||void 0,hidden:!0,container:c.name,containerState:c.state})}}return{url:location.href,title:document.title,elements:[...n,...e]}}function bn(n){if(n.offsetParent===null&&n.tagName!=="INPUT"&&n.tagName!=="BODY"||n.getAttribute("aria-hidden")==="true")return!1;const e=getComputedStyle(n);if(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")return!1;let t=n.parentElement;for(let i=0;t&&i<10;i++){const r=getComputedStyle(t);if(r.display==="none"||r.visibility==="hidden")return!1;if(r.overflow==="hidden"&&t.scrollHeight>0){const s=t.getBoundingClientRect();if(s.height===0||s.width===0)return!1}t=t.parentElement}return!0}function yn(n){var t;let e=n.parentElement;for(let i=0;e&&i<15;i++){const r=e.tagName.toLowerCase(),s=e.getAttribute("role"),o=e.getAttribute("aria-expanded"),a=e.getAttribute("aria-hidden"),l=(typeof e.className=="string"?e.className:"").toLowerCase();if(r==="details"&&!e.hasAttribute("open")){const c=e.querySelector("summary");return{name:((t=c==null?void 0:c.textContent)==null?void 0:t.trim())||"accordion",state:"collapsed"}}if(o==="false"||a==="true"){const c=ce(e),d=Vt(e,l,s);return{name:c||d,state:"collapsed"}}if(s==="menu"||s==="menubar"||s==="navigation"||r==="nav"){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden"||c.maxHeight==="0px"||c.height==="0px"||c.opacity==="0")return{name:ce(e)||Vt(e,l,s),state:"collapsed"};if(c.transform&&c.transform!=="none"){const d=e.getBoundingClientRect();if(d.right<0||d.left>window.innerWidth)return{name:ce(e)||"sidebar",state:"closed"}}}if(l.includes("sidebar")||l.includes("drawer")||l.includes("offcanvas")){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden"||c.transform&&c.transform!=="none"){const d=e.getBoundingClientRect();if(d.right<0||d.left>window.innerWidth||c.display==="none")return{name:ce(e)||"sidebar",state:"closed"}}}if(l.includes("dropdown")||l.includes("popover")||l.includes("popup")){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden"||c.opacity==="0")return{name:ce(e)||"dropdown menu",state:"closed"}}if(l.includes("modal")||l.includes("dialog")||s==="dialog"){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden")return{name:ce(e)||"dialog",state:"closed"}}if(s==="tabpanel"&&(getComputedStyle(e).display==="none"||e.getAttribute("hidden")!==null)){const d=e.getAttribute("aria-label")||e.getAttribute("aria-labelledby")||"tab";return{name:`"${te(d)}" tab`,state:"inactive"}}if((r==="nav"||r==="ul")&&l.includes("nav")&&getComputedStyle(e).display==="none")return{name:"navigation menu",state:"collapsed"};e=e.parentElement}return null}function ce(n){var s;const e=n.getAttribute("aria-label");if(e)return te(e);const t=n.getAttribute("aria-labelledby");if(t){const o=document.getElementById(t);if(o!=null&&o.textContent)return te(o.textContent.trim())}if(n.id){const o=document.querySelector(`[aria-controls="${n.id}"]`);if(o){const a=o.getAttribute("aria-label")||((s=o.textContent)==null?void 0:s.trim());if(a)return te(a)}}const i=n.querySelector(":scope > summary");if(i!=null&&i.textContent)return te(i.textContent.trim());const r=n.querySelector("h1, h2, h3, h4, h5, h6");return r!=null&&r.textContent?te(r.textContent.trim()):null}function Vt(n,e,t){return t==="menu"||t==="menubar"?"menu":t==="navigation"||n.tagName==="NAV"?"navigation menu":e.includes("hamburger")||e.includes("mobile-nav")||e.includes("mobile-menu")?"hamburger menu":e.includes("sidebar")||e.includes("sidenav")?"sidebar":e.includes("drawer")?"drawer":e.includes("dropdown")?"dropdown":e.includes("accordion")||e.includes("collapse")||e.includes("collapsible")?"accordion":e.includes("offcanvas")?"off-canvas menu":e.includes("popover")?"popover":e.includes("tooltip")?"tooltip":"hidden panel"}function Wt(n){const e=n.getAttribute("data-guideai");if(e)return`[data-guideai="${e}"]`;const t=n.getAttribute("data-testid");if(t)return`[data-testid="${t}"]`;if(n.id)return`#${n.id}`;const i=n.getAttribute("name");if(i)return`${n.tagName.toLowerCase()}[name="${i}"]`;const r=n.tagName.toLowerCase();if(r==="a"){const a=n.getAttribute("href");if(a)return`a[href="${a}"]`}if(r==="button"){const a=n.type,l=n.className&&typeof n.className=="string"?n.className.split(/\s+/).filter(c=>c&&!c.startsWith("guideai"))[0]:"";if(l)return`button.${l}`;if(a&&a!=="submit")return`button[type="${a}"]`}if(r==="input"){const a=n;if(a.type)return`input[type="${a.type}"]`}const s=[];let o=n;for(let a=0;o&&a<3;a++){let l=o.tagName.toLowerCase();if(o.className&&typeof o.className=="string"){const c=o.className.split(/\s+/).filter(d=>d&&!d.startsWith("guideai"))[0];c&&(l+=`.${c}`)}s.unshift(l),o=o.parentElement}return s.join(" > ")}function te(n){return n.length<=qt?n:n.slice(0,qt)}const vn=["backgroundColor","color","fontSize","fontWeight","fontFamily","paddingTop","paddingRight","paddingBottom","paddingLeft","borderRadius","borderTopWidth","borderTopColor","display","opacity","boxShadow","textAlign"],E=32,xn=new Set(["input","textarea","select","option"]),wn={block:0,inline:.2,"inline-block":.4,flex:.6,grid:.8,none:1};function kn(n){const e=window.getComputedStyle(n);let t="";for(const i of vn)t+=String(e[i]??"")+"|";return An(t)}function _n(n,e){return n===e?1:0}function En(n){const e=window.getComputedStyle(n),t=n.getBoundingClientRect(),i=window.innerWidth||1,r=window.innerHeight||1;return[D(e.fontSize)/72,(parseFloat(e.fontWeight)||400)/900,...jt(e.backgroundColor),...jt(e.color),D(e.paddingTop)/50,D(e.paddingRight)/50,D(e.paddingBottom)/50,D(e.paddingLeft)/50,D(e.borderRadius)/30,D(e.borderTopWidth)/10,Math.min(t.width/i,1),Math.min(t.height/r,1),parseFloat(e.opacity)||1,wn[e.display]??.5,e.boxShadow&&e.boxShadow!=="none"?1:0,D(e.borderTopWidth)>0?1:0,Math.min(n.childElementCount/20,1),Math.min(t.x/i,1),Math.min(t.y/r,1),t.height>0?Math.min(t.width/t.height/10,1):0]}function Sn(n,e){if(n.length!==e.length||n.length===0)return 0;let t=0,i=0,r=0;for(let o=0;o<n.length;o++)t+=n[o]*e[o],i+=n[o]*n[o],r+=e[o]*e[o];const s=Math.sqrt(i)*Math.sqrt(r);return s===0?0:t/s}function Cn(n){var r;const e=n.tagName.toLowerCase();if(xn.has(e)||n.offsetParent===null)return;const t=window.getComputedStyle(n),i=n.getBoundingClientRect();if(!(i.width===0||i.height===0))try{const s=document.createElement("canvas");s.width=E,s.height=E;const o=s.getContext("2d");if(!o)return;o.clearRect(0,0,E,E),o.fillStyle=t.backgroundColor||"transparent";const a=D(t.borderRadius);a>0?Ln(o,0,0,E,E,Math.min(a,E/2)*(E/Math.max(i.width,1))):o.fillRect(0,0,E,E);const l=D(t.borderTopWidth);l>0&&(o.strokeStyle=t.borderTopColor||"#000",o.lineWidth=Math.max(1,l*(E/Math.max(i.width,1))),o.strokeRect(1,1,E-2,E-2));const c=((r=n.textContent)==null?void 0:r.trim().length)??0;if(c>0){o.fillStyle=t.color||"#000";const u=Math.min(c*2,E-8),h=Math.min(D(t.fontSize)*(E/Math.max(i.height,1)),E/3),p=(E-u)/2,m=(E-h)/2;o.fillRect(p,m,u,h)}t.boxShadow&&t.boxShadow!=="none"&&(o.fillStyle="rgba(0,0,0,0.1)",o.fillRect(2,E-4,E-4,2));const d=o.getImageData(0,0,E,E);return In(d.data)}catch{return}}function Tn(n,e){if(!n||!e||n.length!==e.length)return 0;let t=0;for(let r=0;r<n.length;r++){const s=parseInt(n[r],16),o=parseInt(e[r],16),a=s^o;t+=4-Mn(a)}const i=n.length*4;return i===0?0:t/i}function An(n){let e=5381;for(let t=0;t<n.length;t++)e=(e<<5)+e+n.charCodeAt(t)|0;return(e>>>0).toString(16).padStart(8,"0")}function D(n){return parseFloat(n)||0}function jt(n){const e=n.match(/(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/);return e?[parseInt(e[1],10)/255,parseInt(e[2],10)/255,parseInt(e[3],10)/255]:[0,0,0]}function Ln(n,e,t,i,r,s){n.beginPath(),n.moveTo(e+s,t),n.arcTo(e+i,t,e+i,t+r,s),n.arcTo(e+i,t+r,e,t+r,s),n.arcTo(e,t+r,e,t,s),n.arcTo(e,t,e+i,t,s),n.closePath(),n.fill()}function In(n){const e=n.length/4,t=new Uint8Array(e);let i=0;for(let o=0;o<e;o++){const a=n[o*4],l=n[o*4+1],c=n[o*4+2];t[o]=a*.299+l*.587+c*.114|0,i+=t[o]}const r=i/e;let s="";for(let o=0;o<e;o+=4){let a=0;for(let l=0;l<4&&o+l<e;l++)t[o+l]>=r&&(a|=1<<3-l);s+=a.toString(16)}return s}function Mn(n){return n=n&15,n=n-(n>>1&5),n=(n&3)+(n>>2&3),n}function ie(n){const e=Pn(n),t=Rn(n),i=Hn(n),r=Nn(n),s=$n(n),o=On(n),a=e.score+t.score+i.score+r.score+s.score+o.score;return{tier1_stable:e,tier2_text:t,tier3_structural:i,tier4_context:r,tier5_position:s,tier6_visual:o,total_score:a}}function Pn(n){const e=n.getAttribute("data-guideai")??void 0,t=n.getAttribute("data-testid")??void 0,i=n.getAttribute("aria-label")??void 0,r=n.getAttribute("name")??void 0,s=n.id||void 0;let o=0;return e?o+=40:t?o+=38:(s||r||i)&&(o+=35),{data_guideai:e,data_testid:t,aria_label:i,name:r,id:s,score:o}}function Rn(n){const e=n,t=re(Kt(n),120),i=n.placeholder||n.getAttribute("placeholder")||void 0;let r;if(n.id){const a=document.querySelector(`label[for="${n.id}"]`);a&&(r=re(a.textContent??"",80))}if(!r){const a=n.closest("label");a&&(r=re(a.textContent??"",80))}const s=[];t&&s.push(t.toLowerCase()),i&&s.push(i.toLowerCase()),r&&s.push(r.toLowerCase()),e.title&&s.push(e.title.toLowerCase());let o=0;return t?o+=30:i?o+=28:r&&(o+=25),{text_content:t,placeholder:i,label:r,variants:s,score:o}}function Hn(n){const e=n.tagName.toLowerCase(),t=n.getAttribute("role")??void 0,i=Dn(n),r=Bn(n);let s=0;return e&&(s+=10),t&&(s+=5),i&&(s+=8),s+=Math.min(r,2),{tag:e,role:t,css_path:i,dom_depth:r,score:s}}function Nn(n){const e=n.parentElement,t=e?re(Kt(e),80):void 0,i=n.closest("form"),r=i&&(i.getAttribute("name")||i.getAttribute("aria-label")||i.id)||void 0,s=zn(n);let o=0;return s&&(o+=6),r&&(o+=5),t&&(o+=4),{parent_text:t,form_context:r,nearest_heading:s,score:o}}function $n(n){let e,t;try{const r=n.getBoundingClientRect();e={x:Math.round(r.x),y:Math.round(r.y),width:Math.round(r.width),height:Math.round(r.height)};const s=window.innerWidth,o=window.innerHeight,a=r.x+r.width/2,l=r.y+r.height/2,c=a<s/3?"left":a<2*s/3?"center":"right";t=`${l<o/3?"top":l<2*o/3?"middle":"bottom"}-${c}`}catch{}return{bounding_rect:e,relative_position:t,score:e?5:0}}function Kt(n){let e="";for(let t=0;t<n.childNodes.length;t++){const i=n.childNodes[t];i.nodeType===Node.TEXT_NODE&&(e+=i.textContent??"")}return e.trim()}function re(n,e){return n&&(n.length>e?n.slice(0,e):n)}function Dn(n){const e=[];let t=n,i=0;for(;t&&t!==document.documentElement&&i<5;){let r=t.tagName.toLowerCase();if(t.id){r+=`#${t.id}`,e.unshift(r);break}const s=t.parentElement;if(s){const o=s.children;let a=0,l=0;for(let c=0;c<o.length;c++)o[c].tagName===t.tagName&&(l++,o[c]===t&&(a=l));l>1&&(r+=`:nth-of-type(${a})`)}e.unshift(r),t=s,i++}return e.join(" > ")}function Bn(n){let e=0,t=n;for(;t&&t!==document.documentElement;)e++,t=t.parentElement;return e}function On(n){const e=kn(n),t=En(n),i=Cn(n);let r=0;return e&&(r+=8),t.length>0&&(r+=7),i&&(r+=5),{style_hash:e,style_vector:t,canvas_hash:i,score:r}}function zn(n){let e=n;for(;e;){let t=e.previousElementSibling;for(;t;){if(/^h[1-6]$/i.test(t.tagName))return re(t.textContent??"",80);const i=t.querySelector("h1,h2,h3,h4,h5,h6");if(i)return re(i.textContent??"",80);t=t.previousElementSibling}if(e=e.parentElement,e&&/^h[1-6]$/i.test(e.tagName))return re(e.textContent??"",80)}}function Fn(n){var e,t,i;return(((e=n.toggle)==null?void 0:e.getAttribute("aria-label"))||((i=(t=n.toggle)==null?void 0:t.textContent)==null?void 0:i.trim())||n.container.getAttribute("aria-label")||n.label||"Open menu").trim()}function Gn(n){const e=n.replace(/\s+/g," ").trim(),t=/^(open|show|expand)\b/i.test(e);return{title:t?e:`Open ${e}`,body:t?`Click ${e.toLowerCase()} to reveal the hidden navigation or content.`:`Click ${e.toLowerCase()} to reveal the hidden navigation or content.`}}class qn{constructor(e,t,i,r){this.renderer=null,this.guidePlayerFactory=null,this.destroyed=!1,this._helpSupportEnabled=!1,this.onBubbleClick=null,this.analyzer=null,this.lastWalkthroughSteps=null,this.lastWalkthroughTitle="",this.pauseGuideHandler=null,this.resumeGuideHandler=null,this.api=e,this.config=t,this.eventBuffer=i,this.shadowRoot=r}setGuidePlayerFactory(e){this.guidePlayerFactory=e}setAnalyzer(e){this.analyzer=e}setHelpSupportEnabled(e){this._helpSupportEnabled=e}setPauseResumeHandlers(e,t){this.pauseGuideHandler=e,this.resumeGuideHandler=t}async init(){this.onBubbleClick=()=>{this.destroyed||this.toggle()},document.addEventListener("guideai:bubble-click",this.onBubbleClick)}toggle(){var e;(e=this.renderer)!=null&&e.isOpen()?this.close():this.open()}open(){var e,t;(e=this.renderer)!=null&&e.isOpen()||(this.renderer=new fn(this.config,this.eventBuffer,this.shadowRoot),this.renderer.render({onClose:()=>this.close(),onSend:i=>this.handleSend(i),onStartWalkthrough:(i,r)=>this.handleStartWalkthrough(i,r),onSaveWalkthrough:i=>this.handleSaveWalkthrough(i),onPauseGuide:()=>{var i;return(i=this.pauseGuideHandler)==null?void 0:i.call(this)},onResumeGuide:()=>{var i;return(i=this.resumeGuideHandler)==null?void 0:i.call(this)}}),this._helpSupportEnabled&&this.renderer.showSupportButton(),(t=this.eventBuffer)==null||t.push(_(this.config.siteId,"chat_opened")))}close(){var e;(e=this.renderer)==null||e.remove(),this.renderer=null,document.dispatchEvent(new CustomEvent("guideai:resource-center-close"))}async handleSend(e){var r;if(!this.renderer)return;const t={role:"user",text:e};this.renderer.addMessage(t);const i=_(this.config.siteId,"chat_message_sent");i.element_text=e,(r=this.eventBuffer)==null||r.push(i),this.renderer.setLoading(!0);try{const s=Ut(),o=await this.api.post("/api/v1/chat/ask",{question:e,page_url:location.href,page_snapshot:s});if(!this.renderer)return;this.renderer.setLoading(!1);const a={role:"assistant",text:o.answer};o.guide_steps&&o.guide_steps.length>0&&(a.guideSteps=o.guide_steps.map(l=>{const c=l.action??"none";return{title:l.title??"",body:l.body??"",target_selector:l.target_selector,action:c,completion_hint:l.completion_hint}}),a.guideTitle=o.guide_title??"Walkthrough"),this.renderer.addMessage(a)}catch(s){if(!this.renderer)return;this.renderer.setLoading(!1);const o=s instanceof Error&&s.message.includes("404")?"Chat service is not available. Make sure the backend is running.":"Sorry, something went wrong. Please try again.";this.renderer.addMessage({role:"assistant",text:o}),typeof console<"u"&&console.warn("[GuideAI] Chat error:",s)}}handleStartWalkthrough(e,t){var o;if(!this.guidePlayerFactory)return;this.lastWalkthroughSteps=e,this.lastWalkthroughTitle=t,this.close();const i=this.generateUUID(),r=this.buildGuideSteps(e,i),s={id:i,site_id:this.config.siteId,title:t,status:"published",trigger_type:"manual",trigger_config:{},steps:r,tags:["chat-generated"],version:1,created_at:new Date().toISOString(),updated_at:new Date().toISOString()};(o=this.eventBuffer)==null||o.push(_(this.config.siteId,"chat_walkthrough_started",{guide_title:t,step_count:e.length})),this.guidePlayerFactory(s,()=>this.onWalkthroughComplete())}onWalkthroughComplete(){this.lastWalkthroughSteps&&(this.open(),setTimeout(()=>{var e;(e=this.renderer)==null||e.addSaveWalkthroughPrompt(this.lastWalkthroughSteps.length,this.lastWalkthroughTitle)},300))}async handleSaveWalkthrough(e){if(!this.lastWalkthroughSteps)return;const t=this.lastWalkthroughSteps,i={title:e||this.lastWalkthroughTitle||"Chat Walkthrough",description:`Guide created from chat walkthrough with ${t.length} steps`,steps:t.map((r,s)=>{const o=this.buildGuideStep(r,s);return{ordinal:s,step_type:o.step_type,target_selector:o.target_selector,target_fingerprint:o.target_fingerprint,content:o.content,action_config:o.action_config,page_url_pattern:o.page_url_pattern}})};try{await this.api.post("/api/v1/guides/record",i),this.lastWalkthroughSteps=null,this.lastWalkthroughTitle=""}catch(r){typeof console<"u"&&console.warn("[GuideAI] Failed to save walkthrough as guide:",r)}}buildGuideSteps(e,t){const i=[];let r=0;console.log("[GuideAI] Building guide steps, analyzer:",!!this.analyzer);const s=this.inferPagePatterns(e);for(let o=0;o<e.length;o++){const a=e[o],l=["click","fill","select","scroll","navigate","none"],c=a.action&&l.includes(a.action)?a.action:a.target_selector?"click":"none",d=this.extractTagFromSelector(a.target_selector),u=a.title||a.body||"";console.log(`[GuideAI] Step ${o}: "${u}", selector: "${a.target_selector}", page_url: "${s[o]}"`);const h=`chat_reveal_group_${o}`;let p=!1,m={tier1_stable:{score:0},tier2_text:{text_content:u,variants:u?[u.toLowerCase()]:[],score:u?25:0},tier3_structural:{tag:d,dom_depth:0,score:d?8:0},tier4_context:{score:0},tier5_position:{score:0},total_score:(u?25:0)+(d?8:0)};if(this.analyzer){const f={description:u,tag:d||void 0,text:u||void 0,selector:a.target_selector,fingerprint:m.total_score>0?m:void 0,actionType:c};try{const g=this.analyzer.resolveDetectOnly(f);if(console.log(`[GuideAI] Analyzer detect for step ${o}:`,{hasElement:!!g.element,isVisible:g.isVisible,requiresReveal:g.requiresReveal,revealPathLength:g.revealPath.length,revealReason:g.revealReason,revealConfidence:g.revealConfidence,score:g.score}),c!=="none"&&g.element&&g.requiresReveal&&g.revealPath.length>0){p=!0,console.log(`[GuideAI] Adding ${g.revealPath.length} reveal step(s) for hidden element`);const b=`chat_step_${r+g.revealPath.length}`;for(const y of g.revealPath){const S=y.toggle||y.container,v=ie(S),w=Fn(y),C=Gn(w);i.push({id:`chat_step_${r}`,guide_id:t,ordinal:r++,step_type:"tooltip",target_selector:"",target_fingerprint:v,page_url_pattern:s[o],content:{title:C.title,body:C.body},action_config:{action_type:"click",sensitive:!1,requires_confirmation:!1,allow_skip:!1},metadata:{requires_reveal:!0,reveal_for:b,reveal_group:h,reveal_confidence:g.revealConfidence??null,reveal_reason:g.revealReason??null}})}}g.element&&(m=ie(g.element),console.log("[GuideAI] Enriched fingerprint score:",m.total_score))}catch(g){console.warn("[GuideAI] Analyzer detection failed for step",o,g)}}i.push({id:`chat_step_${r}`,guide_id:t,ordinal:r++,step_type:"tooltip",target_selector:a.target_selector,target_fingerprint:m,page_url_pattern:s[o],content:{title:a.title,body:a.body},action_config:{action_type:c,sensitive:!1,requires_confirmation:!1,completion_hint:a.completion_hint},metadata:{reveal_required:p,reveal_group:h}})}return console.log(`[GuideAI] Built ${i.length} total steps (${e.length} original + reveal steps)`),i}inferPagePatterns(e){const t=[];let i=location.pathname;for(let r=0;r<e.length;r++){const s=e[r];t[r]=i;const o=this.inferNavigationTarget(s);o&&(console.log(`[GuideAI] Step ${r} navigates to "${o}" — subsequent steps expect that page`),i=o)}return t}inferNavigationTarget(e){const t=e.action||(e.target_selector?"click":"none");if(!(t==="click"||t==="navigate"))return null;if(e.target_selector)try{const a=document.querySelector(e.target_selector);if(a){const l=a.tagName==="A"?a:a.closest("a");if(l!=null&&l.href){const c=l.getAttribute("href");if(c&&c!=="#"&&!c.startsWith("javascript:"))try{if(c.startsWith("/"))return c.split("?")[0].split("#")[0];if(c.startsWith("http"))return new URL(c).pathname}catch{}}}}catch{}if(e.target_selector){const a=e.target_selector.match(/a\[href=['"]?([^'"\]]+)['"]?\]/);if(a!=null&&a[1]){const l=a[1];if(l.startsWith("/"))return l.split("?")[0].split("#")[0]}}const r=((e.title||"")+" "+(e.body||"")).toLowerCase(),s=r.match(/(?:navigate|go)\s+to\s+(\/[a-z0-9\-/]+)/);if(s!=null&&s[1])return s[1];const o=[/(?:click|go to|navigate to|visit)\s+(?:the\s+)?["']?([a-z][a-z\s]*?)["']?\s+(?:link|page|tab|button|menu item)/,/(?:click|go to|navigate to|visit)\s+["']([^"']+)["']/];for(const a of o){const l=r.match(a);if(l!=null&&l[1]){const c=l[1].trim(),d=this.findLinkHrefByText(c);if(d)return d}}return null}findLinkHrefByText(e){const t=e.toLowerCase().trim();if(!t)return null;try{const i=document.querySelectorAll("a[href]");for(let r=0;r<i.length;r++){const s=i[r],o=(s.textContent||"").toLowerCase().trim();if(o.includes(t)||t.includes(o)){const a=s.getAttribute("href");if(a&&a!=="#"&&!a.startsWith("javascript:")){if(a.startsWith("/"))return a.split("?")[0].split("#")[0];try{if(a.startsWith("http"))return new URL(a).pathname}catch{}}}}}catch{}return null}buildGuideStep(e,t){const i=["click","fill","select","scroll","navigate","none"],r=e.action&&i.includes(e.action)?e.action:e.target_selector?"click":"none",s=this.extractTagFromSelector(e.target_selector),o=e.title||e.body||"";let a={tier1_stable:{score:0},tier2_text:{text_content:o,variants:o?[o.toLowerCase()]:[],score:o?25:0},tier3_structural:{tag:s,dom_depth:0,score:s?8:0},tier4_context:{score:0},tier5_position:{score:0},total_score:(o?25:0)+(s?8:0)};if(this.analyzer){const l={description:o,tag:s||void 0,text:o||void 0,selector:e.target_selector,fingerprint:a.total_score>0?a:void 0,actionType:r},c=this.analyzer.resolveSync(l);c.element&&(a=ie(c.element))}return{id:`chat_step_${t}`,guide_id:"",ordinal:t,step_type:"tooltip",target_selector:e.target_selector,target_fingerprint:a,content:{title:e.title,body:e.body},action_config:{action_type:r,sensitive:!1,requires_confirmation:!1,completion_hint:e.completion_hint}}}extractTagFromSelector(e){if(!e)return"";const t=e.match(/^([a-z][a-z0-9]*)/i);return t?t[1].toLowerCase():""}generateUUID(){return typeof crypto<"u"&&crypto.randomUUID?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}destroy(){var e;this.destroyed=!0,this.onBubbleClick&&(document.removeEventListener("guideai:bubble-click",this.onBubbleClick),this.onBubbleClick=null),(e=this.renderer)==null||e.remove(),this.renderer=null}}/*! noble-ciphers - MIT License (c) 2023 Paul Miller (paulmillr.com) */function Un(n){return n instanceof Uint8Array||ArrayBuffer.isView(n)&&n.constructor.name==="Uint8Array"}function M(n,e,t=""){const i=Un(n),r=n==null?void 0:n.length,s=e!==void 0;if(!i||s&&r!==e){const o=t&&`"${t}" `,a=s?` of length ${e}`:"",l=i?`length=${r}`:`type=${typeof n}`;throw new Error(o+"expected Uint8Array"+a+", got "+l)}return n}function Se(n,e=!0){if(n.destroyed)throw new Error("Hash instance has been destroyed");if(e&&n.finished)throw new Error("Hash#digest() has already been called")}function Yt(n,e){M(n,void 0,"output");const t=e.outputLen;if(n.length<t)throw new Error("digestInto() expects output buffer of length at least "+t)}function Vn(n){return new Uint8Array(n.buffer,n.byteOffset,n.byteLength)}function V(n){return new Uint32Array(n.buffer,n.byteOffset,Math.floor(n.byteLength/4))}function W(...n){for(let e=0;e<n.length;e++)n[e].fill(0)}function Ce(n){return new DataView(n.buffer,n.byteOffset,n.byteLength)}const Wn=new Uint8Array(new Uint32Array([287454020]).buffer)[0]===68;function jn(n,e){if(n.length!==e.length)return!1;let t=0;for(let i=0;i<n.length;i++)t|=n[i]^e[i];return t===0}const Kn=(n,e)=>{function t(i,...r){if(M(i,void 0,"key"),!Wn)throw new Error("Non little-endian hardware is not yet supported");if(n.nonceLength!==void 0){const d=r[0];M(d,n.varSizeNonce?void 0:n.nonceLength,"nonce")}const s=n.tagLength;s&&r[1]!==void 0&&M(r[1],void 0,"AAD");const o=e(i,...r),a=(d,u)=>{if(u!==void 0){if(d!==2)throw new Error("cipher output not supported");M(u,void 0,"output")}};let l=!1;return{encrypt(d,u){if(l)throw new Error("cannot encrypt() twice with same key + nonce");return l=!0,M(d),a(o.encrypt.length,u),o.encrypt(d,u)},decrypt(d,u){if(M(d),s&&d.length<s)throw new Error('"ciphertext" expected length bigger than tagLength='+s);return a(o.decrypt.length,u),o.decrypt(d,u)}}}return Object.assign(t,n),t};function Yn(n,e,t=!0){if(e===void 0)return new Uint8Array(n);if(e.length!==n)throw new Error('"output" expected Uint8Array of length '+n+", got: "+e.length);if(t&&!Te(e))throw new Error("invalid output, must be aligned");return e}function Xn(n,e,t){const i=new Uint8Array(16),r=Ce(i);return r.setBigUint64(0,BigInt(e),t),r.setBigUint64(8,BigInt(n),t),i}function Te(n){return n.byteOffset%4===0}function ne(n){return Uint8Array.from(n)}function Jn(n=32){const e=typeof globalThis=="object"?globalThis.crypto:null;if(typeof(e==null?void 0:e.getRandomValues)!="function")throw new Error("crypto.getRandomValues must be defined");return e.getRandomValues(new Uint8Array(n))}const j=16,Ye=new Uint8Array(16),z=V(Ye),Qn=225,Zn=(n,e,t,i)=>{const r=i&1;return{s3:t<<31|i>>>1,s2:e<<31|t>>>1,s1:n<<31|e>>>1,s0:n>>>1^Qn<<24&-(r&1)}},H=n=>(n>>>0&255)<<24|(n>>>8&255)<<16|(n>>>16&255)<<8|n>>>24&255|0;function es(n){n.reverse();const e=n[15]&1;let t=0;for(let i=0;i<n.length;i++){const r=n[i];n[i]=r>>>1|t,t=(r&1)<<7}return n[0]^=-e&225,n}const ts=n=>n>64*1024?8:n>1024?4:2;class Xt{constructor(e,t){x(this,"blockLen",j);x(this,"outputLen",j);x(this,"s0",0);x(this,"s1",0);x(this,"s2",0);x(this,"s3",0);x(this,"finished",!1);x(this,"t");x(this,"W");x(this,"windowSize");M(e,16,"key"),e=ne(e);const i=Ce(e);let r=i.getUint32(0,!1),s=i.getUint32(4,!1),o=i.getUint32(8,!1),a=i.getUint32(12,!1);const l=[];for(let m=0;m<128;m++)l.push({s0:H(r),s1:H(s),s2:H(o),s3:H(a)}),{s0:r,s1:s,s2:o,s3:a}=Zn(r,s,o,a);const c=ts(t||1024);if(![1,2,4,8].includes(c))throw new Error("ghash: invalid window size, expected 2, 4 or 8");this.W=c;const u=128/c,h=this.windowSize=2**c,p=[];for(let m=0;m<u;m++)for(let f=0;f<h;f++){let g=0,b=0,y=0,S=0;for(let v=0;v<c;v++){if(!(f>>>c-v-1&1))continue;const{s0:C,s1:R,s2:$,s3:oe}=l[c*m+v];g^=C,b^=R,y^=$,S^=oe}p.push({s0:g,s1:b,s2:y,s3:S})}this.t=p}_updateBlock(e,t,i,r){e^=this.s0,t^=this.s1,i^=this.s2,r^=this.s3;const{W:s,t:o,windowSize:a}=this;let l=0,c=0,d=0,u=0;const h=(1<<s)-1;let p=0;for(const m of[e,t,i,r])for(let f=0;f<4;f++){const g=m>>>8*f&255;for(let b=8/s-1;b>=0;b--){const y=g>>>s*b&h,{s0:S,s1:v,s2:w,s3:C}=o[p*a+y];l^=S,c^=v,d^=w,u^=C,p+=1}}this.s0=l,this.s1=c,this.s2=d,this.s3=u}update(e){Se(this),M(e),e=ne(e);const t=V(e),i=Math.floor(e.length/j),r=e.length%j;for(let s=0;s<i;s++)this._updateBlock(t[s*4+0],t[s*4+1],t[s*4+2],t[s*4+3]);return r&&(Ye.set(e.subarray(i*j)),this._updateBlock(z[0],z[1],z[2],z[3]),W(z)),this}destroy(){const{t:e}=this;for(const t of e)t.s0=0,t.s1=0,t.s2=0,t.s3=0}digestInto(e){Se(this),Yt(e,this),this.finished=!0;const{s0:t,s1:i,s2:r,s3:s}=this,o=V(e);return o[0]=t,o[1]=i,o[2]=r,o[3]=s,e}digest(){const e=new Uint8Array(j);return this.digestInto(e),this.destroy(),e}}class is extends Xt{constructor(e,t){M(e);const i=es(ne(e));super(i,t),W(i)}update(e){Se(this),M(e),e=ne(e);const t=V(e),i=e.length%j,r=Math.floor(e.length/j);for(let s=0;s<r;s++)this._updateBlock(H(t[s*4+3]),H(t[s*4+2]),H(t[s*4+1]),H(t[s*4+0]));return i&&(Ye.set(e.subarray(r*j)),this._updateBlock(H(z[3]),H(z[2]),H(z[1]),H(z[0])),W(z)),this}digestInto(e){Se(this),Yt(e,this),this.finished=!0;const{s0:t,s1:i,s2:r,s3:s}=this,o=V(e);return o[0]=t,o[1]=i,o[2]=r,o[3]=s,e.reverse()}}function Jt(n){const e=(i,r)=>n(r,i.length).update(i).digest(),t=n(new Uint8Array(16),0);return e.outputLen=t.outputLen,e.blockLen=t.blockLen,e.create=(i,r)=>n(i,r),e}const Qt=Jt((n,e)=>new Xt(n,e));Jt((n,e)=>new is(n,e));const Xe=16,rs=4,Ae=new Uint8Array(Xe),ns=283;function ss(n){if(![16,24,32].includes(n.length))throw new Error('"aes key" expected Uint8Array of length 16/24/32, got length='+n.length)}function Je(n){return n<<1^ns&-(n>>7)}function Zt(n,e){let t=0;for(;e>0;e>>=1)t^=n&-(e&1),n=Je(n);return t}const os=(()=>{const n=new Uint8Array(256);for(let t=0,i=1;t<256;t++,i^=Je(i))n[t]=i;const e=new Uint8Array(256);e[0]=99;for(let t=0;t<255;t++){let i=n[255-t];i|=i<<8,e[n[t]]=(i^i>>4^i>>5^i>>6^i>>7^99)&255}return W(n),e})(),as=n=>n<<24|n>>>8,Qe=n=>n<<8|n>>>24;function ls(n,e){if(n.length!==256)throw new Error("Wrong sbox length");const t=new Uint32Array(256).map((c,d)=>e(n[d])),i=t.map(Qe),r=i.map(Qe),s=r.map(Qe),o=new Uint32Array(256*256),a=new Uint32Array(256*256),l=new Uint16Array(256*256);for(let c=0;c<256;c++)for(let d=0;d<256;d++){const u=c*256+d;o[u]=t[c]^i[d],a[u]=r[c]^s[d],l[u]=n[c]<<8|n[d]}return{sbox:n,sbox2:l,T0:t,T1:i,T2:r,T3:s,T01:o,T23:a}}const ei=ls(os,n=>Zt(n,3)<<24|n<<16|n<<8|Zt(n,2)),cs=(()=>{const n=new Uint8Array(16);for(let e=0,t=1;e<16;e++,t=Je(t))n[e]=t;return n})();function ds(n){M(n);const e=n.length;ss(n);const{sbox2:t}=ei,i=[];Te(n)||i.push(n=ne(n));const r=V(n),s=r.length,o=l=>pe(t,l,l,l,l),a=new Uint32Array(e+28);a.set(r);for(let l=s;l<a.length;l++){let c=a[l-1];l%s===0?c=o(as(c))^cs[l/s-1]:s>6&&l%s===4&&(c=o(c)),a[l]=a[l-s]^c}return W(...i),a}function Le(n,e,t,i,r,s){return n[t<<8&65280|i>>>8&255]^e[r>>>8&65280|s>>>24&255]}function pe(n,e,t,i,r){return n[e&255|t&65280]|n[i>>>16&255|r>>>16&65280]<<16}function ti(n,e,t,i,r){const{sbox2:s,T01:o,T23:a}=ei;let l=0;e^=n[l++],t^=n[l++],i^=n[l++],r^=n[l++];const c=n.length/4-2;for(let m=0;m<c;m++){const f=n[l++]^Le(o,a,e,t,i,r),g=n[l++]^Le(o,a,t,i,r,e),b=n[l++]^Le(o,a,i,r,e,t),y=n[l++]^Le(o,a,r,e,t,i);e=f,t=g,i=b,r=y}const d=n[l++]^pe(s,e,t,i,r),u=n[l++]^pe(s,t,i,r,e),h=n[l++]^pe(s,i,r,e,t),p=n[l++]^pe(s,r,e,t,i);return{s0:d,s1:u,s2:h,s3:p}}function Ie(n,e,t,i,r){M(t,Xe,"nonce"),M(i),r=Yn(i.length,r);const s=t,o=V(s),a=Ce(s),l=V(i),c=V(r),d=e?0:12,u=i.length;let h=a.getUint32(d,e),{s0:p,s1:m,s2:f,s3:g}=ti(n,o[0],o[1],o[2],o[3]);for(let y=0;y+4<=l.length;y+=4)c[y+0]=l[y+0]^p,c[y+1]=l[y+1]^m,c[y+2]=l[y+2]^f,c[y+3]=l[y+3]^g,h=h+1>>>0,a.setUint32(d,h,e),{s0:p,s1:m,s2:f,s3:g}=ti(n,o[0],o[1],o[2],o[3]);const b=Xe*Math.floor(l.length/rs);if(b<u){const y=new Uint32Array([p,m,f,g]),S=Vn(y);for(let v=b,w=0;v<u;v++,w++)r[v]=i[v]^S[w];W(y)}return r}function us(n,e,t,i,r){const s=r?r.length:0,o=n.create(t,i.length+s);r&&o.update(r);const a=Xn(8*i.length,8*s,e);o.update(i),o.update(a);const l=o.digest();return W(a),l}const hs=Kn({blockSize:16,nonceLength:12,tagLength:16,varSizeNonce:!0},function(e,t,i){if(t.length<8)throw new Error("aes/gcm: invalid nonce length");const r=16;function s(a,l,c){const d=us(Qt,!1,a,c,i);for(let u=0;u<l.length;u++)d[u]^=l[u];return d}function o(){const a=ds(e),l=Ae.slice(),c=Ae.slice();if(Ie(a,!1,c,c,l),t.length===12)c.set(t);else{const u=Ae.slice();Ce(u).setBigUint64(8,BigInt(t.length*8),!1);const p=Qt.create(l).update(t).update(u);p.digestInto(c),p.destroy()}const d=Ie(a,!1,c,Ae);return{xk:a,authKey:l,counter:c,tagMask:d}}return{encrypt(a){const{xk:l,authKey:c,counter:d,tagMask:u}=o(),h=new Uint8Array(a.length+r),p=[l,c,d,u];Te(a)||p.push(a=ne(a)),Ie(l,!1,d,a,h.subarray(0,a.length));const m=s(c,u,h.subarray(0,h.length-r));return p.push(m),h.set(m,a.length),W(...p),h},decrypt(a){const{xk:l,authKey:c,counter:d,tagMask:u}=o(),h=[l,c,u,d];Te(a)||h.push(a=ne(a));const p=a.subarray(0,-r),m=a.subarray(-r),f=s(c,u,p);if(h.push(f),!jn(f,m))throw new Error("aes/gcm: invalid ghash tag");const g=Ie(l,!1,d,p);return W(...h),g}}});/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */function gs(n){return n instanceof Uint8Array||ArrayBuffer.isView(n)&&n.constructor.name==="Uint8Array"}function Ze(n,e=""){if(!Number.isSafeInteger(n)||n<0){const t=e&&`"${e}" `;throw new Error(`${t}expected integer >= 0, got ${n}`)}}function fe(n,e,t=""){const i=gs(n),r=n==null?void 0:n.length,s=e!==void 0;if(!i||s&&r!==e){const o=t&&`"${t}" `,a=s?` of length ${e}`:"",l=i?`length=${r}`:`type=${typeof n}`;throw new Error(o+"expected Uint8Array"+a+", got "+l)}return n}function et(n){if(typeof n!="function"||typeof n.create!="function")throw new Error("Hash must wrapped by utils.createHasher");Ze(n.outputLen),Ze(n.blockLen)}function Me(n,e=!0){if(n.destroyed)throw new Error("Hash instance has been destroyed");if(e&&n.finished)throw new Error("Hash#digest() has already been called")}function ps(n,e){fe(n,void 0,"digestInto() output");const t=e.outputLen;if(n.length<t)throw new Error('"digestInto() output" expected to be of length >='+t)}function me(...n){for(let e=0;e<n.length;e++)n[e].fill(0)}function tt(n){return new DataView(n.buffer,n.byteOffset,n.byteLength)}function F(n,e){return n<<32-e|n>>>e}function fs(n,e={}){const t=(r,s)=>n(s).update(r).digest(),i=n(void 0);return t.outputLen=i.outputLen,t.blockLen=i.blockLen,t.create=r=>n(r),Object.assign(t,e),Object.freeze(t)}const ms=n=>({oid:Uint8Array.from([6,9,96,134,72,1,101,3,4,2,n])});class ii{constructor(e,t){x(this,"oHash");x(this,"iHash");x(this,"blockLen");x(this,"outputLen");x(this,"finished",!1);x(this,"destroyed",!1);if(et(e),fe(t,void 0,"key"),this.iHash=e.create(),typeof this.iHash.update!="function")throw new Error("Expected instance of class which extends utils.Hash");this.blockLen=this.iHash.blockLen,this.outputLen=this.iHash.outputLen;const i=this.blockLen,r=new Uint8Array(i);r.set(t.length>i?e.create().update(t).digest():t);for(let s=0;s<r.length;s++)r[s]^=54;this.iHash.update(r),this.oHash=e.create();for(let s=0;s<r.length;s++)r[s]^=106;this.oHash.update(r),me(r)}update(e){return Me(this),this.iHash.update(e),this}digestInto(e){Me(this),fe(e,this.outputLen,"output"),this.finished=!0,this.iHash.digestInto(e),this.oHash.update(e),this.oHash.digestInto(e),this.destroy()}digest(){const e=new Uint8Array(this.oHash.outputLen);return this.digestInto(e),e}_cloneInto(e){e||(e=Object.create(Object.getPrototypeOf(this),{}));const{oHash:t,iHash:i,finished:r,destroyed:s,blockLen:o,outputLen:a}=this;return e=e,e.finished=r,e.destroyed=s,e.blockLen=o,e.outputLen=a,e.oHash=t._cloneInto(e.oHash),e.iHash=i._cloneInto(e.iHash),e}clone(){return this._cloneInto()}destroy(){this.destroyed=!0,this.oHash.destroy(),this.iHash.destroy()}}const it=(n,e,t)=>new ii(n,e).update(t).digest();it.create=(n,e)=>new ii(n,e);function bs(n,e,t){return et(n),t===void 0&&(t=new Uint8Array(n.outputLen)),it(n,t,e)}const rt=Uint8Array.of(0),ri=Uint8Array.of();function ys(n,e,t,i=32){et(n),Ze(i,"length");const r=n.outputLen;if(i>255*r)throw new Error("Length must be <= 255*HashLen");const s=Math.ceil(i/r);t===void 0?t=ri:fe(t,void 0,"info");const o=new Uint8Array(s*r),a=it.create(n,e),l=a._cloneInto(),c=new Uint8Array(a.outputLen);for(let d=0;d<s;d++)rt[0]=d+1,l.update(d===0?ri:c).update(t).update(rt).digestInto(c),o.set(c,r*d),a._cloneInto(l);return a.destroy(),l.destroy(),me(c,rt),o.slice(0,i)}const vs=(n,e,t,i,r)=>ys(n,bs(n,e,t),i,r);function xs(n,e,t){return n&e^~n&t}function ws(n,e,t){return n&e^n&t^e&t}class ks{constructor(e,t,i,r){x(this,"blockLen");x(this,"outputLen");x(this,"padOffset");x(this,"isLE");x(this,"buffer");x(this,"view");x(this,"finished",!1);x(this,"length",0);x(this,"pos",0);x(this,"destroyed",!1);this.blockLen=e,this.outputLen=t,this.padOffset=i,this.isLE=r,this.buffer=new Uint8Array(e),this.view=tt(this.buffer)}update(e){Me(this),fe(e);const{view:t,buffer:i,blockLen:r}=this,s=e.length;for(let o=0;o<s;){const a=Math.min(r-this.pos,s-o);if(a===r){const l=tt(e);for(;r<=s-o;o+=r)this.process(l,o);continue}i.set(e.subarray(o,o+a),this.pos),this.pos+=a,o+=a,this.pos===r&&(this.process(t,0),this.pos=0)}return this.length+=e.length,this.roundClean(),this}digestInto(e){Me(this),ps(e,this),this.finished=!0;const{buffer:t,view:i,blockLen:r,isLE:s}=this;let{pos:o}=this;t[o++]=128,me(this.buffer.subarray(o)),this.padOffset>r-o&&(this.process(i,0),o=0);for(let u=o;u<r;u++)t[u]=0;i.setBigUint64(r-8,BigInt(this.length*8),s),this.process(i,0);const a=tt(e),l=this.outputLen;if(l%4)throw new Error("_sha2: outputLen must be aligned to 32bit");const c=l/4,d=this.get();if(c>d.length)throw new Error("_sha2: outputLen bigger than state");for(let u=0;u<c;u++)a.setUint32(4*u,d[u],s)}digest(){const{buffer:e,outputLen:t}=this;this.digestInto(e);const i=e.slice(0,t);return this.destroy(),i}_cloneInto(e){e||(e=new this.constructor),e.set(...this.get());const{blockLen:t,buffer:i,length:r,finished:s,destroyed:o,pos:a}=this;return e.destroyed=o,e.finished=s,e.length=r,e.pos=a,r%t&&e.buffer.set(i),e}clone(){return this._cloneInto()}}const K=Uint32Array.from([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]),_s=Uint32Array.from([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]),Y=new Uint32Array(64);class Es extends ks{constructor(e){super(64,e,8,!1)}get(){const{A:e,B:t,C:i,D:r,E:s,F:o,G:a,H:l}=this;return[e,t,i,r,s,o,a,l]}set(e,t,i,r,s,o,a,l){this.A=e|0,this.B=t|0,this.C=i|0,this.D=r|0,this.E=s|0,this.F=o|0,this.G=a|0,this.H=l|0}process(e,t){for(let u=0;u<16;u++,t+=4)Y[u]=e.getUint32(t,!1);for(let u=16;u<64;u++){const h=Y[u-15],p=Y[u-2],m=F(h,7)^F(h,18)^h>>>3,f=F(p,17)^F(p,19)^p>>>10;Y[u]=f+Y[u-7]+m+Y[u-16]|0}let{A:i,B:r,C:s,D:o,E:a,F:l,G:c,H:d}=this;for(let u=0;u<64;u++){const h=F(a,6)^F(a,11)^F(a,25),p=d+h+xs(a,l,c)+_s[u]+Y[u]|0,f=(F(i,2)^F(i,13)^F(i,22))+ws(i,r,s)|0;d=c,c=l,l=a,a=o+p|0,o=s,s=r,r=i,i=p+f|0}i=i+this.A|0,r=r+this.B|0,s=s+this.C|0,o=o+this.D|0,a=a+this.E|0,l=l+this.F|0,c=c+this.G|0,d=d+this.H|0,this.set(i,r,s,o,a,l,c,d)}roundClean(){me(Y)}destroy(){this.set(0,0,0,0,0,0,0,0),me(this.buffer)}}class Ss extends Es{constructor(){super(32);x(this,"A",K[0]|0);x(this,"B",K[1]|0);x(this,"C",K[2]|0);x(this,"D",K[3]|0);x(this,"E",K[4]|0);x(this,"F",K[5]|0);x(this,"G",K[6]|0);x(this,"H",K[7]|0)}}const Cs=fs(()=>new Ss,ms(1)),Ts=new TextEncoder().encode("guideai-sdk-encryption-v1"),As=new TextEncoder().encode("aes-256-gcm");class Ls{constructor(e,t){this.ready=!1,this.siteId=e;try{const i=new TextEncoder().encode(t);this.aesKey=vs(Cs,i,Ts,As,32),this.ready=!0}catch(i){typeof console<"u"&&console.warn("[GuideAI] Encryption key derivation failed:",i),this.aesKey=new Uint8Array(0),this.ready=!1}}isReady(){return this.ready}async init(){}encrypt(e){if(!this.ready)return null;try{const t=Jn(12),i=new TextEncoder().encode(JSON.stringify(e)),s=hs(this.aesKey,t).encrypt(i);return{v:2,kid:this.siteId,iv:this.toBase64Url(t),ct:this.toBase64Url(s)}}catch(t){return typeof console<"u"&&console.warn("[GuideAI] Encryption failed; sending plaintext:",t),null}}encryptToBlob(e){const t=this.encrypt(e);return t?new Blob([JSON.stringify(t)],{type:"application/json"}):null}toBase64Url(e){let t="";for(let i=0;i<e.length;i++)t+=String.fromCharCode(e[i]);return btoa(t).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}}function T(n){if(!(n instanceof HTMLElement))return console.log("[Visibility] Element is not HTMLElement"),!1;const e=getComputedStyle(n);if(e.display==="none")return console.log("[Visibility] ❌ Element hidden: display: none"),!1;if(e.visibility==="hidden")return console.log("[Visibility] ❌ Element hidden: visibility: hidden"),!1;if(e.opacity==="0")return console.log("[Visibility] ❌ Element hidden: opacity: 0"),!1;if(n.hasAttribute("hidden"))return console.log("[Visibility] ❌ Element hidden: [hidden] attribute"),!1;if(n.getAttribute("aria-hidden")==="true")return console.log('[Visibility] ❌ Element hidden: aria-hidden="true"'),!1;const t=n.getBoundingClientRect();if(t.width===0||t.height===0)return console.log(`[Visibility] ❌ Element hidden: zero size (${t.width}x${t.height})`),!1;if(n.offsetParent===null&&!["fixed","sticky","absolute"].includes(e.position)&&console.log("[Visibility] ⚠️ offsetParent is null, continuing with geometric checks"),e.opacity==="0"){const a=e.transition||"",l=e.animation||"";if(a.includes("opacity")||l)return console.log("[Visibility] ⏳ Element is animating (opacity: 0, has transition/animation)"),!1}if(e.transform&&e.transform!=="none"){if(/scale[XY]?\(0\.?0*\)/.test(e.transform))return console.log("[Visibility] ❌ Element hidden: transform: scale(0)"),!1;const a=e.transform.match(/translateX?\((-?\d+(?:\.\d+)?)(px|%)\)/);if(a){const l=parseFloat(a[1]),c=a[2];if(c==="px"&&Math.abs(l)>5e3)return console.log(`[Visibility] ❌ Element hidden: translateX(${l}px)`),!1;if(c==="%"&&Math.abs(l)>=100)return console.log(`[Visibility] ❌ Element hidden: translateX(${l}%)`),!1}}if(t.height>0&&t.height<5){const a=e.overflow||e.overflowY;if(a==="hidden"||a==="clip")return console.log(`[Visibility] ❌ Element hidden: height < 5px with overflow:${a}`),!1}if(e.pointerEvents==="none"){const a=n.tagName.toLowerCase(),l=n.getAttribute("role");(a==="button"||a==="a"||a==="input"||a==="select"||a==="textarea"||l==="button"||l==="link"||l==="tab")&&console.log(`[Visibility] ⚠️ Element has pointer-events:none but is interactive type (${a}, role=${l})`)}if(e.clipPath&&e.clipPath!=="none"&&(e.clipPath.includes("inset(100%)")||e.clipPath.includes("inset(50% 50% 50% 50%)")||/polygon\(0\D+0\D+0\D+0\D+0\D+0\D+0\D+0\)/.test(e.clipPath)))return console.log(`[Visibility] ❌ Element hidden: clip-path: ${e.clipPath}`),!1;const i=t.right<-(window.innerWidth*2),r=t.left>window.innerWidth*3,s=t.bottom<-(window.innerHeight*2),o=t.top>window.innerHeight*3;return i||r||s||o?(console.log("[Visibility] ❌ Element hidden: way off-screen (likely off-canvas menu)"),!1):(console.log("[Visibility] ✅ Element is visible (or scrollable into view)"),!0)}function Pe(n){console.log("%c🔍 [Visibility] Searching for expandable ancestors...","color: #ff9800; font-weight: bold");const e=[];let t=n.parentElement,i=0;for(;t&&t!==document.body;){if(i++,t.tagName.toLowerCase(),t.tagName==="DETAILS"&&!t.open){const r=t.querySelector("summary");console.log(`[Visibility] Found collapsed <details> at depth ${i}`,{element:t,toggle:r}),e.unshift({container:t,toggle:r,kind:"details"})}else if(t.getAttribute("aria-expanded")==="false")console.log(`[Visibility] Found aria-expanded="false" at depth ${i}`,t),e.unshift({container:t,toggle:t,kind:"aria-expanded"});else if(t.id){const r=document.querySelector(`[aria-controls="${t.id}"][aria-expanded="false"]`);r&&(console.log(`[Visibility] Found aria-controls toggle at depth ${i}`,{container:t,toggle:r}),e.unshift({container:t,toggle:r,kind:"aria-expanded"}))}else if(t.getAttribute("role")==="tabpanel"&&t.getAttribute("aria-hidden")==="true"){const r=t.getAttribute("aria-labelledby"),s=r?document.getElementById(r):null;console.log(`[Visibility] Found hidden tabpanel at depth ${i}`,{container:t,tab:s}),e.unshift({container:t,toggle:s,kind:"tabpanel"})}else if(!T(t)){const r=(t.className||"").toString().toLowerCase();if(/sidebar|drawer|offcanvas|off-canvas|dropdown|popover|modal|hamburger|mobile-nav|navbar-links|menu/.test(r)){let s=null;t.id&&(s=document.querySelector(`[aria-controls="${t.id}"]`)),!s&&t.parentElement&&(s=t.parentElement.querySelector('button.navbar-toggle, button.hamburger, [aria-label*="menu" i]')),s||(console.log("[Visibility] No toggle found via parent search, trying global inference..."),s=Is(t)),console.log(`[Visibility] Found hidden container via class pattern at depth ${i}`,{container:t,classes:r,toggle:s}),e.unshift({container:t,toggle:s,kind:"class-pattern"})}}t=t.parentElement}return e.length>0?console.log(`%c✅ [Visibility] Found ${e.length} expandable ancestor(s)`,"color: #4caf50; font-weight: bold",e):console.log("[Visibility] No expandable ancestors found"),e}function Is(n){if(console.log("%c🔍 [Visibility] Inferring toggle for container","color: #ff9800; font-weight: bold",n),n.id){const r=document.querySelector(`[aria-controls="${n.id}"]`);if(r)return console.log(`[Visibility] Found toggle via aria-controls="${n.id}"`,r),r}const e=document.querySelector(`[data-toggle="${n.id}"], [data-target="${n.id}"], [data-open="${n.id}"]`);if(e)return console.log("[Visibility] Found toggle via data-* attribute",e),e;const t=(n.className||"").toLowerCase(),i=[];if(t.includes("menu")&&i.push("menu","nav","navigation"),t.includes("drawer")&&i.push("menu","open","show"),t.includes("sidebar")&&i.push("sidebar","menu","toggle"),t.includes("modal")&&i.push("open","show","modal"),t.includes("dropdown")&&i.push("open","show","dropdown"),i.length>0){const r=document.querySelectorAll('button, [role="button"], a, [role="link"]');for(const s of r){const o=(s.textContent||"").toLowerCase(),a=(s.getAttribute("aria-label")||"").toLowerCase(),l=o+" "+a;for(const c of i)if(l.includes(c))return console.log(`[Visibility] Found toggle via text similarity: "${c}" in "${o}"`,s),s}}if(n.previousElementSibling){const r=n.previousElementSibling;if(r.tagName==="BUTTON"||r.getAttribute("role")==="button")return console.log("[Visibility] Found toggle via previous sibling",r),r;const s=r.querySelector('button, [role="button"]');if(s)return console.log("[Visibility] Found toggle in previous sibling's children",s),s}return console.log("[Visibility] ⚠️ Could not infer toggle for container"),null}async function Re(n){if(console.log(`%c🔓 [Visibility] Attempting to expand ${n.kind} container...`,"color: #ff5722; font-weight: bold",n.container),n.kind==="details"&&n.container instanceof HTMLDetailsElement){console.log("[Visibility] Opening <details> element directly"),n.container.open=!0;const t=T(n.container);return console.log(`[Visibility] <details> expansion: ${t?"✅ SUCCESS":"❌ FAILED"}`),t}const e=n.toggle??n.container;if(!e)return console.log("%c❌ [Visibility] No toggle found, cannot expand","color: #f44336"),!1;console.log("[Visibility] Clicking toggle element:",e);try{const t={bubbles:!0,cancelable:!0,composed:!0};e.dispatchEvent(new PointerEvent("pointerdown",t)),e.dispatchEvent(new MouseEvent("mousedown",t)),e.dispatchEvent(new PointerEvent("pointerup",t)),e.dispatchEvent(new MouseEvent("mouseup",t)),e.dispatchEvent(new MouseEvent("click",t)),typeof e.click=="function"&&e.click(),console.log("[Visibility] Click events dispatched, waiting for container to become visible...")}catch(t){return console.log("%c❌ [Visibility] Error dispatching click events:","color: #f44336",t),!1}for(let t=0;t<12;t++)if(await new Promise(i=>setTimeout(i,50)),T(n.container))return console.log(`%c✅ [Visibility] Container became visible after ${(t+1)*50}ms`,"color: #4caf50; font-weight: bold"),!0;return console.log("%c❌ [Visibility] Container did not become visible after 600ms","color: #f44336"),!1}const ni=[/password/i,/passwd/i,/secret/i,/card.?number/i,/credit.?card/i,/cvv/i,/cvc/i,/ccv/i,/ssn/i,/social.?security/i,/pin/i,/token/i,/api.?key/i];class Ms{async execute(e,t){const i=e.action_config;if(this.isSensitiveField(t)){console.warn("[GuideAI] Skipping automation of sensitive field.");return}if(!(i.requires_confirmation&&!await this.showConfirmation(e)))switch(i.action_type){case"click":await this.executeClick(t);break;case"fill":await this.executeFill(t,i.fill_value??"");break;case"select":await this.executeSelect(t,i.select_value??"");break;case"scroll":await this.executeScroll(t);break;case"navigate":this.executeNavigate(i.navigate_url??"");break}}async executeClick(e){e.style.outline="2px solid #3b82f6",await this.delay(200),e.click(),e.dispatchEvent(new MouseEvent("click",{bubbles:!0})),await this.delay(100),e.style.outline=""}async executeFill(e,t){const i=e;if(!this.isSensitiveField(e)){i.focus(),i.dispatchEvent(new Event("focus",{bubbles:!0})),i.value="",i.dispatchEvent(new Event("input",{bubbles:!0}));for(let r=0;r<t.length;r++)i.value+=t[r],i.dispatchEvent(new Event("input",{bubbles:!0})),i.dispatchEvent(new KeyboardEvent("keydown",{key:t[r],bubbles:!0})),i.dispatchEvent(new KeyboardEvent("keyup",{key:t[r],bubbles:!0})),await this.delay(50);i.dispatchEvent(new Event("change",{bubbles:!0}))}}async executeSelect(e,t){const i=e;i.value=t,i.dispatchEvent(new Event("change",{bubbles:!0})),i.dispatchEvent(new Event("input",{bubbles:!0}))}async executeScroll(e){e.scrollIntoView({behavior:"smooth",block:"center"}),await this.delay(500)}executeNavigate(e){e.startsWith("/")||e.startsWith(location.origin)?window.location.href=e:window.open(e,"_blank","noopener")}isSensitiveField(e){const t=e;if(t.type==="password")return!0;const i=[t.name,t.id,t.placeholder,t.autocomplete,e.getAttribute("aria-label")??""];for(const r of i)if(r){for(const s of ni)if(s.test(r))return!0}if(t.id){const r=document.querySelector(`label[for="${t.id}"]`);if(r!=null&&r.textContent){for(const s of ni)if(s.test(r.textContent))return!0}}return!1}showConfirmation(e){return new Promise(t=>{const i=document.createElement("div");i.className="guideai-confirm-dialog",i.setAttribute("role","alertdialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
        ...
        <div class="guideai-confirm-content">
          ...
          <p class="guideai-confirm-message">
            This will perform: <strong>${A(e.content.body)}</strong>
          </p>
      ...
      `,document.body.appendChild(i);const r=i.querySelector(".guideai-confirm-cancel"),s=i.querySelector(".guideai-confirm-proceed"),o=a=>{i.remove(),t(a)};r.addEventListener("click",()=>o(!1)),s.addEventListener("click",()=>o(!0))})}delay(e){return new Promise(t=>setTimeout(t,e))}}function si(n,e=0){const t=n.getBoundingClientRect();return e===0?t:new DOMRect(t.x-e,t.y-e,t.width+e*2,t.height+e*2)}function oi(n,e,t){return Math.max(e,Math.min(n,t))}function Ps(n,e,t,i=12,r=8){const s=window.innerWidth,o=window.innerHeight;let a,l="top";n.bottom+i+t<o?(a=n.bottom+i,l="top"):n.top-i-t>0?(a=n.top-i-t,l="bottom"):(a=oi((o-t)/2,r,o-t-r),l="none");let c=n.left+n.width/2-e/2;return c=oi(c,r,s-e-r),{position:{top:a,left:c},arrowPlacement:l}}function Rs(n,e,t=2147483647){n.style.position="fixed",n.style.zIndex=String(t),n.style.top=`${e.top}px`,n.style.left=`${e.left}px`}function Hs(n,e=2147483647){n.style.position="fixed",n.style.zIndex=String(e),n.style.top="50%",n.style.left="50%",n.style.transform="translate(-50%, -50%)"}function Ns(n,e=200){n.style.opacity="0",requestAnimationFrame(()=>{n.style.transition=`opacity ${e}ms ease`,n.style.opacity="1"})}function $s(n,e=250){n.style.opacity="0",n.style.transform="translateY(20px)",requestAnimationFrame(()=>{n.style.transition=`opacity ${e}ms ease, transform ${e}ms ease`,n.style.opacity="1",n.style.transform="translateY(0)"})}function nt(n){n&&n.remove()}class Ds{constructor(e){this.tooltipEl=null,this.highlightEl=null,this.overlayEl=null,this.shadowRoot=e}renderTooltip(e,t,i){const r=document.createElement("div");r.className="guideai-tooltip",r.setAttribute("role","dialog"),r.setAttribute("aria-label",e.content.title??"Guide step");const{currentStep:s,totalSteps:o,isClickable:a,callbacks:l,showChoices:c}=i,u=s>=o-1?"Finish":e.content.cta_text??"Next";let h="";a&&(h='<p class="guideai-tooltip-hint">Click the highlighted element to continue</p>');let p;p=`
        <div class="guideai-tooltip-nav">
          ...
          <button class="guideai-tooltip-btn guideai-tooltip-next" aria-label="${A(u)}" title="${A(u)}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <path d="M9 6l6 6-6 6" />
            </svg>
          </button>
      ...
      <div class="guideai-tooltip-content">
        ...
        ${e.content.title?`<h3 class="guideai-tooltip-title">${A(e.content.title)}</h3>`:""}
        <p class="guideai-tooltip-body">${A(e.content.body)}</p>
        ${h}
        ${e.content.media_url?`<img class="guideai-tooltip-media" src="${A(e.content.media_url)}" alt="" loading="lazy" />`:""}
        ${p}
      </div>
    `,r.style.visibility="hidden",this.shadowRoot.appendChild(r),this.tooltipEl=r,this.positionTooltip(r,t),r.style.visibility="";const m=r.querySelector(".guideai-tooltip-close");m==null||m.addEventListener("click",()=>l.onDismiss());const f=r.querySelector(".guideai-tooltip-next");f==null||f.addEventListener("click",()=>l.onNext());const g=r.querySelector(".guideai-tooltip-back");g==null||g.addEventListener("click",()=>l.onPrev());const b=r.querySelector(".guideai-tooltip-skip");b==null||b.addEventListener("click",()=>l.onSkip()),Ns(r)}reposition(e){let t=null;if(e.target_selector)try{t=document.querySelector(e.target_selector)}catch{}this.tooltipEl&&this.positionTooltip(this.tooltipEl,t),this.highlightEl&&(t?this.updateHighlightPosition(t):this.removeHighlight())}renderHighlight(e){const t=si(e,4),i=document.createElement("div");i.className="guideai-highlight",i.style.position="fixed",i.style.zIndex="2147483645",i.style.top=`${t.top}px`,i.style.left=`${t.left}px`,i.style.width=`${t.width}px`,i.style.height=`${t.height}px`,i.style.pointerEvents="none",this.shadowRoot.appendChild(i),this.highlightEl=i}updateHighlightPosition(e){if(!this.highlightEl)return;const t=si(e,4);this.highlightEl.style.top=`${t.top}px`,this.highlightEl.style.left=`${t.left}px`,this.highlightEl.style.width=`${t.width}px`,this.highlightEl.style.height=`${t.height}px`}renderOverlay(){const e=document.createElement("div");e.className="guideai-overlay",this.shadowRoot.appendChild(e),this.overlayEl=e}removeTooltip(){nt(this.tooltipEl),this.tooltipEl=null}removeHighlight(){nt(this.highlightEl),this.highlightEl=null}removeOverlay(){nt(this.overlayEl),this.overlayEl=null}removeAll(){this.removeTooltip(),this.removeHighlight(),this.removeOverlay()}getTooltipEl(){return this.tooltipEl}getHighlightEl(){return this.highlightEl}destroy(){this.removeAll()}positionTooltip(e,t){if(!t){Hs(e);return}const i=t.getBoundingClientRect(),r=260;e.style.width=`${r}px`;const s=e.getBoundingClientRect().height||160,o=Ps(i,r,s);e.style.transform="",Rs(e,o.position);const a=e.querySelector(".guideai-tooltip-arrow");a&&a.setAttribute("data-placement",o.arrowPlacement)}}const Bs={tier1:40,tier2:35,tier3:25,tier4:15,tier5:8,tier6:20};let st=null;function Os(n){st=n}function de(n){if(!st)return 1;const e=Bs[n],t=st[n];return!e||!t?1:t/e}function ot(n,e,t){const i=ie(n);let r=0;const s=zs(i,e)*de("tier1");r+=s;const o=Fs(i,e)*de("tier2");r+=o;const a=Gs(i,e)*de("tier3");r+=a;const l=qs(i,e)*de("tier4");r+=l;const c=Us(i,e)*de("tier5");r+=c;const d=Vs(i,e)*de("tier6");return r+=d,t&&(t.tier1=Math.round(s*10)/10,t.tier2=Math.round(o*10)/10,t.tier3=Math.round(a*10)/10,t.tier4=Math.round(l*10)/10,t.tier5=Math.round(c*10)/10,t.tier6=Math.round(d*10)/10),Math.min(100,Math.round(r))}function zs(n,e){const t=n.tier1_stable,i=e.tier1_stable;let r=0;return i.data_guideai&&t.data_guideai===i.data_guideai?40:(i.data_testid&&t.data_testid===i.data_testid&&(r=Math.max(r,38)),i.id&&t.id===i.id&&(r=Math.max(r,36)),i.name&&t.name===i.name&&(r=Math.max(r,35)),i.aria_label&&t.aria_label===i.aria_label&&(r=Math.max(r,35)),r)}function Fs(n,e){const t=n.tier2_text,i=e.tier2_text;let r=0;if(i.text_content&&t.text_content&&t.text_content===i.text_content)r=Math.max(r,35);else if(i.variants.length>0&&t.text_content){const s=t.text_content.toLowerCase();for(const o of i.variants){if(o===s){r=Math.max(r,30);break}(o.includes(s)||s.includes(o))&&(r=Math.max(r,25))}}return i.placeholder&&t.placeholder===i.placeholder&&(r=Math.max(r,28)),i.label&&t.label&&t.label===i.label&&(r=Math.max(r,25)),r}function Gs(n,e){const t=n.tier3_structural,i=e.tier3_structural;let r=0;i.tag&&t.tag===i.tag&&(r+=8),i.role&&t.role===i.role&&(r+=5),i.css_path&&t.css_path&&(t.css_path===i.css_path?r+=8:t.css_path.endsWith(Ws(i.css_path))&&(r+=5));const s=Math.abs(t.dom_depth-i.dom_depth);return s===0?r+=4:s<=2&&(r+=2),Math.min(25,r)}function qs(n,e){const t=n.tier4_context,i=e.tier4_context;let r=0;return i.nearest_heading&&t.nearest_heading&&(t.nearest_heading===i.nearest_heading?r+=6:t.nearest_heading.toLowerCase().includes(i.nearest_heading.toLowerCase())&&(r+=4)),i.form_context&&t.form_context===i.form_context&&(r+=5),i.parent_text&&t.parent_text&&(t.parent_text===i.parent_text?r+=4:(t.parent_text.includes(i.parent_text)||i.parent_text.includes(t.parent_text))&&(r+=2)),Math.min(15,r)}function Us(n,e){const t=n.tier5_position,i=e.tier5_position;let r=0;if(i.bounding_rect&&t.bounding_rect){const s=js(t.bounding_rect,i.bounding_rect);s<10?r+=8:s<50?r+=5:s<150&&(r+=3)}return i.relative_position&&t.relative_position===i.relative_position&&(r+=2),Math.min(8,r)}function Vs(n,e){if(!n.tier6_visual||!e.tier6_visual)return 0;const t=n.tier6_visual,i=e.tier6_visual;let r=0;if(i.style_hash&&_n(t.style_hash,i.style_hash)===1&&(r+=8),i.style_vector.length>0&&t.style_vector.length>0){const s=Sn(t.style_vector,i.style_vector);s>=.95?r+=12:s>=.85?r+=8:s>=.7&&(r+=5)}if(i.canvas_hash&&t.canvas_hash){const s=Tn(t.canvas_hash,i.canvas_hash);s>=.9?r+=10:s>=.8?r+=6:s>=.7&&(r+=3)}return Math.min(20,r)}function Ws(n,e){return n.split(" > ").slice(-2).join(" > ")}function js(n,e){const t=n.x-e.x,i=n.y-e.y;return Math.sqrt(t*t+i*i)}const at=50,Ks=["a","button","input","select","textarea","details","summary","label"];function ai(n,e){var l;const t=document.body;if(!t)return{element:null,score:0};const i=Ys(n,t);if(i){const c={},d=ot(i,n,c);if(d>=at)return{element:i,score:d,tierScores:c}}let r=null,s=0,o={};const a=(l=n.tier3_structural)==null?void 0:l.tag;if(a){const c=t.querySelectorAll(a);for(let d=0;d<c.length;d++){const u={},h=ot(c[d],n,u);h>s&&(s=h,r=c[d],o=u)}}if(s<at){const c=Ks.join(","),d=t.querySelectorAll(c);for(let u=0;u<d.length;u++){if(a&&d[u].tagName.toLowerCase()===a)continue;const h={},p=ot(d[u],n,h);p>s&&(s=p,r=d[u],o=h)}}return s>=at?{element:r,score:s,tierScores:o}:{element:r,score:s,tierScores:o}}function Ys(n,e){const t=n.tier1_stable;if(t.data_guideai){const i=e.querySelector(`[data-guideai="${lt(t.data_guideai)}"]`);if(i)return i}if(t.data_testid){const i=e.querySelector(`[data-testid="${lt(t.data_testid)}"]`);if(i)return i}if(t.id){const i=e.querySelector(`#${Xs(t.id)}`);if(i)return i}if(t.name){const i=e.querySelector(`[name="${lt(t.name)}"]`);if(i)return i}return null}function lt(n){return n.replace(/["\\]/g,"\\$&")}function Xs(n){return typeof CSS<"u"&&CSS.escape?CSS.escape(n):n.replace(/([^\w-])/g,"\\$1")}function Js(n,e){if(!n||!e)return 0;const t=G(n),i=G(e);if(t===i)return 1;if(!t||!i)return 0;const r=Qs(t,i),s=Zs(t,i),o=eo(t,i);return Math.min(1,r*.35+s*.4+o*.25)}function li(n,e,t=.45){if(!n||e.length===0)return{element:null,similarity:0};let i=null,r=0;const s=G(n);console.log(`[TextSimilarity] Normalized stored text: "${s}"`),console.log(`[TextSimilarity] Threshold: ${t}, scanning ${e.length} candidates...`);for(let o=0;o<e.length;o++){const a=e[o],l=to(a);if(!l)continue;const c=Js(n,l);(c>.3||o<5)&&console.log(`[TextSimilarity] Candidate ${o}: similarity=${c.toFixed(3)}, text="${l.substring(0,50)}"`),c>r&&(r=c,i=a)}return console.log(`[TextSimilarity] Best match: similarity=${r.toFixed(3)}, threshold=${t}, accepted=${r>=t}`),r>=t?{element:i,similarity:r,score:Math.round(r*100)}:{element:null,similarity:r}}function ci(n){const e=[],t=new Set,i=n.tier2_text;if(i){if(i.text_content){const o=G(i.text_content);o&&!t.has(o)&&(e.push(o),t.add(o))}if(i.placeholder){const o=G(i.placeholder);o&&!t.has(o)&&(e.push(o),t.add(o))}if(i.label){const o=G(i.label);o&&!t.has(o)&&(e.push(o),t.add(o))}if(i.variants&&Array.isArray(i.variants))for(const o of i.variants){const a=G(o);a&&!t.has(a)&&(e.push(a),t.add(a))}}const r=n.tier1_stable;if(r){if(r.aria_label){const o=G(r.aria_label);o&&!t.has(o)&&(e.push(o),t.add(o))}if(r.name){const o=G(r.name);o&&!t.has(o)&&(e.push(o),t.add(o))}}const s=n.tier4_context;if(s&&s.nearest_heading){const o=G(s.nearest_heading);o&&!t.has(o)&&(e.push(o),t.add(o))}return e.filter(Boolean).join(" ")}function G(n){return n.toLowerCase().replace(/[^\w\s]/g," ").replace(/\s+/g," ").trim()}function ct(n){return new Set(n.split(" ").filter(e=>e.length>0))}function Qs(n,e){const t=ct(n),i=ct(e);if(t.size===0||i.size===0)return 0;let r=0;for(const o of t)i.has(o)&&r++;const s=t.size+i.size-r;return s>0?r/s:0}function Zs(n,e){const t=di(n),i=di(e);if(t.size===0||i.size===0)return 0;let r=0;for(const s of t)i.has(s)&&r++;return 2*r/(t.size+i.size)}function di(n){const e=new Set,t=`  ${n} `;for(let i=0;i<t.length-2;i++)e.add(t.substring(i,i+3));return e}function eo(n,e){if(n.includes(e)||e.includes(n))return 1;const t=n.length<e.length?n:e,i=n.length<e.length?e:n,r=ct(t);let s=0;for(const o of r)i.includes(o)&&s++;return r.size>0?s/r.size:0}function to(n){var t;const e=n;return n.getAttribute("aria-label")||n.placeholder||((t=e.textContent)==null?void 0:t.trim())||""}class io{constructor(e,t){this.analyzer=e,this.feedbackReporter=t}setAnalyzer(e){this.analyzer=e}findTargetElement(e,t){var s,o,a;const i=e.id??"";if(console.log(`%c🔍 [ElementFinder] Starting element search for step ${i}`,"color: #00bcd4; font-weight: bold"),console.log("[ElementFinder] Step details:",{title:e.content.title,target_selector:e.target_selector,has_fingerprint:((s=e.target_fingerprint)==null?void 0:s.total_score)>0,fingerprint_score:(o=e.target_fingerprint)==null?void 0:o.total_score,action_type:e.action_config.action_type}),this.analyzer){console.log("%c🧠 [ElementFinder] Using DeepUI Analyzer","color: #9c27b0; font-weight: bold");const l=this.analyzer.stepToIntent(e);console.log("[ElementFinder] Analyzer intent:",{text:l.text,actionType:l.actionType,tag:l.tag});const c=this.analyzer.resolveSync(l);if(console.log("[ElementFinder] Analyzer result:",{hasElement:!!c.element,score:c.score,resolvedBy:c.resolvedBy,status:c.status}),c.element){if(console.log("%c✅ [ElementFinder] Element FOUND via Analyzer!","color: #4caf50; font-weight: bold",c.element),c.resolvedBy==="fingerprint"&&this.feedbackReporter&&e.target_fingerprint){const d=ie(c.element);this.feedbackReporter.reportSuccess(t,i,c.score,c.tierScores??{},e.target_fingerprint,d)}return c.element}console.log("%c⚠️ [ElementFinder] Analyzer miss, falling back to legacy path","color: #ff9800")}else console.log("[ElementFinder] No analyzer available, using legacy 4-tier fallback");if(console.log("%c📊 [ElementFinder] TIER 1: Fingerprint Matching","color: #3f51b5; font-weight: bold"),e.target_fingerprint&&e.target_fingerprint.total_score>0){console.log(`[ElementFinder] Attempting fingerprint match (score: ${e.target_fingerprint.total_score})`);const l=ai(e.target_fingerprint);if(console.log("[ElementFinder] Fingerprint result:",{found:!!l.element,score:l.score,tierScores:l.tierScores,isVisible:l.element?T(l.element):null}),l.element&&(l.score>=50||l.score>=35&&!T(l.element))){if(console.log(`%c✅ [ElementFinder] Element FOUND via Fingerprint (score: ${l.score})!`,"color: #4caf50; font-weight: bold",l.element),this.feedbackReporter){const d=ie(l.element);this.feedbackReporter.reportSuccess(t,i,l.score,l.tierScores??{},e.target_fingerprint,d)}return l.element}else console.log("%c❌ [ElementFinder] Fingerprint match rejected (score too low or not acceptable)","color: #f44336");this.feedbackReporter&&!l.element&&this.feedbackReporter.reportNotFound(t,i,e.target_fingerprint)}else console.log("[ElementFinder] Skipping fingerprint (no fingerprint data or zero score)");if(console.log("%c📊 [ElementFinder] TIER 2: CSS Selector","color: #3f51b5; font-weight: bold"),e.target_selector){console.log(`[ElementFinder] Trying CSS selector: "${e.target_selector}"`);try{const l=document.querySelector(e.target_selector);if(l)return console.log("%c✅ [ElementFinder] Element FOUND via CSS Selector!","color: #4caf50; font-weight: bold",l),l;console.log("%c❌ [ElementFinder] CSS selector returned no match","color: #f44336")}catch(l){console.log("%c❌ [ElementFinder] CSS selector INVALID:","color: #f44336",l)}}else console.log("[ElementFinder] Skipping CSS selector (no target_selector provided)");if(console.log("%c📊 [ElementFinder] TIER 3: Text Similarity Matching","color: #3f51b5; font-weight: bold"),e.target_fingerprint){const l=ci(e.target_fingerprint);if(l){const d=((a=e.target_fingerprint.tier3_structural)==null?void 0:a.tag)||'a, button, input, select, textarea, [role="button"], [role="link"], [role="tab"]';console.log(`[ElementFinder] Searching for text similarity with selector: "${d}"`),console.log("[ElementFinder] Target text features:",l);try{const u=Array.from(document.querySelectorAll(d));console.log(`[ElementFinder] Found ${u.length} candidate elements`);const h=li(l,u,.45);if(h.element)return console.log(`%c✅ [ElementFinder] Element FOUND via Text Similarity (score: ${h.score})!`,"color: #4caf50; font-weight: bold",h.element),h.element;console.log("%c❌ [ElementFinder] No text similarity match found","color: #f44336")}catch(u){console.log("%c❌ [ElementFinder] Text similarity error:","color: #f44336",u)}}else console.log("[ElementFinder] Skipping text similarity (no text features in fingerprint)")}else console.log("[ElementFinder] Skipping text similarity (no fingerprint)");console.log("%c📊 [ElementFinder] TIER 4: Text Content Search","color: #3f51b5; font-weight: bold");const r=this.findByTextContent(e);return r?console.log("%c✅ [ElementFinder] Element FOUND via Text Content Search!","color: #4caf50; font-weight: bold",r):console.log("%c❌ [ElementFinder] Text content search found nothing","color: #f44336"),r||console.log("%c❌ [ElementFinder] ALL TIERS FAILED - Element not found","color: #f44336; font-weight: bold; font-size: 14px"),r}findByTextContent(e){var s,o,a,l;const t=((s=e.content.title)==null?void 0:s.toLowerCase())||"";if(!t)return console.log("[ElementFinder] Text content search skipped (no title in step)"),null;const r=((a=(o=e.target_fingerprint)==null?void 0:o.tier3_structural)==null?void 0:a.tag)||'a, button, input, select, textarea, [role="button"], [role="link"], [role="tab"]';console.log(`[ElementFinder] Searching for text: "${t}" in selector: "${r}"`);try{const c=document.querySelectorAll(r);console.log(`[ElementFinder] Scanning ${c.length} interactive elements...`);for(let d=0;d<c.length;d++){const u=c[d],h=(u.getAttribute("aria-label")||u.placeholder||((l=u.textContent)==null?void 0:l.trim())||"").toLowerCase();if(h&&(h.includes(t)||t.includes(h)))return console.log(`[ElementFinder] Text match found at index ${d}:`,{elText:h,element:u}),u}console.log(`[ElementFinder] No text matches found in ${c.length} candidates`)}catch(c){console.log("[ElementFinder] Text content search error:",c)}return null}}const ro={pulseMs:15e3,hintMs:3e4,offerHelpMs:6e4};class no{constructor(e,t){this.phase="idle",this.retryCount=0,this.timers=[],this.destroyed=!1,this.onPhaseChange=e,this.thresholds={...ro,...t}}start(){this.phase="idle",this.retryCount=0,this.clearTimers(),this.timers.push(setTimeout(()=>this.transitionTo("pulse"),this.thresholds.pulseMs)),this.timers.push(setTimeout(()=>this.transitionTo("hint"),this.thresholds.hintMs)),this.timers.push(setTimeout(()=>this.transitionTo("offer_help"),this.thresholds.offerHelpMs))}recordRetry(){this.destroyed||(this.retryCount++,this.retryCount>=3&&this.phaseOrder(this.phase)<this.phaseOrder("pulse")&&this.transitionTo("pulse"),this.retryCount>=5&&this.phaseOrder(this.phase)<this.phaseOrder("hint")&&this.transitionTo("hint"))}getPhase(){return this.phase}getRetryCount(){return this.retryCount}reset(){this.clearTimers(),this.phase="idle",this.retryCount=0}destroy(){this.destroyed=!0,this.clearTimers()}transitionTo(e){this.destroyed||this.phaseOrder(e)<=this.phaseOrder(this.phase)||(this.phase=e,this.onPhaseChange(e))}phaseOrder(e){switch(e){case"idle":return 0;case"pulse":return 1;case"hint":return 2;case"offer_help":return 3}}clearTimers(){for(const e of this.timers)clearTimeout(e);this.timers=[]}}class so{constructor(e,t,i){this.stuckDetector=null,this.retryClickCleanup=null,this.beforeUnloadHandler=null,this.config=e,this.eventBuffer=t,this.refs=i}startStuckDetection(e,t){this.destroyStuckDetector();const i=e.action_config.stuck_thresholds;this.stuckDetector=new no(r=>this.handleStuckPhaseChange(r,e),i?{pulseMs:i.pulse_ms,hintMs:i.hint_ms,offerHelpMs:i.offer_help_ms}:void 0),this.stuckDetector.start(),t&&this.setupRetryClickListener(t)}handleStuckPhaseChange(e,t){var s,o;if(this.refs.isDestroyed())return;const i=_(this.config.siteId,"guide_step_stuck",{phase:e,retry_count:((s=this.stuckDetector)==null?void 0:s.getRetryCount())??0});i.guide_id=this.refs.getGuideId(),i.step_index=this.refs.getCurrentStep(),(o=this.eventBuffer)==null||o.push(i);const r=this.refs.getTooltipEl();if(r)switch(r.classList.remove("guideai-minibar--stuck-pulse","guideai-minibar--stuck-hint","guideai-minibar--stuck-offer"),e){case"pulse":r.classList.add("guideai-minibar--stuck-pulse");{const a=this.refs.getHighlightEl();a&&a.classList.add("guideai-highlight--pulse")}break;case"hint":r.classList.add("guideai-minibar--stuck-hint");{const a=r.querySelector(".guideai-minibar-hint");a&&(a.textContent=this.getHintText(t))}break;case"offer_help":r.classList.add("guideai-minibar--stuck-offer");break}}getHintText(e){switch(e.action_config.action_type){case"click":return"Try clicking the highlighted element";case"fill":return"Type in the highlighted field";case"select":return"Choose an option from the dropdown";case"navigate":return"Navigate to the indicated page";default:return"Complete the action to continue"}}setupRetryClickListener(e){this.cleanupRetryClick();const t=this.refs.getShadowRoot(),i=r=>{var o,a,l;if(this.refs.isDestroyed()||!this.stuckDetector||e.contains(r.target)||t.contains(r.target))return;this.stuckDetector.recordRetry();const s=_(this.config.siteId,"guide_step_retry",{retry_count:this.stuckDetector.getRetryCount(),clicked_tag:(a=(o=r.target)==null?void 0:o.tagName)==null?void 0:a.toLowerCase()});s.guide_id=this.refs.getGuideId(),s.step_index=this.refs.getCurrentStep(),(l=this.eventBuffer)==null||l.push(s)};document.addEventListener("click",i,!0),this.retryClickCleanup=()=>{document.removeEventListener("click",i,!0)}}cleanupRetryClick(){this.retryClickCleanup&&(this.retryClickCleanup(),this.retryClickCleanup=null)}destroyStuckDetector(){var t;(t=this.stuckDetector)==null||t.destroy(),this.stuckDetector=null,this.cleanupRetryClick();const e=this.refs.getHighlightEl();e&&e.classList.remove("guideai-highlight--pulse")}setupNavigationPrevention(){this.teardownNavigationPrevention(),this.beforeUnloadHandler=e=>{var i;const t=_(this.config.siteId,"guide_navigation_blocked");t.guide_id=this.refs.getGuideId(),t.step_index=this.refs.getCurrentStep(),(i=this.eventBuffer)==null||i.push(t),e.preventDefault(),e.returnValue=""},window.addEventListener("beforeunload",this.beforeUnloadHandler)}teardownNavigationPrevention(){this.beforeUnloadHandler&&(window.removeEventListener("beforeunload",this.beforeUnloadHandler),this.beforeUnloadHandler=null)}destroy(){this.destroyStuckDetector(),this.teardownNavigationPrevention()}}function oo(n,e){const t=n.action_config.action_type,i=n.action_config.completion_hint;switch(t){case"click":return ao(e);case"fill":return lo(e);case"select":return co(e);case"navigate":return uo(i);case"none":return i?ho():hi();default:return hi()}}function ao(n){let e=()=>{};return{promise:new Promise(i=>{if(!n){const s=()=>{i({completed:!0,detail:"document_click"})};document.addEventListener("click",s,{once:!0}),e=()=>document.removeEventListener("click",s);return}const r=()=>{i({completed:!0,detail:"target_click"})};n.addEventListener("click",r,{once:!0}),e=()=>n.removeEventListener("click",r)}),cancel:()=>e()}}function lo(n){let e=()=>{};return{promise:new Promise(i=>{if(!n||!(n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement)){i({completed:!0,detail:"no_input_target"});return}const r=n,s=r.value,o=()=>r.value!==s&&r.value.trim().length>0?(i({completed:!0,detail:`filled: "${r.value}"`}),!0):!1,a=()=>{o()&&r.removeEventListener("keydown",l)},l=c=>{c.key==="Enter"&&o()&&r.removeEventListener("blur",a)};r.addEventListener("blur",a),r.addEventListener("keydown",l),e=()=>{r.removeEventListener("blur",a),r.removeEventListener("keydown",l)}}),cancel:()=>e()}}function co(n){let e=()=>{};return{promise:new Promise(i=>{if(!n){i({completed:!0,detail:"no_select_target"});return}const r=()=>{const s=n.value??"";i({completed:!0,detail:`selected: "${s}"`})};n.addEventListener("change",r,{once:!0}),e=()=>n.removeEventListener("change",r)}),cancel:()=>e()}}function uo(n){let e=()=>{};const t=location.href;return{promise:new Promise(r=>{const s=()=>location.href!==t?n&&!location.pathname.includes(n)?!1:(r({completed:!0,detail:`navigated: ${location.pathname}`}),!0):!1,o=()=>{s()};window.addEventListener("popstate",o);const a=history.pushState.bind(history),l=history.replaceState.bind(history);history.pushState=function(...d){a(...d),s()},history.replaceState=function(...d){l(...d),s()};const c=setInterval(()=>{s()},500);e=()=>{window.removeEventListener("popstate",o),history.pushState=a,history.replaceState=l,clearInterval(c)}}),cancel:()=>e()}}function ho(n){let e=()=>{};return{promise:new Promise(i=>{let r=!1;const s=v=>{r||(r=!0,e(),i({completed:!0,detail:v}))},o=ui(),a=location.href,l=new MutationObserver(()=>{const v=ui(),w=go(o,v);if(w){s(`dom_changed: ${w}`);return}if(location.href!==a){s(`url_changed: ${location.pathname}`);return}});l.observe(document.body,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:["class","hidden","aria-hidden","aria-selected","aria-expanded","aria-checked","data-state","data-active","data-selected","data-count","disabled","open"]});const c=window.fetch,d=new Set(["POST","PUT","PATCH","DELETE"]);window.fetch=function(...v){var $;const w=v[0];let C="GET";typeof w=="string"||w instanceof URL?C=((($=v[1])==null?void 0:$.method)??"GET").toUpperCase():w instanceof Request&&(C=w.method.toUpperCase());const R=c.apply(window,v);return d.has(C)&&R.then(()=>{setTimeout(()=>{r||s(`network_mutation: ${C}`)},200)}).catch(()=>{}),R};const u=XMLHttpRequest.prototype,h=u.open;let p="GET";u.open=function(v,...w){return p=v.toUpperCase(),h.apply(this,[v,...w])};const m=u.send;u.send=function(...v){return d.has(p)&&this.addEventListener("load",()=>{setTimeout(()=>{r||s(`xhr_mutation: ${p}`)},200)},{once:!0}),m.apply(this,v)};const f=v=>{const w=v.target;if(!w)return;const C=w.closest('button, a, [role="button"], input[type="submit"], [data-action]');C&&setTimeout(()=>{var R;if(!r){const $=((R=C.textContent)==null?void 0:R.trim().slice(0,50))??"";s(`user_action_click: "${$}"`)}},500)};document.addEventListener("click",f,!0);const g=history.pushState.bind(history),b=history.replaceState.bind(history),y=()=>{location.href!==a&&!r&&s(`navigated: ${location.pathname}`)};history.pushState=function(...v){g(...v),y()},history.replaceState=function(...v){b(...v),y()},window.addEventListener("popstate",y);const S=setTimeout(()=>{s("timeout")},12e4);e=()=>{l.disconnect(),document.removeEventListener("click",f,!0),window.removeEventListener("popstate",y),window.fetch=c,u.open=h,u.send=m,history.pushState=g,history.replaceState=b,clearTimeout(S)}}),cancel:()=>e()}}function ui(){var i;const n=new Map;let e=0;const t=document.querySelectorAll('span, sup, sub, small, em, strong, b, i, mark, [role="status"], [aria-live], [aria-atomic]');for(let r=0;r<t.length;r++){const s=t[r],o=((i=s.textContent)==null?void 0:i.trim())??"";if(o.length===0||o.length>10)continue;const a=po(s);n.set(a,o),e++}return{entries:n,totalCount:e}}function go(n,e){for(const[t,i]of n.entries){const r=e.entries.get(t);if(r!==void 0&&r!==i)return`"${i}" → "${r}" at ${t}`}if(e.totalCount>n.totalCount){for(const[t,i]of e.entries)if(!n.entries.has(t)&&(/\d/.test(i)||i.length<=3))return`new_badge: "${i}" at ${t}`}return null}function po(n){const e=[];let t=n,i=0;for(;t&&t!==document.body&&i<4;){const r=t.tagName.toLowerCase(),s=t.id?`#${t.id}`:"",o=fo(t);e.unshift(`${r}${s}[${o}]`),t=t.parentElement,i++}return e.join(">")}function fo(n){let e=0,t=n.previousElementSibling;for(;t;)t.tagName===n.tagName&&e++,t=t.previousElementSibling;return e}function hi(){return{promise:Promise.resolve({completed:!0,detail:"manual"}),cancel:()=>{}}}class mo{constructor(e,t,i,r){this.actionValidatorCancel=null,this.config=e,this.eventBuffer=t,this.stuckWiring=i,this.refs=r}renderMiniBar(e,t,i){const r=document.createElement("div");r.className="guideai-minibar",r.setAttribute("role","status"),r.setAttribute("aria-label",e.content.title??"Waiting for action");const s=this.refs.getTotalSteps(),o=this.refs.getCurrentStep(),a=(o+1)/s*100,l=o>0,c=e.action_config.allow_skip!==!1;r.innerHTML=`
      ...
      <div class="guideai-minibar-content">
        ...
        <span class="guideai-minibar-text">${A(e.content.title||"Complete the action...")}</span>
    ...
    display: none;
  `,X==null||X.appendChild(L)),L}function zo(n){X=n}function Fo(n){const e=Oo(),t=n.getBoundingClientRect();e.style.top=`${t.top}px`,e.style.left=`${t.left}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`,e.style.display="block"}function gi(){L&&(L.style.display="none")}function Go(){L&&L.parentNode&&L.parentNode.removeChild(L),L=null,X=null}const qo="guideai-step-badge";let P=null,J=null;function Uo(){return P&&(J!=null&&J.contains(P))||(P=document.createElement("div"),P.className="guideai-badge-container",P.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 0;
    ...
    z-index: 2147483647;
    pointer-events: none;
  `,J==null||J.appendChild(P)),P}function Vo(n){J=n}function Wo(n,e){const t=Uo(),i=n.getBoundingClientRect(),r=document.createElement("div");r.className=qo,r.textContent=String(e),r.style.cssText=`
    position: fixed;
    top: ${i.top-8}px;
    left: ${i.right-8}px;
    width: 24px;
    ...
    pointer-events: none;
    user-select: none;
  `,t.appendChild(r)}function pi(){P&&P.parentNode&&P.parentNode.removeChild(P),P=null}function jo(){pi(),J=null}let be=!1,ye=null,ve=0,xe=null,we=null;function fi(n){var t,i;const e=n.composedPath();for(const r of e)if(r instanceof Element&&(((t=r.tagName)==null?void 0:t.toLowerCase())==="guideai-shadow"||(i=r.classList)!=null&&i.contains("guideai-recorder")||r.shadowRoot))return!0;return!1}function mi(n){var t,i,r;if(fi(n))return;const e=document.elementFromPoint(n.clientX,n.clientY);e&&((t=e.classList)!=null&&t.contains("guideai-picker-highlight")||(i=e.classList)!=null&&i.contains("guideai-badge-container")||(r=e.closest)!=null&&r.call(e,".guideai-badge-container")||e!==ye&&(ye=e,Fo(e)))}function bi(n){if(!be||!ye||fi(n))return;n.preventDefault(),n.stopPropagation(),n.stopImmediatePropagation();const e=ye,t=Eo(e),i=Xo(e),r=Jo(e),s=Qo(e,ve+1);ve++,Wo(e,ve),gi();const o={title:s,instruction:`Interact with the ${e.tagName.toLowerCase()} element`,actionType:i,targetFingerprint:t,targetPreview:r,pageUrl:window.location.href,timestamp:new Date().toISOString()};xe==null||xe(o)}function yi(n){n.key==="Escape"&&(se(),we==null||we())}function Ko(n,e,t,i){be||(be=!0,ve=i??0,xe=e,we=t??null,zo(n),Vo(n),document.addEventListener("mousemove",mi,!0),document.addEventListener("click",bi,!0),document.addEventListener("keydown",yi,!0),document.body.style.cursor="crosshair")}function se(){be&&(be=!1,ye=null,xe=null,we=null,document.removeEventListener("mousemove",mi,!0),document.removeEventListener("click",bi,!0),document.removeEventListener("keydown",yi,!0),document.body.style.cursor="",gi(),Go())}function ut(){se(),pi(),jo()}function Yo(n){ve=n}function Xo(n){const e=n.tagName.toLowerCase();if(e==="input"){const t=n.type.toLowerCase();return t==="submit"||t==="button"||t==="checkbox"||t==="radio"?"click":"fill"}return e==="textarea"?"fill":e==="select"?"select":e==="a"?"navigate":(e==="button"||n.getAttribute("role")==="button","click")}function Jo(n){var o;const e=n.outerHTML;if(e.length<=200)return e;const t=n.tagName.toLowerCase(),i=Array.from(n.attributes).map(a=>`${a.name}="${a.value}"`).join(" "),r=i?`<${t} ${i}>`:`<${t}>`,s=((o=n.textContent)==null?void 0:o.trim().slice(0,80))??"";return`${r}${s}...</${t}>`}function Qo(n,e){var r;const t=n.tagName.toLowerCase(),i=n.getAttribute("aria-label")??n.getAttribute("placeholder")??n.getAttribute("title")??((r=n.textContent)==null?void 0:r.trim().slice(0,40))??"";return i?`${Zo(n)} "${i}"`:`Step ${e}: ${t} element`}function Zo(n){const e=n.tagName.toLowerCase();return e==="input"||e==="textarea"?"Fill in":e==="select"?"Select":e==="a"?"Navigate to":"Click"}class ea{constructor(e){this.el=null,this.stepsEl=null,this.countEl=null,this.titleInput=null,this.callbacks=null,this.saveBtn=null,this.previewBtn=null,this.shadowRoot=e}render(e){var i,r,s,o;if(this.el)return;this.callbacks=e;const t=document.createElement("div");t.className="guideai-recorder",t.setAttribute("role","dialog"),t.setAttribute("aria-label","Guide Recorder"),t.innerHTML=`
    ...
    `,this.el=t,this.stepsEl=t.querySelector(".guideai-recorder-steps"),this.countEl=t.querySelector(".guideai-recorder-count"),this.titleInput=t.querySelector(".guideai-recorder-title-input"),this.saveBtn=t.querySelector(".guideai-recorder-save"),this.previewBtn=t.querySelector(".guideai-recorder-preview"),(i=t.querySelector(".guideai-recorder-close"))==null||i.addEventListener("click",()=>{var a;(a=this.callbacks)==null||a.onCancel()}),(r=t.querySelector(".guideai-recorder-cancel"))==null||r.addEventListener("click",()=>{var a;(a=this.callbacks)==null||a.onCancel()}),(s=this.previewBtn)==null||s.addEventListener("click",()=>{var a;(a=this.callbacks)==null||a.onPreview()}),(o=this.saveBtn)==null||o.addEventListener("click",()=>{var l,c,d;const a=((c=(l=this.titleInput)==null?void 0:l.value)==null?void 0:c.trim())||"Recorded Guide";(d=this.callbacks)==null||d.onSave(a)}),this.shadowRoot.appendChild(t)}updateSteps(e){if(!this.stepsEl)return;e.length===0?this.stepsEl.innerHTML='<div class="guideai-recorder-empty">Click elements on the page to record steps</div>':(this.stepsEl.innerHTML=e.map((i,r)=>`
          <div class="guideai-recorder-step" data-index="${r}">
            ...
            <span class="guideai-recorder-step-title">${A(i.title)}</span>
            <button class="guideai-recorder-step-del" data-index="${r}" aria-label="Delete step">&times;</button>
          </div>
        `).join(""),this.stepsEl.querySelectorAll(".guideai-recorder-step-del").forEach(i=>{i.addEventListener("click",r=>{var o;const s=parseInt(r.currentTarget.getAttribute("data-index")||"0",10);(o=this.callbacks)==null||o.onDeleteStep(s)})})),this.countEl&&(this.countEl.textContent=`${e.length} step${e.length!==1?"s":""}`);const t=e.length>0;this.saveBtn&&(this.saveBtn.disabled=!t),this.previewBtn&&(this.previewBtn.disabled=!t)}showSaving(){this.saveBtn&&(this.saveBtn.textContent="Saving...",this.saveBtn.disabled=!0)}showSaved(){this.saveBtn&&(this.saveBtn.textContent="Saved!",this.saveBtn.disabled=!0),setTimeout(()=>this.destroy(),1500)}showError(e){this.saveBtn&&(this.saveBtn.textContent="Save Guide",this.saveBtn.disabled=!1),typeof console<"u"&&console.warn("[GuideAI] Recorder error:",e)}destroy(){this.el&&this.el.parentNode&&this.el.parentNode.removeChild(this.el),this.el=null,this.stepsEl=null,this.countEl=null,this.titleInput=null,this.saveBtn=null,this.previewBtn=null,this.callbacks=null}}const ht=n=>`guideai_recorder_${n}`;class ta{constructor(e,t,i,r){this.panel=null,this.steps=[],this.recording=!1,this.startedAt="",this.config=e,this.api=t,this.eventBuffer=i,this.shadowRoot=r,this.restoreState()}startRecording(){var e;this.recording||(this.recording=!0,this.startedAt=new Date().toISOString(),this.panel=new ea(this.shadowRoot),this.panel.render({onSave:t=>this.saveGuide(t),onCancel:()=>this.cancelRecording(),onPreview:()=>this.previewGuide(),onDeleteStep:t=>this.deleteStep(t)}),this.panel.updateSteps(this.steps),Ko(this.shadowRoot,t=>this.onStepCaptured(t),()=>this.cancelRecording(),this.steps.length),this.persistState(),(e=this.eventBuffer)==null||e.push(_(this.config.siteId,"guide_recording_started")))}stopRecording(){return this.recording?(this.recording=!1,se(),[...this.steps]):this.steps}cancelRecording(){var e;this.recording=!1,this.steps=[],se(),ut(),(e=this.panel)==null||e.destroy(),this.panel=null,this.clearState()}deleteStep(e){var t;e<0||e>=this.steps.length||(this.steps.splice(e,1),(t=this.panel)==null||t.updateSteps(this.steps),this.persistState())}getSteps(){return[...this.steps]}getStepCount(){return this.steps.length}isRecording(){return this.recording}previewGuide(){if(this.steps.length===0)return;this.recording&&se();const t=this.buildGuide("Preview Guide");new dt(this.config,this.eventBuffer,this.shadowRoot).start(t)}async saveGuide(e,t){var r,s,o,a;if(this.steps.length===0)throw new Error("No steps recorded");(r=this.panel)==null||r.showSaving();const i={title:e||"Recorded Guide",description:t||void 0,steps:this.steps.map((l,c)=>({ordinal:c,step_type:"tooltip",target_selector:null,target_fingerprint:l.targetFingerprint,content:{title:l.title,body:l.instruction},action_config:{action_type:l.actionType,sensitive:!1,requires_confirmation:!1},page_url_pattern:l.pageUrl}))};try{const l=await this.api.post("/api/v1/guides/record",i);return(s=this.panel)==null||s.showSaved(),(o=this.eventBuffer)==null||o.push(_(this.config.siteId,"guide_recording_saved",{guide_id:l.id,step_count:this.steps.length})),this.recording=!1,this.steps=[],se(),ut(),this.clearState(),{guideId:l.id}}catch(l){const c=l instanceof Error?l.message:"Failed to save guide";throw(a=this.panel)==null||a.showError(c),l}}destroy(){var e;this.recording=!1,se(),ut(),(e=this.panel)==null||e.destroy(),this.panel=null}onStepCaptured(e){var t;this.steps.push(e),(t=this.panel)==null||t.updateSteps(this.steps),this.persistState()}buildGuide(e){return{id:`recorder_${Date.now()}`,site_id:this.config.siteId,title:e,status:"draft",trigger_type:"manual",trigger_config:{},steps:this.steps.map((t,i)=>({id:`step_${i}`,guide_id:`recorder_${Date.now()}`,ordinal:i,step_type:"tooltip",target_selector:void 0,target_fingerprint:t.targetFingerprint,content:{title:t.title,body:t.instruction},action_config:{action_type:t.actionType,sensitive:!1,requires_confirmation:!1},page_url_pattern:t.pageUrl})),tags:["sdk-recorded"],version:1,created_at:this.startedAt,updated_at:new Date().toISOString()}}persistState(){try{const e={isRecording:this.recording,steps:this.steps,startedAt:this.startedAt};sessionStorage.setItem(ht(this.config.siteId),JSON.stringify(e))}catch{}}restoreState(){try{const e=sessionStorage.getItem(ht(this.config.siteId));if(!e)return;const t=JSON.parse(e);t.isRecording&&t.steps.length>0&&(this.steps=t.steps,this.startedAt=t.startedAt,Yo(this.steps.length))}catch{}}clearState(){try{sessionStorage.removeItem(ht(this.config.siteId))}catch{}}}const vi=n=>`guideai_feedback_prompt_shown_${n}`;function gt(n){try{return sessionStorage.getItem(vi(n))==="true"}catch{return!1}}function ia(n){try{sessionStorage.setItem(vi(n),"true")}catch{}}class ra{constructor(e,t,i){this.el=null,this.escHandler=null,this.dismissTimer=null,this.config=e,this.eventBuffer=t,this.shadowRoot=i}show(e,t,i={}){if(this.el||gt(this.config.siteId))return;const r=i.prompt??(e?"Was this guide helpful?":"How is this experience so far?"),s=e?"Guide feedback":"Experience feedback",o=e?"Any additional feedback? (optional)":"Tell us what is working or getting in the way (optional)",a=document.createElement("div");a.className="guideai-feedback",a.setAttribute("role","dialog"),a.setAttribute("aria-label",s),a.innerHTML=`
    ...
    `}submitSurvey(e,t,i,r){var o;const s=_(this.config.siteId,"survey_response",{survey_type:e,score:t,comment:i||void 0,trigger_context:r||void 0});s.element_text=i||void 0,(o=this.eventBuffer)==null||o.push(s)}remove(){this.dismissTimer&&(clearTimeout(this.dismissTimer),this.dismissTimer=null),this.el&&(this.el.remove(),this.el=null)}destroy(){this.remove()}}const sa=n=>`guideai_guides_completed_${n}`,oa=n=>`guideai_survey_shown_${n}`;class aa{constructor(e,t,i=3){this.siteId=e,this.renderer=t,this.triggerAfterGuides=i}onGuideCompleted(){try{const e=sa(this.siteId),t=parseInt(sessionStorage.getItem(e)||"0",10)+1;sessionStorage.setItem(e,String(t));const i=oa(this.siteId);if(sessionStorage.getItem(i))return;if(t>=this.triggerAfterGuides){const r=t===this.triggerAfterGuides?"nps":"csat";setTimeout(()=>{r==="nps"?this.renderer.showNPS("after_guide_completion"):this.renderer.showCSAT("after_guide_completion"),sessionStorage.setItem(i,"true")},2e3)}}catch{}}}const xi=n=>`guideai_usage_feedback_pageviews_${n}`;class la{constructor(e,t,i={}){this.timer=null,this.siteId=e,this.renderer=t,this.minPageViews=Math.max(1,i.minPageViews??2),this.delayMs=Math.max(1e3,i.delayMs??3e4)}onPageView(){gt(this.siteId)||this.incrementPageViews()<this.minPageViews||(this.timer&&clearTimeout(this.timer),this.timer=setTimeout(()=>{this.timer=null,!gt(this.siteId)&&this.renderer.show(void 0,void 0,{prompt:"How is this experience so far?",title:document.title||void 0,triggerContext:"product_usage"})},this.delayMs))}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null)}incrementPageViews(){try{const t=(parseInt(sessionStorage.getItem(xi(this.siteId))||"0",10)||0)+1;return sessionStorage.setItem(xi(this.siteId),String(t)),t}catch{return this.minPageViews}}}function ca(){return`
/* ============================================================
