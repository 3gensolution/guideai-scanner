var Pa=Object.defineProperty;var Ra=(w,G,J)=>G in w?Pa(w,G,{enumerable:!0,configurable:!0,writable:!0,value:J}):w[G]=J;var x=(w,G,J)=>Ra(w,typeof G!="symbol"?G+"":G,J);(function(){"use strict";const w={cdnUrl:"https://cdn.jsdelivr.net/gh/3gensolution/guideai-scanner@cdn-v0.1.0/cdn/guideai.js",apiUrl:"https://api.3guideai.com",idleTimeout:2e4,sessionTimeoutMs:18e5,geolocationMode:"off",chipDismissSeconds:300,batchSize:50,batchIntervalMs:3e4,bubblePosition:"bottom-right",bubbleLabelText:"Help",bubbleIcon:"robot",bubbleImageUrl:"",bubbleDrift:{spring:.005,damping:.92,minTargetInterval:4e3,maxTargetInterval:8e3,enabled:!0},bubbleMode:"drift",bubbleCrawl:{speed:40,climbWalls:!0,cornerPauseMs:1500,persistentSpeech:!0,messages:["Need help? Click me!","I can guide you around.","Try asking me anything!"],messageIntervalMs:8e3},widgetMode:"guide",theme:{},feedbackPromptDelayMs:3e4,feedbackPromptMinPageViews:2};function G(n){const e=n.getAttribute("data-site-id")??"",t=n.getAttribute("data-token")??"";if(!e||!t)throw new Error("[GuideAI] Missing required data-site-id or data-token on script tag.");return{siteId:e,token:t,cdnUrl:n.getAttribute("data-cdn-url")??w.cdnUrl,apiUrl:n.getAttribute("data-api-url")??w.apiUrl,idleTimeout:parseInt(n.getAttribute("data-idle-timeout")??"",10)||w.idleTimeout,sessionTimeoutMs:parseInt(n.getAttribute("data-session-timeout-ms")??"",10)||w.sessionTimeoutMs,geolocationMode:n.getAttribute("data-geolocation")??w.geolocationMode,chipDismissSeconds:parseInt(n.getAttribute("data-chip-dismiss-seconds")??"",10)||w.chipDismissSeconds,batchSize:parseInt(n.getAttribute("data-batch-size")??"",10)||w.batchSize,batchIntervalMs:parseInt(n.getAttribute("data-batch-interval-ms")??"",10)||w.batchIntervalMs,autoAdvanceOnTargetClick:n.getAttribute("data-auto-advance-on-target-click")!=="false",guidesEnabled:n.getAttribute("data-guides-enabled")!=="false",bubbleEnabled:n.getAttribute("data-bubble-enabled")!=="false",bubblePosition:n.getAttribute("data-bubble-position")??w.bubblePosition,bubbleLabelText:n.getAttribute("data-bubble-label")??w.bubbleLabelText,bubbleIcon:n.getAttribute("data-bubble-icon")??w.bubbleIcon,bubbleImageUrl:n.getAttribute("data-bubble-image")??w.bubbleImageUrl,bubbleDrift:{...w.bubbleDrift},bubbleMode:n.getAttribute("data-bubble-mode")??w.bubbleMode,bubbleCrawl:{...w.bubbleCrawl},widgetMode:n.getAttribute("data-widget-mode")??w.widgetMode,theme:{...w.theme},recordingEnabled:n.getAttribute("data-recording")==="true",feedbackAutoPromptEnabled:n.getAttribute("data-feedback-auto-prompt")!=="false",feedbackPromptDelayMs:parseInt(n.getAttribute("data-feedback-prompt-delay-ms")??"",10)||w.feedbackPromptDelayMs,feedbackPromptMinPageViews:parseInt(n.getAttribute("data-feedback-prompt-min-pageviews")??"",10)||w.feedbackPromptMinPageViews,extensionMode:n.getAttribute("data-extension-mode")==="true"}}class J{constructor(e,t){this.crypto=null,this.baseUrl=e.replace(/\/+$/,""),this.token=t}setCryptoManager(e){this.crypto=e}headers(){return{"Content-Type":"application/json","X-API-Key":this.token}}async get(e){const t=`${this.baseUrl}${e}`,i=await fetch(t,{method:"GET",headers:this.headers()});if(!i.ok)throw new Error(`[GuideAI] GET ${e} failed: ${i.status}`);return i.json()}async post(e,t){var o;const i=`${this.baseUrl}${e}`;let r;if(t!==void 0&&((o=this.crypto)!=null&&o.isReady())){const a=this.crypto.encrypt(t);r=JSON.stringify(a||t)}else t!==void 0&&(r=JSON.stringify(t));const s=await fetch(i,{method:"POST",headers:this.headers(),body:r});if(!s.ok)throw new Error(`[GuideAI] POST ${e} failed: ${s.status}`);return s.json()}postKeepalive(e,t){var s;const i=`${this.baseUrl}${e}`;let r;if((s=this.crypto)!=null&&s.isReady()){const o=this.crypto.encrypt(t);r=JSON.stringify(o||t)}else r=JSON.stringify(t);try{fetch(i,{method:"POST",headers:this.headers(),body:r,keepalive:!0})}catch{}}}const ht="guideai-kb-v1";class Ci{constructor(){this.cacheAvailable=typeof caches<"u"}async get(e){if(!this.cacheAvailable)return null;try{return await(await caches.open(ht)).match(e)??null}catch{return null}}async put(e,t){if(this.cacheAvailable)try{await(await caches.open(ht)).put(e,t.clone())}catch{}}async getOrFetch(e,t){const i=await this.get(e),r=async()=>{try{const s=await fetch(e,{method:"GET",headers:t});return s.ok?(await this.put(e,s.clone()),s):null}catch{return null}};return i?(r(),i):r()}}class Ti{constructor(e,t,i){this.bubbleSettings=null,this.helpSupportEnabled=!1,this.widgetMode=null,this.bubbleMode=null,this.url=`${e.replace(/\/+$/,"")}/cdn/knowledge-base/${t}`,this.token=i,this.cache=new Ci}async load(){try{const e={Accept:"application/json","X-API-Key":this.token},t=await this.cache.getOrFetch(this.url,e);if(!t)return null;const i=await t.json();return i.bubble_settings&&typeof i.bubble_settings=="object"&&(this.bubbleSettings=i.bubble_settings,(this.bubbleSettings.mode==="crawl"||this.bubbleSettings.mode==="drift")&&(this.bubbleMode=this.bubbleSettings.mode)),i.help_support_enabled&&(this.helpSupportEnabled=!0),i.widget_mode&&["guide","support","combined"].includes(i.widget_mode)&&(this.widgetMode=i.widget_mode),this.normalize(i)}catch(e){return typeof console<"u"&&console.warn("[GuideAI] Failed to load knowledge base:",e),null}}normalize(e){const t=e.elements??[],i=e.routes??[];return{id:e.id??"",site_id:e.site_id??"",version:e.version??1,framework:e.framework??"",scanned_at:e.scanned_at??"",routes:i.map(r=>({path:r.path??"",page_title:r.page_title,component_name:r.component_name,source_file:r.source_file,dynamic_segments:r.dynamic_segments??[],auth_required:r.auth_required??!1,headings:r.headings??[]})),elements:t.map((r,s)=>{var o,a,l,c;return{id:r.id??`el_${s}`,route_path:r.route_path??r.route??"",tag:r.tag??"",text:r.text,aria_label:r.aria_label,placeholder:(o=r.attributes)==null?void 0:o.placeholder,name:(a=r.attributes)==null?void 0:a.name,data_guideai:(l=r.attributes)==null?void 0:l["data-guideai"],data_testid:(c=r.attributes)==null?void 0:c["data-testid"],fingerprint:r.fingerprint??{tier1_stable:{score:0},tier2_text:{variants:[],score:0},tier3_structural:{tag:r.tag??"",dom_depth:0,score:0},tier4_context:{score:0},tier5_position:{score:0},total_score:0}}})}}}class Ai{constructor(e,t,i){this.queue=[],this.flushTimer=null,this.unloadHandler=null,this.visibilityHandler=null,this.sender=e,this.batchSize=t,this.batchIntervalMs=i,this.flushTimer=setInterval(()=>this.flush(),this.batchIntervalMs),this.unloadHandler=()=>this.flushBeacon(),window.addEventListener("beforeunload",this.unloadHandler),this.visibilityHandler=()=>{document.visibilityState==="hidden"&&this.flushBeacon()},document.addEventListener("visibilitychange",this.visibilityHandler)}push(e){this.queue.push(e),this.queue.length>=this.batchSize&&this.flush()}flush(){if(this.queue.length===0)return;const e=this.queue.splice(0);this.sender.send(e).catch(()=>{this.queue.unshift(...e)})}flushBeacon(){if(this.queue.length===0)return;const e=this.queue.splice(0);this.sender.sendKeepalive(e)}destroy(){this.flushTimer&&(clearInterval(this.flushTimer),this.flushTimer=null),this.unloadHandler&&(window.removeEventListener("beforeunload",this.unloadHandler),this.unloadHandler=null),this.visibilityHandler&&(document.removeEventListener("visibilitychange",this.visibilityHandler),this.visibilityHandler=null)}}const ce="[REDACTED]",Li=[{regex:/\b\d{4}[\s-]?\d{4}[\s-]?\d{4}[\s-]?\d{1,7}\b/g,replacement:ce},{regex:/\b\d{3}-\d{2}-\d{4}\b/g,replacement:ce},{regex:/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b/g,replacement:ce},{regex:/\b\+?1?[-.\s]?\(?\d{3}\)?[-.\s]?\d{3}[-.\s]?\d{4}\b/g,replacement:ce}],Ii=["password","passwd","secret","token","api_key","apikey","api-key","credit_card","card_number","card-number","cvv","cvc","ccv","ssn","social_security","pin"],Mi=new Set(["email","full_name","name","phone"]);function gt(n){if(!n)return n;let e=n;for(const{regex:t,replacement:i}of Li)e=e.replace(t,i);return e}function de(n){const e={...n};for(const t of Object.keys(e)){const i=t.toLowerCase();if(Ii.some(s=>i.includes(s))){e[t]=ce;continue}const r=e[t];typeof r=="string"?Mi.has(i)?e[t]=r:e[t]=gt(r):Array.isArray(r)?e[t]=r.map(s=>typeof s=="string"?gt(s):s&&typeof s=="object"&&!Array.isArray(s)?de(s):s):r&&typeof r=="object"&&!Array.isArray(r)&&(e[t]=de(r))}return e}const Pi="guideai_anon_id_";function Ri(n){const e=Pi+n;try{let t=localStorage.getItem(e);return t||(t=pt(),localStorage.setItem(e,t)),t}catch{return pt()}}function pt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16)})}function Hi(n){const e=navigator.userAgent||"",{browser:t,version:i}=Ni(e),r=$i(e),s=Di(),o=`guideai_visits_${n}`,a=`guideai_first_visit_${n}`;let l=1,c=!1,d;try{const g=localStorage.getItem(o);g&&(l=(parseInt(g,10)||0)+1,c=!0),localStorage.setItem(o,String(l)),d=localStorage.getItem(a)||void 0,d||(d=new Date().toISOString(),localStorage.setItem(a,d))}catch{}let u,h,f;try{const g=navigator;g.connection&&(u=g.connection.effectiveType,h=g.connection.downlink,f=g.connection.rtt)}catch{}let m="";try{m=Intl.DateTimeFormat().resolvedOptions().timeZone}catch{}const p=Oi();return{browser:t,browser_version:i,os:r,device_type:s,screen_width:screen.width||0,screen_height:screen.height||0,viewport_width:window.innerWidth||0,viewport_height:window.innerHeight||0,pixel_ratio:window.devicePixelRatio||1,device_memory:navigator.deviceMemory,hardware_concurrency:navigator.hardwareConcurrency,touch_capable:"ontouchstart"in window||navigator.maxTouchPoints>0,connection_type:u,connection_downlink:h,connection_rtt:f,timezone:m,language:navigator.language||"",languages:Array.from(navigator.languages||[]),is_returning:c,session_number:l,first_visit_at:d,referrer:document.referrer||"",entry_url:location.href,platform_hints:p}}function Ni(n){const e=[["Edge",/Edg[e/](\d+[\d.]*)/],["Opera",/OPR\/(\d+[\d.]*)/],["Chrome",/Chrome\/(\d+[\d.]*)/],["Firefox",/Firefox\/(\d+[\d.]*)/],["Safari",/Version\/(\d+[\d.]*).*Safari/],["IE",/(?:MSIE |Trident.*rv:)(\d+[\d.]*)/]];for(const[t,i]of e){const r=n.match(i);if(r)return{browser:t,version:r[1]}}return{browser:"Unknown",version:""}}function $i(n){return/Windows/.test(n)?"Windows":/Mac OS X|macOS/.test(n)?"macOS":/CrOS/.test(n)?"ChromeOS":/Linux/.test(n)?"Linux":/Android/.test(n)?"Android":/iPhone|iPad|iPod/.test(n)?"iOS":"Unknown"}function Di(){const n=navigator.userAgent||"",e=navigator.maxTouchPoints||0,t=screen.width||window.innerWidth;return/iPhone|iPod|Android.*Mobile|webOS|BlackBerry|Opera Mini/i.test(n)?"mobile":/iPad|Android(?!.*Mobile)|Tablet/i.test(n)||e>0&&t>=768?"tablet":(e===0||t>1024,"desktop")}function Oi(){const n=[],e=window;try{(e.ethereum||e.web3||e.solana||e.phantom)&&n.push("web3"),e.M&&typeof e.M=="object"&&e.M.cfg&&n.push("moodle"),(e.$A||e.sforce||document.querySelector("lightning-app, force-aloha-page"))&&n.push("salesforce"),(document.querySelector("[data-reactroot], [data-reactid]")||e.__REACT_DEVTOOLS_GLOBAL_HOOK__)&&n.push("react"),(document.querySelector("[ng-app], [data-ng-app], [ng-version]")||e.ng)&&n.push("angular"),(document.querySelector("[data-v-]")||e.__VUE__)&&n.push("vue"),(e.wp||document.querySelector('meta[name="generator"][content*="WordPress"]'))&&n.push("wordpress"),e.Shopify&&n.push("shopify"),e.matchMedia&&e.matchMedia("(display-mode: standalone)").matches&&n.push("pwa")}catch{}return n}const ft="guideai_session_";function se(){return new Date().toISOString()}function mt(n){if(!n)return null;try{const e=JSON.parse(n);if(e&&typeof e.id=="string"&&typeof e.last_seen_at=="string")return{id:e.id,started_at:typeof e.started_at=="string"?e.started_at:e.last_seen_at,last_seen_at:e.last_seen_at}}catch{return{id:n,started_at:se(),last_seen_at:se()}}return null}function bt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16)})}function Bi(n,e){const t=Date.parse(n.last_seen_at);return Number.isFinite(t)?Date.now()-t>e:!0}function zi(n,e){const t=ft+n;try{const i=mt(sessionStorage.getItem(t));if(i&&!Bi(i,e)){const s={...i,last_seen_at:se()};return sessionStorage.setItem(t,JSON.stringify(s)),{id:s.id,isNew:!1}}const r={id:bt(),started_at:se(),last_seen_at:se()};return sessionStorage.setItem(t,JSON.stringify(r)),{id:r.id,isNew:!0}}catch{return{id:bt(),isNew:!0}}}function Fi(n){const e=ft+n;try{const t=mt(sessionStorage.getItem(e));if(!t)return;sessionStorage.setItem(e,JSON.stringify({...t,last_seen_at:se()}))}catch{}}const yt="guideai_geo_",Gi=1440*6e4;function vt(){return new Date().toISOString()}function qi(n){if(!n)return!1;const e=Date.parse(n);return Number.isFinite(e)?Date.now()-e<Gi:!1}function xt(n){try{const e=sessionStorage.getItem(yt+n);if(!e)return null;const t=JSON.parse(e);return typeof t.geo_lat!="number"||typeof t.geo_lng!="number"||!qi(t.geo_captured_at)?null:{geo_lat:t.geo_lat,geo_lng:t.geo_lng,geo_accuracy_m:typeof t.geo_accuracy_m=="number"?t.geo_accuracy_m:void 0,geo_captured_at:t.geo_captured_at??vt(),geo_source:"browser"}}catch{return null}}function Ui(n,e){try{sessionStorage.setItem(yt+n,JSON.stringify(e))}catch{}}async function Vi(){try{const n=navigator.permissions;return n!=null&&n.query?(await n.query({name:"geolocation"})).state??"unknown":"unknown"}catch{return"unknown"}}function Wi(n=2e3){return new Promise((e,t)=>{if(!navigator.geolocation)return t(new Error("Geolocation unavailable"));navigator.geolocation.getCurrentPosition(e,t,{enableHighAccuracy:!1,timeout:n,maximumAge:10*6e4})})}async function ji(n,e){if(e==="off")return null;const t=xt(n);if(t)return t;if(!navigator.geolocation)return null;const i=await Vi();if(e==="granted-only"&&i!=="granted"||i==="denied")return null;try{const r=await Wi(),s={geo_lat:r.coords.latitude,geo_lng:r.coords.longitude,geo_accuracy_m:r.coords.accuracy,geo_captured_at:vt(),geo_source:"browser"};return Ui(n,s),s}catch{return null}}const D=160,Ki=200,xe=180;function Yi(){const n=location.pathname||"/",e=location.search||"",t=location.hash||"";return{page_title:L(document.title,D)||void 0,pathname:n,search:e||void 0,hash:t||void 0,url_origin:location.origin||void 0,url_host:location.host||void 0,referrer_host:Xi(),viewport_width:window.innerWidth||void 0,viewport_height:window.innerHeight||void 0,screen_width:screen.width||void 0,screen_height:screen.height||void 0,scroll_x:Math.round(window.scrollX||0),scroll_y:Math.round(window.scrollY||0),document_lang:document.documentElement.lang||void 0,platform_hints:Ji()}}function oe(n){if(!n||!(n instanceof Element))return{};const e=n,i=Qi(e)||e,r=i.closest("form");return{element_text:L(Zi(i),D)||void 0,element_tag:i.tagName.toLowerCase(),metadata:ar({element_id:i.id||void 0,element_class:sr(i.className),element_role:i.getAttribute("role")||void 0,element_href:nr(i),element_name:i.getAttribute("name")||void 0,element_type:i.getAttribute("type")||void 0,element_aria_label:L(i.getAttribute("aria-label")||"",D)||void 0,element_placeholder:L(i.getAttribute("placeholder")||"",D)||void 0,element_data_guideai:i.getAttribute("data-guideai")||void 0,element_data_testid:i.getAttribute("data-testid")||i.getAttribute("data-test-id")||void 0,element_selector_hint:or(i),parent_text:L(er(i),D)||void 0,nearest_heading:L(tr(i),D)||void 0,section_title:L(ir(i),D)||void 0,form_id:(r==null?void 0:r.id)||void 0,form_name:(r==null?void 0:r.getAttribute("name"))||void 0,form_action:wt((r==null?void 0:r.getAttribute("action"))||""),input_label:L(rr(i),D)||void 0})}}function Xi(){if(document.referrer)try{return new URL(document.referrer).host||void 0}catch{return}}function Ji(){const n=[],e=window;try{(e.ethereum||e.web3||e.solana||e.phantom)&&n.push("web3"),e.M&&typeof e.M=="object"&&e.M.cfg&&n.push("moodle"),(e.$A||e.sforce||document.querySelector("lightning-app, force-aloha-page"))&&n.push("salesforce"),(e.__REACT_DEVTOOLS_GLOBAL_HOOK__||document.querySelector("[data-reactroot], [data-reactid]"))&&n.push("react"),(e.ng||document.querySelector("[ng-app], [data-ng-app], [ng-version]"))&&n.push("angular"),(e.__VUE__||document.querySelector("[data-v-]"))&&n.push("vue"),e.Shopify&&n.push("shopify"),(e.wp||document.querySelector('meta[name="generator"][content*="WordPress"]'))&&n.push("wordpress")}catch{return[]}return n.slice(0,6)}function Qi(n){let e=n;for(let t=0;e&&t<5;t++){const i=e.tagName.toLowerCase(),r=e.getAttribute("role");if(["a","button","input","select","textarea","summary"].includes(i)||r==="button"||r==="link"||r==="tab"||r==="menuitem"||e.onclick||e.getAttribute("tabindex")!==null)return e;e=e.parentElement}return null}function Zi(n){return(n.getAttribute("aria-label")||n.getAttribute("placeholder")||n.innerText||n.textContent||"").trim().replace(/\s+/g," ")}function er(n){const e=n.parentElement;return!e||e===document.body?"":(e.textContent||"").trim().replace(/\s+/g," ")}function tr(n){var r,s;let e=n;for(let o=0;e&&o<5;o++){const a=e.querySelector(":scope > h1, :scope > h2, :scope > h3, :scope > h4, :scope > h5, :scope > h6");if((r=a==null?void 0:a.textContent)!=null&&r.trim())return a.textContent.trim().replace(/\s+/g," ");e=e.parentElement}const t=n.closest('section, article, [role="region"], [role="tabpanel"]'),i=t==null?void 0:t.querySelector("h1, h2, h3, h4, h5, h6");return((s=i==null?void 0:i.textContent)==null?void 0:s.trim().replace(/\s+/g," "))||""}function ir(n){var i;const e=n.closest('section, article, aside, nav, [role="region"], [role="tabpanel"], [class*="card"], [class*="panel"]');if(!e)return"";const t=e.querySelector('h1, h2, h3, h4, h5, h6, [role="heading"], .card-title, .section-title, strong');return((i=t==null?void 0:t.textContent)==null?void 0:i.trim().replace(/\s+/g," "))||e.getAttribute("aria-label")||""}function rr(n){var t,i;if(n.id)try{const r=document.querySelector(`label[for="${CSS.escape(n.id)}"]`);if((t=r==null?void 0:r.textContent)!=null&&t.trim())return r.textContent.trim().replace(/\s+/g," ")}catch{}const e=n.closest("label");return e&&e!==n&&((i=e.textContent)!=null&&i.trim())?e.textContent.trim().replace(/\s+/g," "):""}function nr(n){const e=n.href||n.getAttribute("href")||"";if(e)return wt(e)||void 0}function wt(n){if(n)try{const e=new URL(n,location.origin);return`${e.pathname}${e.search}${e.hash}`.slice(0,D)}catch{return L(n,D)||void 0}}function sr(n){if(n)return L(n.split(/\s+/).filter(Boolean).slice(0,4).join(" "),Ki)||void 0}function or(n){const e=n.getAttribute("data-guideai");if(e)return`[data-guideai="${e}"]`;const t=n.getAttribute("data-testid")||n.getAttribute("data-test-id");if(t)return`[data-testid="${t}"]`;if(n.id)return`#${n.id}`;const i=n.getAttribute("name");if(i)return L(`${n.tagName.toLowerCase()}[name="${i}"]`,xe)||void 0;const r=n.tagName.toLowerCase(),s=n.getAttribute("role");if(s)return L(`${r}[role="${s}"]`,xe)||void 0;if(r==="a"){const o=n.getAttribute("href");if(o)return L(`a[href="${o}"]`,xe)||void 0}return L(r,xe)||void 0}function ar(n){return Object.fromEntries(Object.entries(n).filter(([,e])=>e==null?!1:typeof e=="string"?e.trim().length>0:Array.isArray(e)?e.length>0:!0))}function L(n,e){const t=n.trim().replace(/\s+/g," ");return t.length<=e?t:t.slice(0,e)}const kt="/api/v1/events";class lr{constructor(e,t,i){this.api=e,this.siteId=t,this.sessionId=i}async send(e){if(e.length===0)return;const i=e.map(r=>this.enrich(r)).map(r=>de(r));try{await this.api.post(kt,{events:i})}catch(r){typeof console<"u"&&console.warn("[GuideAI] Failed to send events:",r)}}sendKeepalive(e){if(e.length===0)return;const i=e.map(r=>this.enrich(r)).map(r=>de(r));this.api.postKeepalive(kt,{events:i})}prepareForEncrypt(e){return e.map(i=>this.enrich(i)).map(i=>de(i))}enrich(e){var o;Fi(this.siteId);let t=e.user_id;if(!t)try{t=sessionStorage.getItem(`guideai_user_id_${this.siteId}`)||void 0}catch{}let i;try{const a=sessionStorage.getItem(`guideai_account_${this.siteId}`);a&&(i=(o=JSON.parse(a))==null?void 0:o.id)}catch{}const r=xt(this.siteId)??void 0,s={...Yi(),...e.metadata,...i?{account_id:i}:{},...r||{}};return{site_id:this.siteId,session_id:this.sessionId,anonymous_id:e.anonymous_id??Ri(this.siteId),event_type:"click",url:location.href,timestamp:new Date().toISOString(),...e,...t?{user_id:t}:{},metadata:s}}}const cr=3,_t=500;class dr{constructor(e){this.clickMap=new WeakMap,this.handler=null,this.callback=e}start(){this.handler=e=>{e.target&&this.trackClick(e)},document.addEventListener("click",this.handler,{capture:!0,passive:!0})}destroy(){this.handler&&(document.removeEventListener("click",this.handler,{capture:!0}),this.handler=null)}trackClick(e){const t=e.target,i=Date.now();let r=this.clickMap.get(t);r||(r={timestamps:[]},this.clickMap.set(t,r)),r.timestamps.push(i),r.timestamps=r.timestamps.filter(s=>i-s<=_t),r.timestamps.length>=cr&&(this.fireRageClick(t,r.timestamps.length),r.timestamps=[],document.dispatchEvent(new CustomEvent("guideai:frustration")))}fireRageClick(e,t){const i=oe(e),r="metadata"in i?i.metadata:{};this.callback({event_type:"rage_click",url:location.href,element_text:i.element_text||this.truncate(e.innerText??e.textContent??"",100),element_tag:i.element_tag||e.tagName.toLowerCase(),click_count:t,timestamp:new Date().toISOString(),metadata:{...r,rage_window_ms:_t}})}truncate(e,t){return e.length>t?e.slice(0,t):e}}const Et=300;class ur{constructor(e){this.handler=null,this.callback=e}start(){this.handler=e=>{e.target&&this.checkClick(e)},document.addEventListener("click",this.handler,{capture:!0,passive:!0})}destroy(){this.handler&&(document.removeEventListener("click",this.handler,{capture:!0}),this.handler=null)}checkClick(e){const t=e.target,i=t.tagName.toLowerCase();if(["html","body"].includes(i)||!(i==="a"||i==="button"||i==="input"||i==="select"||i==="textarea"||t.getAttribute("role")==="button"||t.getAttribute("role")==="link"||t.getAttribute("tabindex")!==null||t.onclick!==null||t.closest('a, button, [role="button"]')!==null))return;const s=location.href;let o=!1;const a=new MutationObserver(()=>{o=!0});a.observe(document.body,{childList:!0,subtree:!0,attributes:!0,characterData:!0}),setTimeout(()=>{a.disconnect();const l=location.href,c=s!==l,d=document.querySelector('[role="dialog"]')!==null||document.querySelector('[role="alertdialog"]')!==null||document.querySelector(".modal.show, .modal.active, dialog[open]")!==null;!o&&!c&&!d&&this.fireDeadClick(t)},Et)}fireDeadClick(e){const t=oe(e),i="metadata"in t?t.metadata:{};this.callback({event_type:"dead_click",url:location.href,element_text:t.element_text||this.truncate(e.innerText??e.textContent??"",100),element_tag:t.element_tag||e.tagName.toLowerCase(),had_response:!1,timestamp:new Date().toISOString(),metadata:{...i,observation_window_ms:Et}}),document.dispatchEvent(new CustomEvent("guideai:frustration"))}truncate(e,t){return e.length>t?e.slice(0,t):e}}const Ne=[".error",".field-error",".form-error",".invalid-feedback",".validation-error",".has-error",'[role="alert"]','[aria-invalid="true"]'].join(",");class hr{constructor(e){this.observer=null,this.existingErrors=new Set,this.debounceTimer=null,this.pendingErrors=[],this.callback=e}start(){this.snapshotExisting(),this.observer=new MutationObserver(e=>{for(const t of e){if(t.type==="childList")for(let i=0;i<t.addedNodes.length;i++){const r=t.addedNodes[i];r.nodeType===Node.ELEMENT_NODE&&this.checkElement(r)}t.type==="attributes"&&t.target.nodeType===Node.ELEMENT_NODE&&this.checkElement(t.target)}}),this.observer.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","role","aria-invalid"]})}destroy(){this.observer&&(this.observer.disconnect(),this.observer=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null),this.existingErrors.clear(),this.pendingErrors=[]}snapshotExisting(){const e=document.querySelectorAll(Ne);for(let t=0;t<e.length;t++)this.existingErrors.add(e[t])}checkElement(e){if(this.existingErrors.has(e))return;const t=e.matches(Ne);let i=[];t&&i.push(e);const r=e.querySelectorAll(Ne);for(let s=0;s<r.length;s++)this.existingErrors.has(r[s])||i.push(r[s]);i.length!==0&&(this.pendingErrors.push(...i),this.scheduleFlush())}scheduleFlush(){this.debounceTimer||(this.debounceTimer=setTimeout(()=>{this.flushErrors(),this.debounceTimer=null},100))}flushErrors(){if(this.pendingErrors.length===0)return;const e=new Set(this.pendingErrors);this.pendingErrors=[];for(const t of e){this.existingErrors.add(t);const i=t.innerText??t.textContent??"",r=t.closest("form"),s=oe(t),o="metadata"in s?s.metadata:{};this.callback({event_type:"form_error",url:location.href,element_text:s.element_text||this.truncate(i,200),element_tag:s.element_tag||t.tagName.toLowerCase(),timestamp:new Date().toISOString(),metadata:{...o,form_name:(r==null?void 0:r.getAttribute("name"))??(r==null?void 0:r.id)??void 0,error_class:t.className}})}document.dispatchEvent(new CustomEvent("guideai:frustration"))}truncate(e,t){return e.length>t?e.slice(0,t):e}}class gr{constructor(e){this.enrichers={},this.popstateHandler=null,this.hashchangeHandler=null,this.origPushState=null,this.origReplaceState=null,this.destroyed=!1,this.callback=e,this.currentUrl=location.href,this.pageEnteredAt=Date.now()}setEnrichers(e){this.enrichers=e}start(){this.origPushState=history.pushState.bind(history),history.pushState=(...e)=>{this.origPushState(...e),this.onUrlChange("push")},this.origReplaceState=history.replaceState.bind(history),history.replaceState=(...e)=>{this.origReplaceState(...e),this.onUrlChange("replace")},this.popstateHandler=()=>this.onUrlChange("popstate"),window.addEventListener("popstate",this.popstateHandler),this.hashchangeHandler=()=>this.onUrlChange("hash"),window.addEventListener("hashchange",this.hashchangeHandler)}destroy(){this.destroyed=!0,this.origPushState&&(history.pushState=this.origPushState),this.origReplaceState&&(history.replaceState=this.origReplaceState),this.popstateHandler&&(window.removeEventListener("popstate",this.popstateHandler),this.popstateHandler=null),this.hashchangeHandler&&(window.removeEventListener("hashchange",this.hashchangeHandler),this.hashchangeHandler=null)}firePageExit(){this.emitPageExit("unload")}onUrlChange(e){var r,s;if(this.destroyed)return;const t=location.href;if(t===this.currentUrl)return;const i=this.currentUrl;this.emitPageExit(e),(s=(r=this.enrichers).resetPageMetrics)==null||s.call(r),this.currentUrl=t,this.pageEnteredAt=Date.now(),this.callback({event_type:"page_view",url:t,previous_url:i,timestamp:new Date().toISOString(),metadata:{navigation_type:e,page_title:document.title}})}emitPageExit(e){const i={time_on_page_ms:Date.now()-this.pageEnteredAt,exit_trigger:e,page_title:document.title};if(this.enrichers.getScrollData)try{const r=this.enrichers.getScrollData();i.max_scroll_depth_pct=r.max_scroll_depth_pct}catch{}if(this.enrichers.getEngagementData)try{const r=this.enrichers.getEngagementData();i.active_time_ms=r.active_time_ms,i.idle_time_ms=r.idle_time_ms}catch{}if(this.enrichers.flushAbandoned)try{this.enrichers.flushAbandoned()}catch{}this.callback({event_type:"page_exit",url:this.currentUrl,timestamp:new Date().toISOString(),metadata:i})}}const pr=[25,50,75,90];class fr{constructor(e){this.maxDepthPct=0,this.firedThresholds=new Set,this.scrollHandler=null,this.rafId=null,this.pending=!1,this.destroyed=!1,this.callback=e}start(){this.scrollHandler=()=>{this.pending||this.destroyed||(this.pending=!0,this.rafId=requestAnimationFrame(()=>{this.pending=!1,this.measure()}))},window.addEventListener("scroll",this.scrollHandler,{passive:!0}),document.addEventListener("scroll",this.scrollHandler,{passive:!0,capture:!0})}destroy(){this.destroyed=!0,this.scrollHandler&&(window.removeEventListener("scroll",this.scrollHandler),document.removeEventListener("scroll",this.scrollHandler,{capture:!0}),this.scrollHandler=null),this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null)}reset(){this.maxDepthPct=0,this.firedThresholds.clear()}getPageScrollData(){return{max_scroll_depth_pct:this.maxDepthPct}}measure(){const e=Math.max(document.body.scrollHeight||0,document.documentElement.scrollHeight||0),t=window.innerHeight||document.documentElement.clientHeight||0,i=window.scrollY||document.documentElement.scrollTop||0;if(e<=t){this.maxDepthPct=100;return}const r=e-t,s=Math.min(100,Math.round(i/r*100));s>this.maxDepthPct&&(this.maxDepthPct=s);for(const o of pr)s>=o&&!this.firedThresholds.has(o)&&(this.firedThresholds.add(o),this.callback({event_type:"scroll",url:location.href,timestamp:new Date().toISOString(),metadata:{scroll_depth_pct:o,max_depth_pct:this.maxDepthPct,page_height:e,viewport_height:t}}))}}const mr=3e4,br=5e3;class yr{constructor(){this.activeTimeMs=0,this.idleTimeMs=0,this.heartbeatTimer=null,this.visibilityHandler=null,this.activityHandler=null,this.isPageVisible=!0,this.destroyed=!1,this.lastActivityAt=Date.now(),this.lastHeartbeatAt=Date.now()}start(){this.activityHandler=()=>{this.lastActivityAt=Date.now()};const e={passive:!0,capture:!0};document.addEventListener("mousemove",this.activityHandler,e),document.addEventListener("keydown",this.activityHandler,e),document.addEventListener("touchstart",this.activityHandler,e),document.addEventListener("scroll",this.activityHandler,e),document.addEventListener("click",this.activityHandler,e),this.visibilityHandler=()=>{this.isPageVisible=!document.hidden,this.isPageVisible&&(this.lastActivityAt=Date.now())},document.addEventListener("visibilitychange",this.visibilityHandler),this.heartbeatTimer=setInterval(()=>this.heartbeat(),br)}destroy(){this.destroyed=!0;const e={capture:!0};this.activityHandler&&(document.removeEventListener("mousemove",this.activityHandler,e),document.removeEventListener("keydown",this.activityHandler,e),document.removeEventListener("touchstart",this.activityHandler,e),document.removeEventListener("scroll",this.activityHandler,e),document.removeEventListener("click",this.activityHandler,e),this.activityHandler=null),this.visibilityHandler&&(document.removeEventListener("visibilitychange",this.visibilityHandler),this.visibilityHandler=null),this.heartbeatTimer&&(clearInterval(this.heartbeatTimer),this.heartbeatTimer=null)}reset(){this.heartbeat(),this.activeTimeMs=0,this.idleTimeMs=0,this.lastActivityAt=Date.now(),this.lastHeartbeatAt=Date.now()}getEngagementData(){return this.heartbeat(),{active_time_ms:this.activeTimeMs,idle_time_ms:this.idleTimeMs}}heartbeat(){if(this.destroyed)return;const e=Date.now(),t=e-this.lastHeartbeatAt;this.lastHeartbeatAt=e;const i=e-this.lastActivityAt;!this.isPageVisible||i>mr?this.idleTimeMs+=t:this.activeTimeMs+=t}}class vr{constructor(e){this.clickHandler=null,this.dblClickHandler=null,this.contextHandler=null,this.destroyed=!1,this.callback=e}start(){this.clickHandler=e=>{this.destroyed||!e.target||this.emitClick(e,"click")},this.dblClickHandler=e=>{this.destroyed||!e.target||this.emitClick(e,"double_click")},this.contextHandler=e=>{this.destroyed||!e.target||this.emitClick(e,"right_click")},document.addEventListener("click",this.clickHandler,{capture:!0,passive:!0}),document.addEventListener("dblclick",this.dblClickHandler,{capture:!0,passive:!0}),document.addEventListener("contextmenu",this.contextHandler,{capture:!0,passive:!0})}destroy(){this.destroyed=!0;const e={capture:!0};this.clickHandler&&(document.removeEventListener("click",this.clickHandler,e),this.clickHandler=null),this.dblClickHandler&&(document.removeEventListener("dblclick",this.dblClickHandler,e),this.dblClickHandler=null),this.contextHandler&&(document.removeEventListener("contextmenu",this.contextHandler,e),this.contextHandler=null)}emitClick(e,t){var d,u;const i=e.target,s=this.findClickableAncestor(i)||i,o=((d=s.tagName)==null?void 0:d.toLowerCase())||"",a=this.classifyClick(s,o),l=oe(s),c="metadata"in l?l.metadata:{};this.callback({event_type:t,url:location.href,element_text:l.element_text||this.truncate(((u=s.textContent)==null?void 0:u.trim())||"",100),element_tag:l.element_tag||o,timestamp:new Date().toISOString(),metadata:{...c,click_type:a,viewport_x:Math.round(e.clientX),viewport_y:Math.round(e.clientY),page_x:Math.round(e.pageX),page_y:Math.round(e.pageY)}})}findClickableAncestor(e){var i;let t=e;for(let r=0;t&&r<5;r++){const s=(i=t.tagName)==null?void 0:i.toLowerCase();if(s==="a"||s==="button"||s==="input"||s==="select"||s==="textarea")return t;const o=t.getAttribute("role");if(o==="button"||o==="link"||o==="tab"||o==="menuitem"||t.onclick||t.getAttribute("tabindex"))return t;t=t.parentElement}return null}classifyClick(e,t){const i=e.getAttribute("role")||"",r=e.getAttribute("type")||"",s=e.getAttribute("href");return t==="a"||i==="link"?"link":e.closest("nav")||i==="navigation"?"navigation":i==="tab"||e.closest('[role="tablist"]')?"tab":r==="checkbox"||r==="radio"||i==="switch"?"toggle":t==="select"||i==="listbox"||i==="combobox"?"dropdown":t==="input"||t==="textarea"?"form_field":t==="button"||i==="button"?r==="submit"||e.classList.contains("cta")||e.classList.contains("primary")?"cta":"button":s?"link":"other"}truncate(e,t){return e.length>t?e.slice(0,t):e}}class xr{constructor(e){this.formStates=new WeakMap,this.activeForms=new Set,this.focusHandler=null,this.submitHandler=null,this.pasteHandler=null,this.destroyed=!1,this.callback=e}start(){this.focusHandler=e=>{this.destroyed||!e.target||this.onFieldFocus(e.target)},this.submitHandler=e=>{this.destroyed||!e.target||this.onFormSubmit(e.target)},this.pasteHandler=e=>{this.destroyed||!e.target||this.onPaste(e.target)},document.addEventListener("focusin",this.focusHandler,{capture:!0,passive:!0}),document.addEventListener("submit",this.submitHandler,{capture:!0}),document.addEventListener("paste",this.pasteHandler,{capture:!0,passive:!0})}destroy(){this.destroyed=!0,this.focusHandler&&(document.removeEventListener("focusin",this.focusHandler,{capture:!0}),this.focusHandler=null),this.submitHandler&&(document.removeEventListener("submit",this.submitHandler,{capture:!0}),this.submitHandler=null),this.pasteHandler&&(document.removeEventListener("paste",this.pasteHandler,{capture:!0}),this.pasteHandler=null),this.activeForms.clear()}flushAbandoned(){for(const e of this.activeForms){const t=this.formStates.get(e);if(t&&!t.submitted&&t.fieldsInteracted.size>0){const i=e;this.callback({event_type:"form_abandon",url:location.href,timestamp:new Date().toISOString(),metadata:{form_id:t.formId,total_fields:t.totalFields,fields_interacted:t.fieldsInteracted.size,field_order:t.fieldOrder.slice(0,20),last_field:t.lastFieldName,time_spent_ms:Date.now()-t.startedAt,had_paste:t.hasPaste,form_action:i.getAttribute("action")||void 0,form_method:i.getAttribute("method")||void 0}})}}this.activeForms.clear()}onFieldFocus(e){var c;const t=(c=e.tagName)==null?void 0:c.toLowerCase();if(t!=="input"&&t!=="textarea"&&t!=="select")return;const i=e.getAttribute("type");if(i==="hidden"||i==="submit"||i==="button")return;const r=e.closest("form")||e.closest('[role="form"]')||document.body,s=this.getFieldName(e),o=oe(e),a="metadata"in o?o.metadata:{};let l=this.formStates.get(r);if(!l){const d=r.querySelectorAll("input, textarea, select"),u=r.id||r.getAttribute("name")||`form_${Date.now()}`;l={formId:u,startedAt:Date.now(),totalFields:d.length,fieldsInteracted:new Set,fieldOrder:[],lastFieldName:s,hasPaste:!1,submitted:!1},this.formStates.set(r,l),this.activeForms.add(r),this.callback({event_type:"form_start",url:location.href,timestamp:new Date().toISOString(),metadata:{form_id:u,total_fields:d.length,first_field:s,...a}})}l.fieldsInteracted.has(s)||(l.fieldsInteracted.add(s),l.fieldOrder.push(s)),l.lastFieldName=s}onFormSubmit(e){const t=this.formStates.get(e);t&&(t.submitted=!0,this.activeForms.delete(e),this.callback({event_type:"form_submit",url:location.href,timestamp:new Date().toISOString(),metadata:{form_id:t.formId,total_fields:t.totalFields,fields_interacted:t.fieldsInteracted.size,field_order:t.fieldOrder.slice(0,20),time_to_submit_ms:Date.now()-t.startedAt,had_paste:t.hasPaste,form_action:e.getAttribute("action")||void 0,form_method:e.getAttribute("method")||void 0}}))}onPaste(e){const t=e.closest("form")||e.closest('[role="form"]')||document.body,i=this.formStates.get(t);i&&(i.hasPaste=!0)}getFieldName(e){return e.getAttribute("name")||e.getAttribute("aria-label")||e.id||e.getAttribute("placeholder")||e.tagName.toLowerCase()}}const St=5e3,wr=1e3;class kr{constructor(e){this.recentErrors=new Map,this.errorHandler=null,this.rejectionHandler=null,this.destroyed=!1,this.callback=e}start(){const e=window.onerror;this.errorHandler=(t,i,r,s,o)=>(this.destroyed||this.handleError(String(t),i||"",r||0,s||0,o==null?void 0:o.stack),typeof e=="function"?e(t,i,r,s,o):!1),window.onerror=this.errorHandler,this.rejectionHandler=t=>{if(this.destroyed)return;const i=t.reason,r=i instanceof Error?i.message:String(i),s=i instanceof Error?i.stack:void 0;this.handleError(r,"",0,0,s,!0)},window.addEventListener("unhandledrejection",this.rejectionHandler)}destroy(){this.destroyed=!0,this.errorHandler&&(window.onerror===this.errorHandler&&(window.onerror=null),this.errorHandler=null),this.rejectionHandler&&(window.removeEventListener("unhandledrejection",this.rejectionHandler),this.rejectionHandler=null),this.recentErrors.clear()}handleError(e,t,i,r,s,o=!1){if(t.includes("guideai")||s&&s.includes("guideai"))return;const a=`${e}|${t}|${i}`,l=Date.now(),c=this.recentErrors.get(a);if(!(c&&l-c<St)){if(this.recentErrors.set(a,l),this.recentErrors.size>50)for(const[d,u]of this.recentErrors)l-u>St&&this.recentErrors.delete(d);this.callback({event_type:"js_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_message:this.truncate(e,500),error_source:this.extractFilename(t),error_line:i,error_col:r,error_stack:s?this.sanitizeStack(s):void 0,is_unhandled_rejection:o||void 0}})}}extractFilename(e){if(!e)return"";try{const t=new URL(e),i=t.pathname.split("/");return i[i.length-1]||t.pathname}catch{return e.split("/").pop()||e}}sanitizeStack(e){const t=e.replace(/file:\/\/[^\s)]+/g,"[local]").replace(/\/Users\/[^\s:)]+/g,"[path]").replace(/\/home\/[^\s:)]+/g,"[path]").replace(/C:\\[^\s:)]+/g,"[path]");return this.truncate(t,wr)}truncate(e,t){return e.length>t?e.slice(0,t)+"…":e}}const _r=1e4;class Er{constructor(e){this.reportTimer=null,this.paintObserver=null,this.lcpObserver=null,this.longTaskObserver=null,this.resourceErrorHandler=null,this.origFetch=null,this.origXhrOpen=null,this.fcpMs=0,this.lcpMs=0,this.longTaskCount=0,this.destroyed=!1,this.callback=e}start(){try{this.paintObserver=new PerformanceObserver(e=>{for(const t of e.getEntries())t.name==="first-contentful-paint"&&(this.fcpMs=Math.round(t.startTime))}),this.paintObserver.observe({type:"paint",buffered:!0})}catch{}try{this.lcpObserver=new PerformanceObserver(e=>{const t=e.getEntries();t.length>0&&(this.lcpMs=Math.round(t[t.length-1].startTime))}),this.lcpObserver.observe({type:"largest-contentful-paint",buffered:!0})}catch{}try{this.longTaskObserver=new PerformanceObserver(e=>{this.longTaskCount+=e.getEntries().length}),this.longTaskObserver.observe({type:"longtask"})}catch{}this.resourceErrorHandler=e=>{if(this.destroyed)return;const t=e.target;if(!t||!t.tagName)return;const i=t.tagName.toLowerCase();if(i==="img"||i==="script"||i==="link"){const r=t.src||t.src||t.href||"";if(r.includes("guideai"))return;this.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{resource_tag:i,resource_url:this.extractPathname(r),error_type:"resource_load_failed"}})}},window.addEventListener("error",this.resourceErrorHandler,{capture:!0}),this.interceptFetch(),this.interceptXhr(),this.reportTimer=setTimeout(()=>this.emitPerformanceReport(),_r)}destroy(){this.destroyed=!0,this.reportTimer&&(clearTimeout(this.reportTimer),this.reportTimer=null),this.paintObserver&&(this.paintObserver.disconnect(),this.paintObserver=null),this.lcpObserver&&(this.lcpObserver.disconnect(),this.lcpObserver=null),this.longTaskObserver&&(this.longTaskObserver.disconnect(),this.longTaskObserver=null),this.resourceErrorHandler&&(window.removeEventListener("error",this.resourceErrorHandler,{capture:!0}),this.resourceErrorHandler=null),this.origFetch&&(window.fetch=this.origFetch,this.origFetch=null),this.origXhrOpen&&(XMLHttpRequest.prototype.open=this.origXhrOpen,this.origXhrOpen=null)}interceptFetch(){try{this.origFetch=window.fetch.bind(window);const e=this;window.fetch=function(...t){var s;const i=typeof t[0]=="string"?t[0]:((s=t[0])==null?void 0:s.url)||"",r=Date.now();return e.origFetch(...t).then(o=>{var a;return!e.destroyed&&o.status>=400&&!i.includes("guideai")&&!i.includes("/api/v1/events")&&e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"http_error",request_url:e.extractPathname(i),status_code:o.status,duration_ms:Date.now()-r,method:((a=t[1])==null?void 0:a.method)||"GET"}}),o},o=>{var a;throw!e.destroyed&&!i.includes("guideai")&&!i.includes("/api/v1/events")&&e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"fetch_failed",request_url:e.extractPathname(i),error_message:(o==null?void 0:o.message)||"Network request failed",duration_ms:Date.now()-r,method:((a=t[1])==null?void 0:a.method)||"GET"}}),o})}}catch{}}interceptXhr(){try{this.origXhrOpen=XMLHttpRequest.prototype.open;const e=this;XMLHttpRequest.prototype.open=function(t,i,...r){const s=String(i);if(!s.includes("guideai")&&!s.includes("/api/v1/events")){const o=Date.now();this.addEventListener("load",function(){!e.destroyed&&this.status>=400&&e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"xhr_http_error",request_url:e.extractPathname(s),status_code:this.status,duration_ms:Date.now()-o,method:t}})}),this.addEventListener("error",function(){e.destroyed||e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"xhr_failed",request_url:e.extractPathname(s),duration_ms:Date.now()-o,method:t}})}),this.addEventListener("timeout",function(){e.destroyed||e.callback({event_type:"network_error",url:location.href,timestamp:new Date().toISOString(),metadata:{error_type:"xhr_timeout",request_url:e.extractPathname(s),duration_ms:Date.now()-o,method:t}})})}return e.origXhrOpen.apply(this,[t,i,...r])}}catch{}}emitPerformanceReport(){var t,i,r;if(this.destroyed)return;const e={fcp_ms:this.fcpMs||void 0,lcp_ms:this.lcpMs||void 0,long_task_count:this.longTaskCount};try{const s=performance.getEntriesByType("navigation")[0];s&&(e.ttfb_ms=Math.round(s.responseStart-s.requestStart),e.dom_load_ms=Math.round(s.domContentLoadedEventEnd-s.startTime),e.page_load_ms=Math.round(s.loadEventEnd-s.startTime),e.dns_ms=Math.round(s.domainLookupEnd-s.domainLookupStart),e.connect_ms=Math.round(s.connectEnd-s.connectStart),e.transfer_size=s.transferSize)}catch{}(t=this.paintObserver)==null||t.disconnect(),(i=this.lcpObserver)==null||i.disconnect(),(r=this.longTaskObserver)==null||r.disconnect(),this.callback({event_type:"performance",url:location.href,timestamp:new Date().toISOString(),metadata:e})}extractPathname(e){try{return new URL(e).pathname}catch{return e}}}const $e=['[role="alert"]','[role="alertdialog"]','[role="status"]','[aria-live="assertive"]','[aria-live="polite"]',".error-message",".error-banner",".error-toast",".error-notification",".error-alert",".error-dialog",".error-text",".error-msg",".alert-error",".alert-danger",".alert-warning",".toast",".toast-error",".toast-warning",".Toastify__toast--error",".Toastify__toast--warning",".notistack-MuiContent-error",".notistack-MuiContent-warning",".react-hot-toast",".MuiAlert-standardError",".MuiAlert-standardWarning",".MuiAlert-filledError",".MuiAlert-filledWarning",".MuiSnackbar-root",".ant-message-error",".ant-message-warning",".ant-notification-notice-error",".ant-notification-notice-warning",".ant-alert-error",".ant-alert-warning",".alert-danger",".alert-warning",".invalid-feedback:not(.d-none)",".is-invalid",'[data-status="error"]','[data-status="warning"]',".alert.alert-danger",".moodle-exception-message","#notice.error",".notifyproblem",".notifyerror",".slds-notify--error",".slds-notify--warning",".slds-notify_alert",".slds-theme_error",'lightning-notice[variant="error"]',"force-record-layout-item .error",".web3modal-modal-card .error",".walletconnect-modal__text--error",'[class*="wallet-error"]','[class*="transaction-error"]','[class*="connect-error"]','[data-state="error"]',"dialog[open]"].join(","),Ct=[/\bunable to\b/i,/\bfailed to\b/i,/\bcannot\b.*\b(?:connect|load|save|send|process|complete|fetch|login|sign[- ]?in)\b/i,/\bcould not\b/i,/\bsomething went wrong\b/i,/\bunexpected error\b/i,/\binternal (?:server )?error\b/i,/\bservice unavailable\b/i,/\brequest (?:timed out|timeout)\b/i,/\btry again\b/i,/\bplease try\b/i,/\bconnection (?:lost|failed|refused|error)\b/i,/\bnetwork error\b/i,/\bno internet\b/i,/\boffline\b/i,/\baccess denied\b/i,/\bpermission denied\b/i,/\bunauthorized\b/i,/\bforbidden\b/i,/\bnot found\b/i,/\b(?:invalid|incorrect|wrong) (?:password|credentials|email|username|input)\b/i,/\bsession (?:expired|timed out)\b/i,/\blogin failed\b/i,/\bauthentication failed\b/i,/\bpayment (?:failed|declined|error)\b/i,/\binsufficient (?:funds|balance)\b/i,/\brate limit\b/i,/\btoo many (?:requests|attempts)\b/i,/\baccount (?:locked|suspended|disabled)\b/i,/\btransaction (?:failed|rejected|reverted)\b/i,/\bwallet (?:not found|disconnected|rejected)\b/i,/\buser rejected\b/i,/\bgas (?:estimation failed|too low)\b/i,/\bnonce too\b/i,/\bcontract (?:error|reverted)\b/i,/\bmetamask\b.*\b(?:error|rejected|denied)\b/i,/\bsubmission (?:failed|error)\b/i,/\bgrade (?:error|failed)\b/i,/\benrolment (?:error|failed)\b/i,/\bcourse (?:not available|error)\b/i,/\b(?:error |status )(?:4\d{2}|5\d{2})\b/i,/\b(?:404|500|502|503)\b.*\b(?:error|not found|unavailable)\b/i],De=5,Tt=500,At=3e3;class Sr{constructor(e){this.observer=null,this.existingElements=new WeakSet,this.recentErrors=new Map,this.debounceTimer=null,this.pendingElements=[],this.destroyed=!1,this.callback=e}start(){this.snapshotExisting(),this.observer=new MutationObserver(e=>{if(!this.destroyed)for(const t of e){if(t.type==="childList")for(let i=0;i<t.addedNodes.length;i++){const r=t.addedNodes[i];r.nodeType===Node.ELEMENT_NODE&&this.inspectElement(r)}t.type==="attributes"&&t.target.nodeType===Node.ELEMENT_NODE&&this.inspectElement(t.target)}}),this.observer.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","role","aria-live","data-status","data-state","style"]})}destroy(){this.destroyed=!0,this.observer&&(this.observer.disconnect(),this.observer=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null),this.recentErrors.clear(),this.pendingElements=[]}snapshotExisting(){try{const e=document.querySelectorAll($e);for(let t=0;t<e.length;t++)this.existingElements.add(e[t])}catch{}}inspectElement(e){var i;if(this.existingElements.has(e)||(i=e.closest)!=null&&i.call(e,"[data-guideai-root]"))return;if(this.isErrorElement(e)){this.pendingElements.push(e),this.scheduleFlush();return}try{const r=e.querySelectorAll($e);for(let s=0;s<r.length;s++)this.existingElements.has(r[s])||this.pendingElements.push(r[s]);this.pendingElements.length>0&&this.scheduleFlush()}catch{}}isErrorElement(e){try{if(e.matches($e)){const t=e.getAttribute("role");return t==="status"||t==="dialog"||e.tagName==="DIALOG"?this.hasErrorText(e):!0}}catch{}return!!this.looksLikeErrorByText(e)}hasErrorText(e){const t=this.getVisibleText(e);return t.length<De?!1:Ct.some(i=>i.test(t))}looksLikeErrorByText(e){const t=e,i=this.getVisibleText(e);if(i.length<De||i.length>Tt||!this.isVisible(t)||!Ct.some(a=>a.test(i)))return!1;const r=String(e.className||"").toLowerCase(),s=/error|alert|warn|danger|fail|toast|notify|snack|banner/i.test(r),o=this.hasErrorStyling(t);return s||o}hasErrorStyling(e){try{const t=window.getComputedStyle(e),i=t.color||"",r=t.backgroundColor||"",s=o=>{const a=o.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(!a)return!1;const l=parseInt(a[1],10),c=parseInt(a[2],10),d=parseInt(a[3],10);return l>150&&c<100&&d<100};return s(i)||s(r)}catch{return!1}}isVisible(e){try{if(e.offsetParent===null&&e.tagName!=="BODY")return!1;const t=window.getComputedStyle(e);return!(t.display==="none"||t.visibility==="hidden"||t.opacity==="0")}catch{return!0}}getVisibleText(e){return(e.innerText??e.textContent??"").trim().slice(0,Tt)}scheduleFlush(){this.debounceTimer||(this.debounceTimer=setTimeout(()=>{this.flush(),this.debounceTimer=null},150))}flush(){if(this.pendingElements.length===0)return;const e=[...new Set(this.pendingElements)];this.pendingElements=[];const t=Date.now();for(const i of e){this.existingElements.add(i);const r=this.getVisibleText(i);if(r.length<De)continue;const s=r.slice(0,100),o=this.recentErrors.get(s);if(o&&t-o<At)continue;this.recentErrors.set(s,t);const a=this.classifyError(r,i),l=oe(i),c="metadata"in l?l.metadata:{};this.callback({event_type:"ui_error",url:location.href,element_text:l.element_text||r.slice(0,300),element_tag:l.element_tag||i.tagName.toLowerCase(),timestamp:new Date().toISOString(),metadata:{...c,error_category:a,error_text:r.slice(0,300),container_type:this.getContainerType(i),is_modal:!!i.closest('dialog, [role="dialog"], [role="alertdialog"], .modal'),is_toast:!!i.closest('.toast, .Toastify, .notistack, .react-hot-toast, [class*="snackbar"], [class*="notification"]')}})}if(this.recentErrors.size>100)for(const[i,r]of this.recentErrors)t-r>At&&this.recentErrors.delete(i)}classifyError(e,t){const i=e.toLowerCase();return/login|sign.?in|credential|password|auth/i.test(i)?"authentication":/permission|denied|forbidden|unauthorized|access/i.test(i)?"authorization":/network|connect|internet|offline/i.test(i)?"network":/timeout|timed.?out/i.test(i)?"timeout":/payment|declined|insufficient|billing/i.test(i)?"payment":/not found|404|missing/i.test(i)?"not_found":/server error|500|502|503|unavailable/i.test(i)?"server":/rate limit|too many/i.test(i)?"rate_limit":/session|expired/i.test(i)?"session":/wallet|metamask|transaction|gas|nonce|contract/i.test(i)?"web3":/valid|invalid|required|format|must be/i.test(i)?"validation":/upload|file|size|too large/i.test(i)?"file":/enrol|course|grade|quiz|submission|assignment/i.test(i)?"lms":"general"}getContainerType(e){const t=e.getAttribute("role");if(t==="alertdialog")return"alert_dialog";if(t==="alert")return"alert";if(t==="dialog"||e.tagName==="DIALOG")return"dialog";if(t==="status")return"status";const i=String(e.className||"").toLowerCase();return/toast/i.test(i)?"toast":/snack/i.test(i)?"snackbar":/banner/i.test(i)?"banner":/modal/i.test(i)?"modal":/notif/i.test(i)?"notification":/alert/i.test(i)?"alert":"inline"}truncate(e,t){return e.length>t?e.slice(0,t):e}}const Oe=n=>`guideai_visitor_${n}`,Be=n=>`guideai_account_${n}`,Lt=n=>`guideai_user_id_${n}`,Cr=new Set(["identify","feature_used","product_view","add_to_cart","remove_from_cart","checkout_start","purchase","search","signup","login","share","subscribe","unsubscribe","feedback","rating","signup_started","signup_completed","trial_started","trial_abandoned","login_success","onboarding_started","onboarding_completed","setup_completed","key_action_completed","invite_sent","invite_accepted","upgrade_cta_clicked","addon_interest_clicked","demo_requested","lead_submitted","pricing_page_view","feedback_submitted","support_ticket_created","wallet_connect","wallet_disconnect","transaction_sign","transaction_confirm","token_swap","nft_view","nft_purchase","course_start","course_complete","lesson_view","quiz_start","quiz_complete","assignment_submit"]),Tr=50,we=500;class Ar{constructor(){this.eventBuffer=null,this.siteId=""}configure(e,t){this.eventBuffer=e,this.siteId=t}track(e,t){if(!this.eventBuffer||!e)return;const i=this.sanitizeMetadata(t||{}),r=Cr.has(e),s={event_type:r?e:"custom",url:location.href,timestamp:new Date().toISOString(),metadata:{...i,...r?{}:{custom_event_name:e}}};this.eventBuffer.push(s)}trackFeature(e,t,i){if(!this.eventBuffer||!e)return;const r=this.sanitizeMetadata(i||{}),s={event_type:"feature_used",url:location.href,timestamp:new Date().toISOString(),metadata:{...r,feature_key:e,...t?{feature_label:t}:{}}};this.eventBuffer.push(s)}identify(e){if(e)try{sessionStorage.setItem(Lt(this.siteId),e)}catch{}}getUserId(){try{return sessionStorage.getItem(Lt(this.siteId))}catch{return null}}initializeVisitor(e){var r;if(!((r=e==null?void 0:e.visitor)!=null&&r.id)){typeof console<"u"&&console.warn("[GuideAI] initialize() requires visitor.id");return}const{visitor:t,account:i}=e;this.identify(t.id);try{sessionStorage.setItem(Oe(this.siteId),JSON.stringify(t))}catch{}if(i!=null&&i.id)try{sessionStorage.setItem(Be(this.siteId),JSON.stringify(i))}catch{}if(this.eventBuffer){const s={visitor:{...t}};i&&(s.account={...i}),this.eventBuffer.push({event_type:"identify",url:location.href,timestamp:new Date().toISOString(),user_id:t.id,metadata:s})}}updateOptions(e){const{visitor:t,account:i}=e;if(t){const s={...this.getVisitorData(),...t};t.id&&this.identify(t.id);try{sessionStorage.setItem(Oe(this.siteId),JSON.stringify(s))}catch{}}if(i){const s={...this.getAccountData(),...i};try{sessionStorage.setItem(Be(this.siteId),JSON.stringify(s))}catch{}}if(this.eventBuffer){const r=this.getVisitorData(),s=this.getAccountData(),o={};r&&(o.visitor=r),s&&(o.account=s),this.eventBuffer.push({event_type:"identify",url:location.href,timestamp:new Date().toISOString(),user_id:(r==null?void 0:r.id)||this.getUserId()||void 0,metadata:o})}}getVisitorData(){try{const e=sessionStorage.getItem(Oe(this.siteId));return e?JSON.parse(e):null}catch{return null}}getAccountData(){try{const e=sessionStorage.getItem(Be(this.siteId));return e?JSON.parse(e):null}catch{return null}}sanitizeMetadata(e){const t={};let i=0;for(const[r,s]of Object.entries(e)){if(i>=Tr)break;if(s!=null){if(typeof s=="string")t[r]=s.length>we?s.slice(0,we):s;else if(typeof s=="number"||typeof s=="boolean")t[r]=s;else try{const o=JSON.stringify(s);t[r]=o.length>we?o.slice(0,we):o}catch{t[r]="[complex]"}i++}}return t}}const Lr=new Set(["password","credit-card","ssn"]),Ir=new Set(["SCRIPT","NOSCRIPT"]);class Mr{constructor(){this.nodeIdCounter=1,this.nodeIdMap=new WeakMap}getNodeId(e){let t=this.nodeIdMap.get(e);return t||(t=this.nodeIdCounter++,this.nodeIdMap.set(e,t)),t}serializeDocument(){return this.serializeNode(document.documentElement)}serializeNode(e){try{const t=this.getNodeId(e);if(e.nodeType===Node.TEXT_NODE){const a=e.parentElement;return a&&this.shouldMask(a)?{id:t,type:3,text:"[masked]"}:{id:t,type:3,text:e.textContent??""}}if(e.nodeType===Node.COMMENT_NODE)return{id:t,type:8,text:""};if(e.nodeType!==Node.ELEMENT_NODE)return null;const i=e,r=i.tagName;if(Ir.has(r))return{id:t,type:1,tag:r,attrs:{},children:[]};const s=this.sanitizeAttributes(i),o=[];for(let a=0;a<i.childNodes.length;a++){const l=this.serializeNode(i.childNodes[a]);l&&o.push(l)}return{id:t,type:1,tag:r,attrs:s,children:o}}catch{return null}}shouldMask(e){var t;if(e.hasAttribute("data-guideai-mask"))return!0;if(e.tagName==="INPUT"){const i=(t=e.type)==null?void 0:t.toLowerCase();if(Lr.has(i))return!0}return!1}sanitizeAttributes(e){var i;const t={};for(let r=0;r<e.attributes.length;r++){const s=e.attributes[r],o=s.name;o.startsWith("on")||o.startsWith("data-guideai-internal")||(t[o]=s.value)}if(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.tagName==="SELECT"){const r=e;if(((i=r.type)==null?void 0:i.toLowerCase())==="password")t.value="***";else if(this.shouldMask(e))t.value="[masked]";else{const o=r.value||"";t.value=o?`[${o.length} chars]`:""}}return t}reset(){this.nodeIdCounter=1,this.nodeIdMap=new WeakMap}}class Pr{constructor(e,t){this.serializer=e,this.callback=t,this.observer=null}start(){try{this.observer=new MutationObserver(e=>{try{const t=this.processMutations(e);t.length>0&&this.callback(t)}catch{}}),this.observer.observe(document.documentElement,{childList:!0,attributes:!0,characterData:!0,subtree:!0,attributeOldValue:!0})}catch{}}stop(){var e;(e=this.observer)==null||e.disconnect(),this.observer=null}processMutations(e){const t=[];for(const i of e)if(!this.isGuideAINode(i.target))switch(i.type){case"childList":{for(let r=0;r<i.addedNodes.length;r++){const s=i.addedNodes[r];if(this.isGuideAINode(s))continue;const o=this.serializer.serializeNode(s);o&&t.push({type:"add",targetId:o.id,parentId:i.target?this.serializer.getNodeId(i.target):void 0,nextSiblingId:i.nextSibling?this.serializer.getNodeId(i.nextSibling):void 0,data:o})}for(let r=0;r<i.removedNodes.length;r++){const s=i.removedNodes[r];this.isGuideAINode(s)||t.push({type:"remove",targetId:this.serializer.getNodeId(s),parentId:i.target?this.serializer.getNodeId(i.target):void 0})}break}case"attributes":{const r=i.target,s=i.attributeName??"";t.push({type:"attr",targetId:this.serializer.getNodeId(i.target),attr:{name:s,value:r.getAttribute(s)}});break}case"characterData":{t.push({type:"text",targetId:this.serializer.getNodeId(i.target),text:i.target.textContent??""});break}}return t}isGuideAINode(e){if(!e)return!1;const t=e.nodeType===Node.ELEMENT_NODE?e:e.parentElement;return t?t.id==="guideai-shadow-host"||t.closest("#guideai-shadow-host")!==null:!1}}class Rr{constructor(){this.lastX=0,this.lastY=0,this.timer=null,this.hasMoved=!1,this.handler=null,this.cb=null}start(e){this.cb=e,this.handler=t=>{this.lastX=t.clientX,this.lastY=t.clientY,this.hasMoved=!0},document.addEventListener("mousemove",this.handler,{passive:!0}),this.timer=setInterval(()=>{this.hasMoved&&this.cb&&(this.cb({x:this.lastX,y:this.lastY}),this.hasMoved=!1)},50)}stop(){this.handler&&(document.removeEventListener("mousemove",this.handler),this.handler=null),this.timer&&(clearInterval(this.timer),this.timer=null)}}class Hr{constructor(){this.timer=null,this.lastX=0,this.lastY=0,this.changed=!1,this.handler=null,this.cb=null}start(e){this.cb=e,this.handler=()=>{this.lastX=window.scrollX,this.lastY=window.scrollY,this.changed=!0},window.addEventListener("scroll",this.handler,{passive:!0}),this.timer=setInterval(()=>{this.changed&&this.cb&&(this.cb({x:this.lastX,y:this.lastY}),this.changed=!1)},100)}stop(){this.handler&&(window.removeEventListener("scroll",this.handler),this.handler=null),this.timer&&(clearInterval(this.timer),this.timer=null)}}class Nr{constructor(){this.handler=null,this.getNodeId=null}start(e,t){this.getNodeId=t,this.handler=i=>{var r;try{const s=i.target;if(!s||!("value"in s))return;const o=s,a=(r=o.type)==null?void 0:r.toLowerCase();let l;a==="password"?l="***":s.hasAttribute("data-guideai-mask")?l="[masked]":l=`[${(o.value||"").length} chars]`,e({targetId:t(s),value:l,tag:s.tagName})}catch{}},document.addEventListener("input",this.handler,{capture:!0,passive:!0})}stop(){this.handler&&(document.removeEventListener("input",this.handler,{capture:!0}),this.handler=null)}}class $r{constructor(){this.handler=null,this.timer=null,this.cb=null}start(e){this.cb=e,this.handler=()=>{this.timer&&clearTimeout(this.timer),this.timer=setTimeout(()=>{this.cb&&this.cb({width:window.innerWidth,height:window.innerHeight})},200)},window.addEventListener("resize",this.handler,{passive:!0})}stop(){this.handler&&(window.removeEventListener("resize",this.handler),this.handler=null),this.timer&&(clearTimeout(this.timer),this.timer=null)}}class Dr{constructor(e){this.sender=e,this.events=[],this.chunkIndex=0,this.byteSize=0,this.flushTimer=null,this.MAX_BYTES=50*1024,this.FLUSH_INTERVAL=5e3,this.flushTimer=setInterval(()=>this.flush(),this.FLUSH_INTERVAL)}push(e){try{this.events.push(e),this.byteSize+=this.estimateSize(e),this.byteSize>=this.MAX_BYTES&&this.flush()}catch{}}flush(){if(this.events.length!==0)try{const e=this.events.splice(0);this.sender.send(e,this.chunkIndex++),this.byteSize=0}catch{}}destroy(){this.flushTimer&&(clearInterval(this.flushTimer),this.flushTimer=null),this.flush()}estimateSize(e){try{return e.type==="snapshot"?5e3:e.type==="mutation"?500:e.type==="mouse"?30:e.type==="click"?50:e.type==="scroll"?30:e.type==="input"?100:e.type==="resize"?30:100}catch{return 100}}}class Or{constructor(e,t){this.sessionId=e,this.api=t}async send(e,t){try{const i={chunks:[{session_id:this.sessionId,chunk_index:t,data:{events:e},timestamp:new Date().toISOString()}]};this.api.postKeepalive("/api/v1/recordings",i)}catch{}}}class Br{constructor(e,t){this.startTime=0,this.destroyed=!1,this.clickHandler=null,this.sender=new Or(t,e),this.buffer=new Dr(this.sender),this.serializer=new Mr,this.mouseObserver=new Rr,this.scrollObserver=new Hr,this.inputObserver=new Nr,this.resizeObserver=new $r,this.mutationObserver=new Pr(this.serializer,i=>{this.pushEvent({type:"mutation",timestamp:this.elapsed(),data:i})})}start(){try{if(this.destroyed)return;this.startTime=Date.now();const e=this.serializer.serializeDocument();this.pushEvent({type:"snapshot",timestamp:0,data:e}),this.mutationObserver.start(),this.mouseObserver.start(t=>{this.pushEvent({type:"mouse",timestamp:this.elapsed(),data:t})}),this.scrollObserver.start(t=>{this.pushEvent({type:"scroll",timestamp:this.elapsed(),data:t})}),this.inputObserver.start(t=>{this.pushEvent({type:"input",timestamp:this.elapsed(),data:t})},t=>this.serializer.getNodeId(t)),this.resizeObserver.start(t=>{this.pushEvent({type:"resize",timestamp:this.elapsed(),data:t})}),this.clickHandler=t=>{try{const i=t.target;this.pushEvent({type:"click",timestamp:this.elapsed(),data:{x:t.clientX,y:t.clientY,targetId:this.serializer.getNodeId(i),tag:i==null?void 0:i.tagName}})}catch{}},document.addEventListener("click",this.clickHandler,{capture:!0,passive:!0})}catch(e){typeof console<"u"&&console.warn("[GuideAI] Recording start error:",e)}}destroy(){this.destroyed=!0;try{this.mutationObserver.stop(),this.mouseObserver.stop(),this.scrollObserver.stop(),this.inputObserver.stop(),this.resizeObserver.stop(),this.clickHandler&&(document.removeEventListener("click",this.clickHandler,{capture:!0}),this.clickHandler=null),this.buffer.destroy()}catch{}}pushEvent(e){this.destroyed||this.buffer.push(e)}elapsed(){return Date.now()-this.startTime}}function M(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}function zr(n){return n.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function _(n,e,t){return{site_id:n,session_id:"",event_type:e,url:location.href,timestamp:new Date().toISOString(),metadata:t??{}}}function ze(n,e,t,i,r){const s=_(n,e,r);return s.guide_id=t,i!==void 0&&(s.step_index=i,s.total_steps=r==null?void 0:r.total_steps),s}function Fe(n,e,t,i,r){return{site_id:n,session_id:"",event_type:"guide_step_action",url:location.href,guide_id:e,step_index:t,timestamp:new Date().toISOString(),metadata:r?{action:i,detail:r}:{action:i}}}function Ge(n,e,t,i,r,s,o,a){return{site_id:n,session_id:"",event_type:"guide_step",url:location.href,guide_id:e,step_index:t,total_steps:i,timestamp:new Date().toISOString(),metadata:{step_title:r,action_type:s,has_target:o,interactive:a}}}const It="guideai_chip_dismissals",Fr=15e3,Gr=150,qr=48,Mt=300*1e3;class Ur{constructor(e,t,i,r){this.activeChips=new Map,this.dismissTimers=new Map,this.focusedIndex=-1,this.onKeyDown=null,this.config=e,this.eventBuffer=t,this.shadowRoot=i,this.positionProvider=r}showChips(e){const t=this.getDismissals(),i=Date.now(),r=e.filter(a=>{const l=t.find(c=>c.chipId===a.id);return!l||i-l.dismissedAt>Mt});r.sort((a,l)=>a.priority-l.priority);const s=r.slice(0,3);let o=this.activeChips.size;s.forEach((a,l)=>{if(this.activeChips.has(a.id))return;const c=l*Gr;setTimeout(()=>{this.renderChip(a,o+l)},c)})}removeAll(){this.activeChips.forEach(e=>e.remove()),this.activeChips.clear(),this.dismissTimers.forEach(e=>clearTimeout(e)),this.dismissTimers.clear(),this.removeKeyboardListeners()}renderChip(e,t){var a;const i=document.createElement("div");i.className="guideai-chip",i.setAttribute("data-chip-id",e.id),i.setAttribute("role","option"),i.setAttribute("tabindex","-1"),i.setAttribute("aria-label",`${e.emoji} ${e.label}`),i.innerHTML=`
  ...
  <g class="guideai-crawl-leg-right">
    ...
    `;const r=i.querySelector(".guideai-chat-walkthrough-btn"),s=i.querySelector("input");r==null||r.addEventListener("click",()=>{var a,l,c;const o=((a=s==null?void 0:s.value)==null?void 0:a.trim())||t;(c=(l=this.callbacks)==null?void 0:l.onSaveWalkthrough)==null||c.call(l,o),r.textContent="Saved!",r.disabled=!0,s&&(s.disabled=!0)}),this.messagesEl.appendChild(i),requestAnimationFrame(()=>this.scrollToBottom())}showSupportButton(){if(!this.el)return;const e=this.el.querySelector(".guideai-chat-support-btn-wrap");e&&(e.style.display="")}isOpen(){return this.el!==null}showPauseButton(){this.pauseBtn&&(this.pauseBtn.style.display="",this.guidePaused=!1,this.updatePauseButton())}hidePauseButton(){this.pauseBtn&&(this.pauseBtn.style.display="none")}updatePauseButton(){this.pauseBtn&&(this.guidePaused?(this.pauseBtn.innerHTML=`${ln} Resume`,this.pauseBtn.setAttribute("aria-label","Resume guide")):(this.pauseBtn.innerHTML=`${Nt} Pause`,this.pauseBtn.setAttribute("aria-label","Pause guide")))}handleSend(){if(!this.inputEl||!this.callbacks)return;const e=this.inputEl.value.trim();e&&(this.inputEl.value="",this.callbacks.onSend(e))}scrollToBottom(){this.messagesEl&&this.messagesEl.scrollTo({top:this.messagesEl.scrollHeight,behavior:"smooth"})}}const dn=["a[href]","button","input","select","textarea",'[role="button"]','[role="link"]','[role="tab"]','[role="menuitem"]',"[tabindex]"].join(","),$t=50,Dt=30,Ot=80;function Bt(){var i;const n=[],e=[],t=document.querySelectorAll(dn);for(let r=0;r<t.length&&!(n.length>=$t&&e.length>=Dt);r++){const s=t[r];if(s.closest(".guideai-bubble, .guideai-chat, .guideai-chip")||s.closest("[data-guideai-shadow]"))continue;const o=s.tagName.toLowerCase(),a=ee(s.getAttribute("aria-label")||s.placeholder||((i=s.textContent)==null?void 0:i.trim())||"");if(!a&&o!=="input"&&o!=="select"&&o!=="textarea")continue;const l=un(s);if(l&&n.length<$t)n.push({tag:o,text:a,selector:Ft(s),role:s.getAttribute("role")||void 0,type:s.type||void 0,placeholder:s.placeholder||void 0});else if(!l&&e.length<Dt){const c=hn(s);c&&e.push({tag:o,text:a,selector:Ft(s),role:s.getAttribute("role")||void 0,type:s.type||void 0,placeholder:s.placeholder||void 0,hidden:!0,container:c.name,containerState:c.state})}}return{url:location.href,title:document.title,elements:[...n,...e]}}function un(n){if(n.offsetParent===null&&n.tagName!=="INPUT"&&n.tagName!=="BODY"||n.getAttribute("aria-hidden")==="true")return!1;const e=getComputedStyle(n);if(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")return!1;let t=n.parentElement;for(let i=0;t&&i<10;i++){const r=getComputedStyle(t);if(r.display==="none"||r.visibility==="hidden")return!1;if(r.overflow==="hidden"&&t.scrollHeight>0){const s=t.getBoundingClientRect();if(s.height===0||s.width===0)return!1}t=t.parentElement}return!0}function hn(n){var t;let e=n.parentElement;for(let i=0;e&&i<15;i++){const r=e.tagName.toLowerCase(),s=e.getAttribute("role"),o=e.getAttribute("aria-expanded"),a=e.getAttribute("aria-hidden"),l=(typeof e.className=="string"?e.className:"").toLowerCase();if(r==="details"&&!e.hasAttribute("open")){const c=e.querySelector("summary");return{name:((t=c==null?void 0:c.textContent)==null?void 0:t.trim())||"accordion",state:"collapsed"}}if(o==="false"||a==="true"){const c=ae(e),d=zt(e,l,s);return{name:c||d,state:"collapsed"}}if(s==="menu"||s==="menubar"||s==="navigation"||r==="nav"){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden"||c.maxHeight==="0px"||c.height==="0px"||c.opacity==="0")return{name:ae(e)||zt(e,l,s),state:"collapsed"};if(c.transform&&c.transform!=="none"){const d=e.getBoundingClientRect();if(d.right<0||d.left>window.innerWidth)return{name:ae(e)||"sidebar",state:"closed"}}}if(l.includes("sidebar")||l.includes("drawer")||l.includes("offcanvas")){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden"||c.transform&&c.transform!=="none"){const d=e.getBoundingClientRect();if(d.right<0||d.left>window.innerWidth||c.display==="none")return{name:ae(e)||"sidebar",state:"closed"}}}if(l.includes("dropdown")||l.includes("popover")||l.includes("popup")){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden"||c.opacity==="0")return{name:ae(e)||"dropdown menu",state:"closed"}}if(l.includes("modal")||l.includes("dialog")||s==="dialog"){const c=getComputedStyle(e);if(c.display==="none"||c.visibility==="hidden")return{name:ae(e)||"dialog",state:"closed"}}if(s==="tabpanel"&&(getComputedStyle(e).display==="none"||e.getAttribute("hidden")!==null)){const d=e.getAttribute("aria-label")||e.getAttribute("aria-labelledby")||"tab";return{name:`"${ee(d)}" tab`,state:"inactive"}}if((r==="nav"||r==="ul")&&l.includes("nav")&&getComputedStyle(e).display==="none")return{name:"navigation menu",state:"collapsed"};e=e.parentElement}return null}function ae(n){var s;const e=n.getAttribute("aria-label");if(e)return ee(e);const t=n.getAttribute("aria-labelledby");if(t){const o=document.getElementById(t);if(o!=null&&o.textContent)return ee(o.textContent.trim())}if(n.id){const o=document.querySelector(`[aria-controls="${n.id}"]`);if(o){const a=o.getAttribute("aria-label")||((s=o.textContent)==null?void 0:s.trim());if(a)return ee(a)}}const i=n.querySelector(":scope > summary");if(i!=null&&i.textContent)return ee(i.textContent.trim());const r=n.querySelector("h1, h2, h3, h4, h5, h6");return r!=null&&r.textContent?ee(r.textContent.trim()):null}function zt(n,e,t){return t==="menu"||t==="menubar"?"menu":t==="navigation"||n.tagName==="NAV"?"navigation menu":e.includes("hamburger")||e.includes("mobile-nav")||e.includes("mobile-menu")?"hamburger menu":e.includes("sidebar")||e.includes("sidenav")?"sidebar":e.includes("drawer")?"drawer":e.includes("dropdown")?"dropdown":e.includes("accordion")||e.includes("collapse")||e.includes("collapsible")?"accordion":e.includes("offcanvas")?"off-canvas menu":e.includes("popover")?"popover":e.includes("tooltip")?"tooltip":"hidden panel"}function Ft(n){const e=n.getAttribute("data-guideai");if(e)return`[data-guideai="${e}"]`;const t=n.getAttribute("data-testid");if(t)return`[data-testid="${t}"]`;if(n.id)return`#${n.id}`;const i=n.getAttribute("name");if(i)return`${n.tagName.toLowerCase()}[name="${i}"]`;const r=n.tagName.toLowerCase();if(r==="a"){const a=n.getAttribute("href");if(a)return`a[href="${a}"]`}if(r==="button"){const a=n.type,l=n.className&&typeof n.className=="string"?n.className.split(/\s+/).filter(c=>c&&!c.startsWith("guideai"))[0]:"";if(l)return`button.${l}`;if(a&&a!=="submit")return`button[type="${a}"]`}if(r==="input"){const a=n;if(a.type)return`input[type="${a.type}"]`}const s=[];let o=n;for(let a=0;o&&a<3;a++){let l=o.tagName.toLowerCase();if(o.className&&typeof o.className=="string"){const c=o.className.split(/\s+/).filter(d=>d&&!d.startsWith("guideai"))[0];c&&(l+=`.${c}`)}s.unshift(l),o=o.parentElement}return s.join(" > ")}function ee(n){return n.length<=Ot?n:n.slice(0,Ot)}const gn=["backgroundColor","color","fontSize","fontWeight","fontFamily","paddingTop","paddingRight","paddingBottom","paddingLeft","borderRadius","borderTopWidth","borderTopColor","display","opacity","boxShadow","textAlign"],E=32,pn=new Set(["input","textarea","select","option"]),fn={block:0,inline:.2,"inline-block":.4,flex:.6,grid:.8,none:1};function mn(n){const e=window.getComputedStyle(n);let t="";for(const i of gn)t+=String(e[i]??"")+"|";return kn(t)}function bn(n,e){return n===e?1:0}function yn(n){const e=window.getComputedStyle(n),t=n.getBoundingClientRect(),i=window.innerWidth||1,r=window.innerHeight||1;return[$(e.fontSize)/72,(parseFloat(e.fontWeight)||400)/900,...Gt(e.backgroundColor),...Gt(e.color),$(e.paddingTop)/50,$(e.paddingRight)/50,$(e.paddingBottom)/50,$(e.paddingLeft)/50,$(e.borderRadius)/30,$(e.borderTopWidth)/10,Math.min(t.width/i,1),Math.min(t.height/r,1),parseFloat(e.opacity)||1,fn[e.display]??.5,e.boxShadow&&e.boxShadow!=="none"?1:0,$(e.borderTopWidth)>0?1:0,Math.min(n.childElementCount/20,1),Math.min(t.x/i,1),Math.min(t.y/r,1),t.height>0?Math.min(t.width/t.height/10,1):0]}function vn(n,e){if(n.length!==e.length||n.length===0)return 0;let t=0,i=0,r=0;for(let o=0;o<n.length;o++)t+=n[o]*e[o],i+=n[o]*n[o],r+=e[o]*e[o];const s=Math.sqrt(i)*Math.sqrt(r);return s===0?0:t/s}function xn(n){var r;const e=n.tagName.toLowerCase();if(pn.has(e)||n.offsetParent===null)return;const t=window.getComputedStyle(n),i=n.getBoundingClientRect();if(!(i.width===0||i.height===0))try{const s=document.createElement("canvas");s.width=E,s.height=E;const o=s.getContext("2d");if(!o)return;o.clearRect(0,0,E,E),o.fillStyle=t.backgroundColor||"transparent";const a=$(t.borderRadius);a>0?_n(o,0,0,E,E,Math.min(a,E/2)*(E/Math.max(i.width,1))):o.fillRect(0,0,E,E);const l=$(t.borderTopWidth);l>0&&(o.strokeStyle=t.borderTopColor||"#000",o.lineWidth=Math.max(1,l*(E/Math.max(i.width,1))),o.strokeRect(1,1,E-2,E-2));const c=((r=n.textContent)==null?void 0:r.trim().length)??0;if(c>0){o.fillStyle=t.color||"#000";const u=Math.min(c*2,E-8),h=Math.min($(t.fontSize)*(E/Math.max(i.height,1)),E/3),f=(E-u)/2,m=(E-h)/2;o.fillRect(f,m,u,h)}t.boxShadow&&t.boxShadow!=="none"&&(o.fillStyle="rgba(0,0,0,0.1)",o.fillRect(2,E-4,E-4,2));const d=o.getImageData(0,0,E,E);return En(d.data)}catch{return}}function wn(n,e){if(!n||!e||n.length!==e.length)return 0;let t=0;for(let r=0;r<n.length;r++){const s=parseInt(n[r],16),o=parseInt(e[r],16),a=s^o;t+=4-Sn(a)}const i=n.length*4;return i===0?0:t/i}function kn(n){let e=5381;for(let t=0;t<n.length;t++)e=(e<<5)+e+n.charCodeAt(t)|0;return(e>>>0).toString(16).padStart(8,"0")}function $(n){return parseFloat(n)||0}function Gt(n){const e=n.match(/(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/);return e?[parseInt(e[1],10)/255,parseInt(e[2],10)/255,parseInt(e[3],10)/255]:[0,0,0]}function _n(n,e,t,i,r,s){n.beginPath(),n.moveTo(e+s,t),n.arcTo(e+i,t,e+i,t+r,s),n.arcTo(e+i,t+r,e,t+r,s),n.arcTo(e,t+r,e,t,s),n.arcTo(e,t,e+i,t,s),n.closePath(),n.fill()}function En(n){const e=n.length/4,t=new Uint8Array(e);let i=0;for(let o=0;o<e;o++){const a=n[o*4],l=n[o*4+1],c=n[o*4+2];t[o]=a*.299+l*.587+c*.114|0,i+=t[o]}const r=i/e;let s="";for(let o=0;o<e;o+=4){let a=0;for(let l=0;l<4&&o+l<e;l++)t[o+l]>=r&&(a|=1<<3-l);s+=a.toString(16)}return s}function Sn(n){return n=n&15,n=n-(n>>1&5),n=(n&3)+(n>>2&3),n}function te(n){const e=Cn(n),t=Tn(n),i=An(n),r=Ln(n),s=In(n),o=Rn(n),a=e.score+t.score+i.score+r.score+s.score+o.score;return{tier1_stable:e,tier2_text:t,tier3_structural:i,tier4_context:r,tier5_position:s,tier6_visual:o,total_score:a}}function Cn(n){const e=n.getAttribute("data-guideai")??void 0,t=n.getAttribute("data-testid")??void 0,i=n.getAttribute("aria-label")??void 0,r=n.getAttribute("name")??void 0,s=n.id||void 0;let o=0;return e?o+=40:t?o+=38:(s||r||i)&&(o+=35),{data_guideai:e,data_testid:t,aria_label:i,name:r,id:s,score:o}}function Tn(n){const e=n,t=ie(qt(n),120),i=n.placeholder||n.getAttribute("placeholder")||void 0;let r;if(n.id){const a=document.querySelector(`label[for="${n.id}"]`);a&&(r=ie(a.textContent??"",80))}if(!r){const a=n.closest("label");a&&(r=ie(a.textContent??"",80))}const s=[];t&&s.push(t.toLowerCase()),i&&s.push(i.toLowerCase()),r&&s.push(r.toLowerCase()),e.title&&s.push(e.title.toLowerCase());let o=0;return t?o+=30:i?o+=28:r&&(o+=25),{text_content:t,placeholder:i,label:r,variants:s,score:o}}function An(n){const e=n.tagName.toLowerCase(),t=n.getAttribute("role")??void 0,i=Mn(n),r=Pn(n);let s=0;return e&&(s+=10),t&&(s+=5),i&&(s+=8),s+=Math.min(r,2),{tag:e,role:t,css_path:i,dom_depth:r,score:s}}function Ln(n){const e=n.parentElement,t=e?ie(qt(e),80):void 0,i=n.closest("form"),r=i&&(i.getAttribute("name")||i.getAttribute("aria-label")||i.id)||void 0,s=Hn(n);let o=0;return s&&(o+=6),r&&(o+=5),t&&(o+=4),{parent_text:t,form_context:r,nearest_heading:s,score:o}}function In(n){let e,t;try{const r=n.getBoundingClientRect();e={x:Math.round(r.x),y:Math.round(r.y),width:Math.round(r.width),height:Math.round(r.height)};const s=window.innerWidth,o=window.innerHeight,a=r.x+r.width/2,l=r.y+r.height/2,c=a<s/3?"left":a<2*s/3?"center":"right";t=`${l<o/3?"top":l<2*o/3?"middle":"bottom"}-${c}`}catch{}return{bounding_rect:e,relative_position:t,score:e?5:0}}function qt(n){let e="";for(let t=0;t<n.childNodes.length;t++){const i=n.childNodes[t];i.nodeType===Node.TEXT_NODE&&(e+=i.textContent??"")}return e.trim()}function ie(n,e){return n&&(n.length>e?n.slice(0,e):n)}function Mn(n){const e=[];let t=n,i=0;for(;t&&t!==document.documentElement&&i<5;){let r=t.tagName.toLowerCase();if(t.id){r+=`#${t.id}`,e.unshift(r);break}const s=t.parentElement;if(s){const o=s.children;let a=0,l=0;for(let c=0;c<o.length;c++)o[c].tagName===t.tagName&&(l++,o[c]===t&&(a=l));l>1&&(r+=`:nth-of-type(${a})`)}e.unshift(r),t=s,i++}return e.join(" > ")}function Pn(n){let e=0,t=n;for(;t&&t!==document.documentElement;)e++,t=t.parentElement;return e}function Rn(n){const e=mn(n),t=yn(n),i=xn(n);let r=0;return e&&(r+=8),t.length>0&&(r+=7),i&&(r+=5),{style_hash:e,style_vector:t,canvas_hash:i,score:r}}function Hn(n){let e=n;for(;e;){let t=e.previousElementSibling;for(;t;){if(/^h[1-6]$/i.test(t.tagName))return ie(t.textContent??"",80);const i=t.querySelector("h1,h2,h3,h4,h5,h6");if(i)return ie(i.textContent??"",80);t=t.previousElementSibling}if(e=e.parentElement,e&&/^h[1-6]$/i.test(e.tagName))return ie(e.textContent??"",80)}}function Nn(n){var e,t,i;return(((e=n.toggle)==null?void 0:e.getAttribute("aria-label"))||((i=(t=n.toggle)==null?void 0:t.textContent)==null?void 0:i.trim())||n.container.getAttribute("aria-label")||n.label||"Open menu").trim()}function $n(n){const e=n.replace(/\s+/g," ").trim(),t=/^(open|show|expand)\b/i.test(e);return{title:t?e:`Open ${e}`,body:t?`Click ${e.toLowerCase()} to reveal the hidden navigation or content.`:`Click ${e.toLowerCase()} to reveal the hidden navigation or content.`}}class Dn{constructor(e,t,i,r){this.renderer=null,this.guidePlayerFactory=null,this.destroyed=!1,this._helpSupportEnabled=!1,this.onBubbleClick=null,this.analyzer=null,this.lastWalkthroughSteps=null,this.lastWalkthroughTitle="",this.pauseGuideHandler=null,this.resumeGuideHandler=null,this.api=e,this.config=t,this.eventBuffer=i,this.shadowRoot=r}setGuidePlayerFactory(e){this.guidePlayerFactory=e}setAnalyzer(e){this.analyzer=e}setHelpSupportEnabled(e){this._helpSupportEnabled=e}setPauseResumeHandlers(e,t){this.pauseGuideHandler=e,this.resumeGuideHandler=t}async init(){this.onBubbleClick=()=>{this.destroyed||this.toggle()},document.addEventListener("guideai:bubble-click",this.onBubbleClick)}toggle(){var e;(e=this.renderer)!=null&&e.isOpen()?this.close():this.open()}open(){var e,t;(e=this.renderer)!=null&&e.isOpen()||(this.renderer=new cn(this.config,this.eventBuffer,this.shadowRoot),this.renderer.render({onClose:()=>this.close(),onSend:i=>this.handleSend(i),onStartWalkthrough:(i,r)=>this.handleStartWalkthrough(i,r),onSaveWalkthrough:i=>this.handleSaveWalkthrough(i),onPauseGuide:()=>{var i;return(i=this.pauseGuideHandler)==null?void 0:i.call(this)},onResumeGuide:()=>{var i;return(i=this.resumeGuideHandler)==null?void 0:i.call(this)}}),this._helpSupportEnabled&&this.renderer.showSupportButton(),(t=this.eventBuffer)==null||t.push(_(this.config.siteId,"chat_opened")))}close(){var e;(e=this.renderer)==null||e.remove(),this.renderer=null,document.dispatchEvent(new CustomEvent("guideai:resource-center-close"))}async handleSend(e){var r;if(!this.renderer)return;const t={role:"user",text:e};this.renderer.addMessage(t);const i=_(this.config.siteId,"chat_message_sent");i.element_text=e,(r=this.eventBuffer)==null||r.push(i),this.renderer.setLoading(!0);try{const s=Bt(),o=await this.api.post("/api/v1/chat/ask",{question:e,page_url:location.href,page_snapshot:s});if(!this.renderer)return;this.renderer.setLoading(!1);const a={role:"assistant",text:o.answer};o.guide_steps&&o.guide_steps.length>0&&(a.guideSteps=o.guide_steps.map(l=>{const c=l.action??"none";return{title:l.title??"",body:l.body??"",target_selector:l.target_selector,action:c,completion_hint:l.completion_hint}}),a.guideTitle=o.guide_title??"Walkthrough"),this.renderer.addMessage(a)}catch(s){if(!this.renderer)return;this.renderer.setLoading(!1);const o=s instanceof Error&&s.message.includes("404")?"Chat service is not available. Make sure the backend is running.":"Sorry, something went wrong. Please try again.";this.renderer.addMessage({role:"assistant",text:o}),typeof console<"u"&&console.warn("[GuideAI] Chat error:",s)}}handleStartWalkthrough(e,t){var o;if(!this.guidePlayerFactory)return;this.lastWalkthroughSteps=e,this.lastWalkthroughTitle=t,this.close();const i=this.generateUUID(),r=this.buildGuideSteps(e,i),s={id:i,site_id:this.config.siteId,title:t,status:"published",trigger_type:"manual",trigger_config:{},steps:r,tags:["chat-generated"],version:1,created_at:new Date().toISOString(),updated_at:new Date().toISOString()};(o=this.eventBuffer)==null||o.push(_(this.config.siteId,"chat_walkthrough_started",{guide_title:t,step_count:e.length})),this.guidePlayerFactory(s,()=>this.onWalkthroughComplete())}onWalkthroughComplete(){this.lastWalkthroughSteps&&(this.open(),setTimeout(()=>{var e;(e=this.renderer)==null||e.addSaveWalkthroughPrompt(this.lastWalkthroughSteps.length,this.lastWalkthroughTitle)},300))}async handleSaveWalkthrough(e){if(!this.lastWalkthroughSteps)return;const t=this.lastWalkthroughSteps,i={title:e||this.lastWalkthroughTitle||"Chat Walkthrough",description:`Guide created from chat walkthrough with ${t.length} steps`,steps:t.map((r,s)=>{const o=this.buildGuideStep(r,s);return{ordinal:s,step_type:o.step_type,target_selector:o.target_selector,target_fingerprint:o.target_fingerprint,content:o.content,action_config:o.action_config,page_url_pattern:o.page_url_pattern}})};try{await this.api.post("/api/v1/guides/record",i),this.lastWalkthroughSteps=null,this.lastWalkthroughTitle=""}catch(r){typeof console<"u"&&console.warn("[GuideAI] Failed to save walkthrough as guide:",r)}}buildGuideSteps(e,t){const i=[];let r=0;console.log("[GuideAI] Building guide steps, analyzer:",!!this.analyzer);const s=this.inferPagePatterns(e);for(let o=0;o<e.length;o++){const a=e[o],l=["click","fill","select","scroll","navigate","none"],c=a.action&&l.includes(a.action)?a.action:a.target_selector?"click":"none",d=this.extractTagFromSelector(a.target_selector),u=a.title||a.body||"";console.log(`[GuideAI] Step ${o}: "${u}", selector: "${a.target_selector}", page_url: "${s[o]}"`);const h=`chat_reveal_group_${o}`;let f=!1,m={tier1_stable:{score:0},tier2_text:{text_content:u,variants:u?[u.toLowerCase()]:[],score:u?25:0},tier3_structural:{tag:d,dom_depth:0,score:d?8:0},tier4_context:{score:0},tier5_position:{score:0},total_score:(u?25:0)+(d?8:0)};if(this.analyzer){const p={description:u,tag:d||void 0,text:u||void 0,selector:a.target_selector,fingerprint:m.total_score>0?m:void 0,actionType:c};try{const g=this.analyzer.resolveDetectOnly(p);if(console.log(`[GuideAI] Analyzer detect for step ${o}:`,{hasElement:!!g.element,isVisible:g.isVisible,requiresReveal:g.requiresReveal,revealPathLength:g.revealPath.length,revealReason:g.revealReason,revealConfidence:g.revealConfidence,score:g.score}),c!=="none"&&g.element&&g.requiresReveal&&g.revealPath.length>0){f=!0,console.log(`[GuideAI] Adding ${g.revealPath.length} reveal step(s) for hidden element`);const b=`chat_step_${r+g.revealPath.length}`;for(const y of g.revealPath){const S=y.toggle||y.container,v=te(S),k=Nn(y),C=$n(k);i.push({id:`chat_step_${r}`,guide_id:t,ordinal:r++,step_type:"tooltip",target_selector:"",target_fingerprint:v,page_url_pattern:s[o],content:{title:C.title,body:C.body},action_config:{action_type:"click",sensitive:!1,requires_confirmation:!1,allow_skip:!1},metadata:{requires_reveal:!0,reveal_for:b,reveal_group:h,reveal_confidence:g.revealConfidence??null,reveal_reason:g.revealReason??null}})}}g.element&&(m=te(g.element),console.log("[GuideAI] Enriched fingerprint score:",m.total_score))}catch(g){console.warn("[GuideAI] Analyzer detection failed for step",o,g)}}i.push({id:`chat_step_${r}`,guide_id:t,ordinal:r++,step_type:"tooltip",target_selector:a.target_selector,target_fingerprint:m,page_url_pattern:s[o],content:{title:a.title,body:a.body},action_config:{action_type:c,sensitive:!1,requires_confirmation:!1,completion_hint:a.completion_hint},metadata:{reveal_required:f,reveal_group:h}})}return console.log(`[GuideAI] Built ${i.length} total steps (${e.length} original + reveal steps)`),i}inferPagePatterns(e){const t=[];let i=location.pathname;for(let r=0;r<e.length;r++){const s=e[r];t[r]=i;const o=this.inferNavigationTarget(s);o&&(console.log(`[GuideAI] Step ${r} navigates to "${o}" — subsequent steps expect that page`),i=o)}return t}inferNavigationTarget(e){const t=e.action||(e.target_selector?"click":"none");if(!(t==="click"||t==="navigate"))return null;if(e.target_selector)try{const a=document.querySelector(e.target_selector);if(a){const l=a.tagName==="A"?a:a.closest("a");if(l!=null&&l.href){const c=l.getAttribute("href");if(c&&c!=="#"&&!c.startsWith("javascript:"))try{if(c.startsWith("/"))return c.split("?")[0].split("#")[0];if(c.startsWith("http"))return new URL(c).pathname}catch{}}}}catch{}if(e.target_selector){const a=e.target_selector.match(/a\[href=['"]?([^'"\]]+)['"]?\]/);if(a!=null&&a[1]){const l=a[1];if(l.startsWith("/"))return l.split("?")[0].split("#")[0]}}const r=((e.title||"")+" "+(e.body||"")).toLowerCase(),s=r.match(/(?:navigate|go)\s+to\s+(\/[a-z0-9\-/]+)/);if(s!=null&&s[1])return s[1];const o=[/(?:click|go to|navigate to|visit)\s+(?:the\s+)?["']?([a-z][a-z\s]*?)["']?\s+(?:link|page|tab|button|menu item)/,/(?:click|go to|navigate to|visit)\s+["']([^"']+)["']/];for(const a of o){const l=r.match(a);if(l!=null&&l[1]){const c=l[1].trim(),d=this.findLinkHrefByText(c);if(d)return d}}return null}findLinkHrefByText(e){const t=e.toLowerCase().trim();if(!t)return null;try{const i=document.querySelectorAll("a[href]");for(let r=0;r<i.length;r++){const s=i[r],o=(s.textContent||"").toLowerCase().trim();if(o.includes(t)||t.includes(o)){const a=s.getAttribute("href");if(a&&a!=="#"&&!a.startsWith("javascript:")){if(a.startsWith("/"))return a.split("?")[0].split("#")[0];try{if(a.startsWith("http"))return new URL(a).pathname}catch{}}}}}catch{}return null}buildGuideStep(e,t){const i=["click","fill","select","scroll","navigate","none"],r=e.action&&i.includes(e.action)?e.action:e.target_selector?"click":"none",s=this.extractTagFromSelector(e.target_selector),o=e.title||e.body||"";let a={tier1_stable:{score:0},tier2_text:{text_content:o,variants:o?[o.toLowerCase()]:[],score:o?25:0},tier3_structural:{tag:s,dom_depth:0,score:s?8:0},tier4_context:{score:0},tier5_position:{score:0},total_score:(o?25:0)+(s?8:0)};if(this.analyzer){const l={description:o,tag:s||void 0,text:o||void 0,selector:e.target_selector,fingerprint:a.total_score>0?a:void 0,actionType:r},c=this.analyzer.resolveSync(l);c.element&&(a=te(c.element))}return{id:`chat_step_${t}`,guide_id:"",ordinal:t,step_type:"tooltip",target_selector:e.target_selector,target_fingerprint:a,content:{title:e.title,body:e.body},action_config:{action_type:r,sensitive:!1,requires_confirmation:!1,completion_hint:e.completion_hint}}}extractTagFromSelector(e){if(!e)return"";const t=e.match(/^([a-z][a-z0-9]*)/i);return t?t[1].toLowerCase():""}generateUUID(){return typeof crypto<"u"&&crypto.randomUUID?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})}destroy(){var e;this.destroyed=!0,this.onBubbleClick&&(document.removeEventListener("guideai:bubble-click",this.onBubbleClick),this.onBubbleClick=null),(e=this.renderer)==null||e.remove(),this.renderer=null}}/*! noble-ciphers - MIT License (c) 2023 Paul Miller (paulmillr.com) */function On(n){return n instanceof Uint8Array||ArrayBuffer.isView(n)&&n.constructor.name==="Uint8Array"}function I(n,e,t=""){const i=On(n),r=n==null?void 0:n.length,s=e!==void 0;if(!i||s&&r!==e){const o=t&&`"${t}" `,a=s?` of length ${e}`:"",l=i?`length=${r}`:`type=${typeof n}`;throw new Error(o+"expected Uint8Array"+a+", got "+l)}return n}function ke(n,e=!0){if(n.destroyed)throw new Error("Hash instance has been destroyed");if(e&&n.finished)throw new Error("Hash#digest() has already been called")}function Ut(n,e){I(n,void 0,"output");const t=e.outputLen;if(n.length<t)throw new Error("digestInto() expects output buffer of length at least "+t)}function Bn(n){return new Uint8Array(n.buffer,n.byteOffset,n.byteLength)}function q(n){return new Uint32Array(n.buffer,n.byteOffset,Math.floor(n.byteLength/4))}function U(...n){for(let e=0;e<n.length;e++)n[e].fill(0)}function _e(n){return new DataView(n.buffer,n.byteOffset,n.byteLength)}const zn=new Uint8Array(new Uint32Array([287454020]).buffer)[0]===68;function Fn(n,e){if(n.length!==e.length)return!1;let t=0;for(let i=0;i<n.length;i++)t|=n[i]^e[i];return t===0}const Gn=(n,e)=>{function t(i,...r){if(I(i,void 0,"key"),!zn)throw new Error("Non little-endian hardware is not yet supported");if(n.nonceLength!==void 0){const d=r[0];I(d,n.varSizeNonce?void 0:n.nonceLength,"nonce")}const s=n.tagLength;s&&r[1]!==void 0&&I(r[1],void 0,"AAD");const o=e(i,...r),a=(d,u)=>{if(u!==void 0){if(d!==2)throw new Error("cipher output not supported");I(u,void 0,"output")}};let l=!1;return{encrypt(d,u){if(l)throw new Error("cannot encrypt() twice with same key + nonce");return l=!0,I(d),a(o.encrypt.length,u),o.encrypt(d,u)},decrypt(d,u){if(I(d),s&&d.length<s)throw new Error('"ciphertext" expected length bigger than tagLength='+s);return a(o.decrypt.length,u),o.decrypt(d,u)}}}return Object.assign(t,n),t};function qn(n,e,t=!0){if(e===void 0)return new Uint8Array(n);if(e.length!==n)throw new Error('"output" expected Uint8Array of length '+n+", got: "+e.length);if(t&&!Ee(e))throw new Error("invalid output, must be aligned");return e}function Un(n,e,t){const i=new Uint8Array(16),r=_e(i);return r.setBigUint64(0,BigInt(e),t),r.setBigUint64(8,BigInt(n),t),i}function Ee(n){return n.byteOffset%4===0}function re(n){return Uint8Array.from(n)}function Vn(n=32){const e=typeof globalThis=="object"?globalThis.crypto:null;if(typeof(e==null?void 0:e.getRandomValues)!="function")throw new Error("crypto.getRandomValues must be defined");return e.getRandomValues(new Uint8Array(n))}const V=16,Ve=new Uint8Array(16),O=q(Ve),Wn=225,jn=(n,e,t,i)=>{const r=i&1;return{s3:t<<31|i>>>1,s2:e<<31|t>>>1,s1:n<<31|e>>>1,s0:n>>>1^Wn<<24&-(r&1)}},R=n=>(n>>>0&255)<<24|(n>>>8&255)<<16|(n>>>16&255)<<8|n>>>24&255|0;function Kn(n){n.reverse();const e=n[15]&1;let t=0;for(let i=0;i<n.length;i++){const r=n[i];n[i]=r>>>1|t,t=(r&1)<<7}return n[0]^=-e&225,n}const Yn=n=>n>64*1024?8:n>1024?4:2;class Vt{constructor(e,t){x(this,"blockLen",V);x(this,"outputLen",V);x(this,"s0",0);x(this,"s1",0);x(this,"s2",0);x(this,"s3",0);x(this,"finished",!1);x(this,"t");x(this,"W");x(this,"windowSize");I(e,16,"key"),e=re(e);const i=_e(e);let r=i.getUint32(0,!1),s=i.getUint32(4,!1),o=i.getUint32(8,!1),a=i.getUint32(12,!1);const l=[];for(let m=0;m<128;m++)l.push({s0:R(r),s1:R(s),s2:R(o),s3:R(a)}),{s0:r,s1:s,s2:o,s3:a}=jn(r,s,o,a);const c=Yn(t||1024);if(![1,2,4,8].includes(c))throw new Error("ghash: invalid window size, expected 2, 4 or 8");this.W=c;const u=128/c,h=this.windowSize=2**c,f=[];for(let m=0;m<u;m++)for(let p=0;p<h;p++){let g=0,b=0,y=0,S=0;for(let v=0;v<c;v++){if(!(p>>>c-v-1&1))continue;const{s0:C,s1:N,s2:W,s3:He}=l[c*m+v];g^=C,b^=N,y^=W,S^=He}f.push({s0:g,s1:b,s2:y,s3:S})}this.t=f}_updateBlock(e,t,i,r){e^=this.s0,t^=this.s1,i^=this.s2,r^=this.s3;const{W:s,t:o,windowSize:a}=this;let l=0,c=0,d=0,u=0;const h=(1<<s)-1;let f=0;for(const m of[e,t,i,r])for(let p=0;p<4;p++){const g=m>>>8*p&255;for(let b=8/s-1;b>=0;b--){const y=g>>>s*b&h,{s0:S,s1:v,s2:k,s3:C}=o[f*a+y];l^=S,c^=v,d^=k,u^=C,f+=1}}this.s0=l,this.s1=c,this.s2=d,this.s3=u}update(e){ke(this),I(e),e=re(e);const t=q(e),i=Math.floor(e.length/V),r=e.length%V;for(let s=0;s<i;s++)this._updateBlock(t[s*4+0],t[s*4+1],t[s*4+2],t[s*4+3]);return r&&(Ve.set(e.subarray(i*V)),this._updateBlock(O[0],O[1],O[2],O[3]),U(O)),this}destroy(){const{t:e}=this;for(const t of e)t.s0=0,t.s1=0,t.s2=0,t.s3=0}digestInto(e){ke(this),Ut(e,this),this.finished=!0;const{s0:t,s1:i,s2:r,s3:s}=this,o=q(e);return o[0]=t,o[1]=i,o[2]=r,o[3]=s,e}digest(){const e=new Uint8Array(V);return this.digestInto(e),this.destroy(),e}}class Xn extends Vt{constructor(e,t){I(e);const i=Kn(re(e));super(i,t),U(i)}update(e){ke(this),I(e),e=re(e);const t=q(e),i=e.length%V,r=Math.floor(e.length/V);for(let s=0;s<r;s++)this._updateBlock(R(t[s*4+3]),R(t[s*4+2]),R(t[s*4+1]),R(t[s*4+0]));return i&&(Ve.set(e.subarray(r*V)),this._updateBlock(R(O[3]),R(O[2]),R(O[1]),R(O[0])),U(O)),this}digestInto(e){ke(this),Ut(e,this),this.finished=!0;const{s0:t,s1:i,s2:r,s3:s}=this,o=q(e);return o[0]=t,o[1]=i,o[2]=r,o[3]=s,e.reverse()}}function Wt(n){const e=(i,r)=>n(r,i.length).update(i).digest(),t=n(new Uint8Array(16),0);return e.outputLen=t.outputLen,e.blockLen=t.blockLen,e.create=(i,r)=>n(i,r),e}const jt=Wt((n,e)=>new Vt(n,e));Wt((n,e)=>new Xn(n,e));const We=16,Jn=4,Se=new Uint8Array(We),Qn=283;function Zn(n){if(![16,24,32].includes(n.length))throw new Error('"aes key" expected Uint8Array of length 16/24/32, got length='+n.length)}function je(n){return n<<1^Qn&-(n>>7)}function Kt(n,e){let t=0;for(;e>0;e>>=1)t^=n&-(e&1),n=je(n);return t}const es=(()=>{const n=new Uint8Array(256);for(let t=0,i=1;t<256;t++,i^=je(i))n[t]=i;const e=new Uint8Array(256);e[0]=99;for(let t=0;t<255;t++){let i=n[255-t];i|=i<<8,e[n[t]]=(i^i>>4^i>>5^i>>6^i>>7^99)&255}return U(n),e})(),ts=n=>n<<24|n>>>8,Ke=n=>n<<8|n>>>24;function is(n,e){if(n.length!==256)throw new Error("Wrong sbox length");const t=new Uint32Array(256).map((c,d)=>e(n[d])),i=t.map(Ke),r=i.map(Ke),s=r.map(Ke),o=new Uint32Array(256*256),a=new Uint32Array(256*256),l=new Uint16Array(256*256);for(let c=0;c<256;c++)for(let d=0;d<256;d++){const u=c*256+d;o[u]=t[c]^i[d],a[u]=r[c]^s[d],l[u]=n[c]<<8|n[d]}return{sbox:n,sbox2:l,T0:t,T1:i,T2:r,T3:s,T01:o,T23:a}}const Yt=is(es,n=>Kt(n,3)<<24|n<<16|n<<8|Kt(n,2)),rs=(()=>{const n=new Uint8Array(16);for(let e=0,t=1;e<16;e++,t=je(t))n[e]=t;return n})();function ns(n){I(n);const e=n.length;Zn(n);const{sbox2:t}=Yt,i=[];Ee(n)||i.push(n=re(n));const r=q(n),s=r.length,o=l=>he(t,l,l,l,l),a=new Uint32Array(e+28);a.set(r);for(let l=s;l<a.length;l++){let c=a[l-1];l%s===0?c=o(ts(c))^rs[l/s-1]:s>6&&l%s===4&&(c=o(c)),a[l]=a[l-s]^c}return U(...i),a}function Ce(n,e,t,i,r,s){return n[t<<8&65280|i>>>8&255]^e[r>>>8&65280|s>>>24&255]}function he(n,e,t,i,r){return n[e&255|t&65280]|n[i>>>16&255|r>>>16&65280]<<16}function Xt(n,e,t,i,r){const{sbox2:s,T01:o,T23:a}=Yt;let l=0;e^=n[l++],t^=n[l++],i^=n[l++],r^=n[l++];const c=n.length/4-2;for(let m=0;m<c;m++){const p=n[l++]^Ce(o,a,e,t,i,r),g=n[l++]^Ce(o,a,t,i,r,e),b=n[l++]^Ce(o,a,i,r,e,t),y=n[l++]^Ce(o,a,r,e,t,i);e=p,t=g,i=b,r=y}const d=n[l++]^he(s,e,t,i,r),u=n[l++]^he(s,t,i,r,e),h=n[l++]^he(s,i,r,e,t),f=n[l++]^he(s,r,e,t,i);return{s0:d,s1:u,s2:h,s3:f}}function Te(n,e,t,i,r){I(t,We,"nonce"),I(i),r=qn(i.length,r);const s=t,o=q(s),a=_e(s),l=q(i),c=q(r),d=e?0:12,u=i.length;let h=a.getUint32(d,e),{s0:f,s1:m,s2:p,s3:g}=Xt(n,o[0],o[1],o[2],o[3]);for(let y=0;y+4<=l.length;y+=4)c[y+0]=l[y+0]^f,c[y+1]=l[y+1]^m,c[y+2]=l[y+2]^p,c[y+3]=l[y+3]^g,h=h+1>>>0,a.setUint32(d,h,e),{s0:f,s1:m,s2:p,s3:g}=Xt(n,o[0],o[1],o[2],o[3]);const b=We*Math.floor(l.length/Jn);if(b<u){const y=new Uint32Array([f,m,p,g]),S=Bn(y);for(let v=b,k=0;v<u;v++,k++)r[v]=i[v]^S[k];U(y)}return r}function ss(n,e,t,i,r){const s=r?r.length:0,o=n.create(t,i.length+s);r&&o.update(r);const a=Un(8*i.length,8*s,e);o.update(i),o.update(a);const l=o.digest();return U(a),l}const os=Gn({blockSize:16,nonceLength:12,tagLength:16,varSizeNonce:!0},function(e,t,i){if(t.length<8)throw new Error("aes/gcm: invalid nonce length");const r=16;function s(a,l,c){const d=ss(jt,!1,a,c,i);for(let u=0;u<l.length;u++)d[u]^=l[u];return d}function o(){const a=ns(e),l=Se.slice(),c=Se.slice();if(Te(a,!1,c,c,l),t.length===12)c.set(t);else{const u=Se.slice();_e(u).setBigUint64(8,BigInt(t.length*8),!1);const f=jt.create(l).update(t).update(u);f.digestInto(c),f.destroy()}const d=Te(a,!1,c,Se);return{xk:a,authKey:l,counter:c,tagMask:d}}return{encrypt(a){const{xk:l,authKey:c,counter:d,tagMask:u}=o(),h=new Uint8Array(a.length+r),f=[l,c,d,u];Ee(a)||f.push(a=re(a)),Te(l,!1,d,a,h.subarray(0,a.length));const m=s(c,u,h.subarray(0,h.length-r));return f.push(m),h.set(m,a.length),U(...f),h},decrypt(a){const{xk:l,authKey:c,counter:d,tagMask:u}=o(),h=[l,c,u,d];Ee(a)||h.push(a=re(a));const f=a.subarray(0,-r),m=a.subarray(-r),p=s(c,u,f);if(h.push(p),!Fn(p,m))throw new Error("aes/gcm: invalid ghash tag");const g=Te(l,!1,d,f);return U(...h),g}}});/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */function as(n){return n instanceof Uint8Array||ArrayBuffer.isView(n)&&n.constructor.name==="Uint8Array"}function Ye(n,e=""){if(!Number.isSafeInteger(n)||n<0){const t=e&&`"${e}" `;throw new Error(`${t}expected integer >= 0, got ${n}`)}}function ge(n,e,t=""){const i=as(n),r=n==null?void 0:n.length,s=e!==void 0;if(!i||s&&r!==e){const o=t&&`"${t}" `,a=s?` of length ${e}`:"",l=i?`length=${r}`:`type=${typeof n}`;throw new Error(o+"expected Uint8Array"+a+", got "+l)}return n}function Xe(n){if(typeof n!="function"||typeof n.create!="function")throw new Error("Hash must wrapped by utils.createHasher");Ye(n.outputLen),Ye(n.blockLen)}function Ae(n,e=!0){if(n.destroyed)throw new Error("Hash instance has been destroyed");if(e&&n.finished)throw new Error("Hash#digest() has already been called")}function ls(n,e){ge(n,void 0,"digestInto() output");const t=e.outputLen;if(n.length<t)throw new Error('"digestInto() output" expected to be of length >='+t)}function pe(...n){for(let e=0;e<n.length;e++)n[e].fill(0)}function Je(n){return new DataView(n.buffer,n.byteOffset,n.byteLength)}function B(n,e){return n<<32-e|n>>>e}function cs(n,e={}){const t=(r,s)=>n(s).update(r).digest(),i=n(void 0);return t.outputLen=i.outputLen,t.blockLen=i.blockLen,t.create=r=>n(r),Object.assign(t,e),Object.freeze(t)}const ds=n=>({oid:Uint8Array.from([6,9,96,134,72,1,101,3,4,2,n])});class Jt{constructor(e,t){x(this,"oHash");x(this,"iHash");x(this,"blockLen");x(this,"outputLen");x(this,"finished",!1);x(this,"destroyed",!1);if(Xe(e),ge(t,void 0,"key"),this.iHash=e.create(),typeof this.iHash.update!="function")throw new Error("Expected instance of class which extends utils.Hash");this.blockLen=this.iHash.blockLen,this.outputLen=this.iHash.outputLen;const i=this.blockLen,r=new Uint8Array(i);r.set(t.length>i?e.create().update(t).digest():t);for(let s=0;s<r.length;s++)r[s]^=54;this.iHash.update(r),this.oHash=e.create();for(let s=0;s<r.length;s++)r[s]^=106;this.oHash.update(r),pe(r)}update(e){return Ae(this),this.iHash.update(e),this}digestInto(e){Ae(this),ge(e,this.outputLen,"output"),this.finished=!0,this.iHash.digestInto(e),this.oHash.update(e),this.oHash.digestInto(e),this.destroy()}digest(){const e=new Uint8Array(this.oHash.outputLen);return this.digestInto(e),e}_cloneInto(e){e||(e=Object.create(Object.getPrototypeOf(this),{}));const{oHash:t,iHash:i,finished:r,destroyed:s,blockLen:o,outputLen:a}=this;return e=e,e.finished=r,e.destroyed=s,e.blockLen=o,e.outputLen=a,e.oHash=t._cloneInto(e.oHash),e.iHash=i._cloneInto(e.iHash),e}clone(){return this._cloneInto()}destroy(){this.destroyed=!0,this.oHash.destroy(),this.iHash.destroy()}}const Qe=(n,e,t)=>new Jt(n,e).update(t).digest();Qe.create=(n,e)=>new Jt(n,e);function us(n,e,t){return Xe(n),t===void 0&&(t=new Uint8Array(n.outputLen)),Qe(n,t,e)}const Ze=Uint8Array.of(0),Qt=Uint8Array.of();function hs(n,e,t,i=32){Xe(n),Ye(i,"length");const r=n.outputLen;if(i>255*r)throw new Error("Length must be <= 255*HashLen");const s=Math.ceil(i/r);t===void 0?t=Qt:ge(t,void 0,"info");const o=new Uint8Array(s*r),a=Qe.create(n,e),l=a._cloneInto(),c=new Uint8Array(a.outputLen);for(let d=0;d<s;d++)Ze[0]=d+1,l.update(d===0?Qt:c).update(t).update(Ze).digestInto(c),o.set(c,r*d),a._cloneInto(l);return a.destroy(),l.destroy(),pe(c,Ze),o.slice(0,i)}const gs=(n,e,t,i,r)=>hs(n,us(n,e,t),i,r);function ps(n,e,t){return n&e^~n&t}function fs(n,e,t){return n&e^n&t^e&t}class ms{constructor(e,t,i,r){x(this,"blockLen");x(this,"outputLen");x(this,"padOffset");x(this,"isLE");x(this,"buffer");x(this,"view");x(this,"finished",!1);x(this,"length",0);x(this,"pos",0);x(this,"destroyed",!1);this.blockLen=e,this.outputLen=t,this.padOffset=i,this.isLE=r,this.buffer=new Uint8Array(e),this.view=Je(this.buffer)}update(e){Ae(this),ge(e);const{view:t,buffer:i,blockLen:r}=this,s=e.length;for(let o=0;o<s;){const a=Math.min(r-this.pos,s-o);if(a===r){const l=Je(e);for(;r<=s-o;o+=r)this.process(l,o);continue}i.set(e.subarray(o,o+a),this.pos),this.pos+=a,o+=a,this.pos===r&&(this.process(t,0),this.pos=0)}return this.length+=e.length,this.roundClean(),this}digestInto(e){Ae(this),ls(e,this),this.finished=!0;const{buffer:t,view:i,blockLen:r,isLE:s}=this;let{pos:o}=this;t[o++]=128,pe(this.buffer.subarray(o)),this.padOffset>r-o&&(this.process(i,0),o=0);for(let u=o;u<r;u++)t[u]=0;i.setBigUint64(r-8,BigInt(this.length*8),s),this.process(i,0);const a=Je(e),l=this.outputLen;if(l%4)throw new Error("_sha2: outputLen must be aligned to 32bit");const c=l/4,d=this.get();if(c>d.length)throw new Error("_sha2: outputLen bigger than state");for(let u=0;u<c;u++)a.setUint32(4*u,d[u],s)}digest(){const{buffer:e,outputLen:t}=this;this.digestInto(e);const i=e.slice(0,t);return this.destroy(),i}_cloneInto(e){e||(e=new this.constructor),e.set(...this.get());const{blockLen:t,buffer:i,length:r,finished:s,destroyed:o,pos:a}=this;return e.destroyed=o,e.finished=s,e.length=r,e.pos=a,r%t&&e.buffer.set(i),e}clone(){return this._cloneInto()}}const j=Uint32Array.from([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]),bs=Uint32Array.from([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]),K=new Uint32Array(64);class ys extends ms{constructor(e){super(64,e,8,!1)}get(){const{A:e,B:t,C:i,D:r,E:s,F:o,G:a,H:l}=this;return[e,t,i,r,s,o,a,l]}set(e,t,i,r,s,o,a,l){this.A=e|0,this.B=t|0,this.C=i|0,this.D=r|0,this.E=s|0,this.F=o|0,this.G=a|0,this.H=l|0}process(e,t){for(let u=0;u<16;u++,t+=4)K[u]=e.getUint32(t,!1);for(let u=16;u<64;u++){const h=K[u-15],f=K[u-2],m=B(h,7)^B(h,18)^h>>>3,p=B(f,17)^B(f,19)^f>>>10;K[u]=p+K[u-7]+m+K[u-16]|0}let{A:i,B:r,C:s,D:o,E:a,F:l,G:c,H:d}=this;for(let u=0;u<64;u++){const h=B(a,6)^B(a,11)^B(a,25),f=d+h+ps(a,l,c)+bs[u]+K[u]|0,p=(B(i,2)^B(i,13)^B(i,22))+fs(i,r,s)|0;d=c,c=l,l=a,a=o+f|0,o=s,s=r,r=i,i=f+p|0}i=i+this.A|0,r=r+this.B|0,s=s+this.C|0,o=o+this.D|0,a=a+this.E|0,l=l+this.F|0,c=c+this.G|0,d=d+this.H|0,this.set(i,r,s,o,a,l,c,d)}roundClean(){pe(K)}destroy(){this.set(0,0,0,0,0,0,0,0),pe(this.buffer)}}class vs extends ys{constructor(){super(32);x(this,"A",j[0]|0);x(this,"B",j[1]|0);x(this,"C",j[2]|0);x(this,"D",j[3]|0);x(this,"E",j[4]|0);x(this,"F",j[5]|0);x(this,"G",j[6]|0);x(this,"H",j[7]|0)}}const xs=cs(()=>new vs,ds(1)),ws=new TextEncoder().encode("guideai-sdk-encryption-v1"),ks=new TextEncoder().encode("aes-256-gcm");class _s{constructor(e,t){this.ready=!1,this.siteId=e;try{const i=new TextEncoder().encode(t);this.aesKey=gs(xs,i,ws,ks,32),this.ready=!0}catch(i){typeof console<"u"&&console.warn("[GuideAI] Encryption key derivation failed:",i),this.aesKey=new Uint8Array(0),this.ready=!1}}isReady(){return this.ready}async init(){}encrypt(e){if(!this.ready)return null;try{const t=Vn(12),i=new TextEncoder().encode(JSON.stringify(e)),s=os(this.aesKey,t).encrypt(i);return{v:2,kid:this.siteId,iv:this.toBase64Url(t),ct:this.toBase64Url(s)}}catch(t){return typeof console<"u"&&console.warn("[GuideAI] Encryption failed; sending plaintext:",t),null}}encryptToBlob(e){const t=this.encrypt(e);return t?new Blob([JSON.stringify(t)],{type:"application/json"}):null}toBase64Url(e){let t="";for(let i=0;i<e.length;i++)t+=String.fromCharCode(e[i]);return btoa(t).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}}function T(n){if(!(n instanceof HTMLElement))return console.log("[Visibility] Element is not HTMLElement"),!1;const e=getComputedStyle(n);if(e.display==="none")return console.log("[Visibility] ❌ Element hidden: display: none"),!1;if(e.visibility==="hidden")return console.log("[Visibility] ❌ Element hidden: visibility: hidden"),!1;if(e.opacity==="0")return console.log("[Visibility] ❌ Element hidden: opacity: 0"),!1;if(n.hasAttribute("hidden"))return console.log("[Visibility] ❌ Element hidden: [hidden] attribute"),!1;if(n.getAttribute("aria-hidden")==="true")return console.log('[Visibility] ❌ Element hidden: aria-hidden="true"'),!1;const t=n.getBoundingClientRect();if(t.width===0||t.height===0)return console.log(`[Visibility] ❌ Element hidden: zero size (${t.width}x${t.height})`),!1;if(n.offsetParent===null&&!["fixed","sticky","absolute"].includes(e.position)&&console.log("[Visibility] ⚠️ offsetParent is null, continuing with geometric checks"),e.opacity==="0"){const a=e.transition||"",l=e.animation||"";if(a.includes("opacity")||l)return console.log("[Visibility] ⏳ Element is animating (opacity: 0, has transition/animation)"),!1}if(e.transform&&e.transform!=="none"){if(/scale[XY]?\(0\.?0*\)/.test(e.transform))return console.log("[Visibility] ❌ Element hidden: transform: scale(0)"),!1;const a=e.transform.match(/translateX?\((-?\d+(?:\.\d+)?)(px|%)\)/);if(a){const l=parseFloat(a[1]),c=a[2];if(c==="px"&&Math.abs(l)>5e3)return console.log(`[Visibility] ❌ Element hidden: translateX(${l}px)`),!1;if(c==="%"&&Math.abs(l)>=100)return console.log(`[Visibility] ❌ Element hidden: translateX(${l}%)`),!1}}if(t.height>0&&t.height<5){const a=e.overflow||e.overflowY;if(a==="hidden"||a==="clip")return console.log(`[Visibility] ❌ Element hidden: height < 5px with overflow:${a}`),!1}if(e.pointerEvents==="none"){const a=n.tagName.toLowerCase(),l=n.getAttribute("role");(a==="button"||a==="a"||a==="input"||a==="select"||a==="textarea"||l==="button"||l==="link"||l==="tab")&&console.log(`[Visibility] ⚠️ Element has pointer-events:none but is interactive type (${a}, role=${l})`)}if(e.clipPath&&e.clipPath!=="none"&&(e.clipPath.includes("inset(100%)")||e.clipPath.includes("inset(50% 50% 50% 50%)")||/polygon\(0\D+0\D+0\D+0\D+0\D+0\D+0\D+0\)/.test(e.clipPath)))return console.log(`[Visibility] ❌ Element hidden: clip-path: ${e.clipPath}`),!1;const i=t.right<-(window.innerWidth*2),r=t.left>window.innerWidth*3,s=t.bottom<-(window.innerHeight*2),o=t.top>window.innerHeight*3;return i||r||s||o?(console.log("[Visibility] ❌ Element hidden: way off-screen (likely off-canvas menu)"),!1):(console.log("[Visibility] ✅ Element is visible (or scrollable into view)"),!0)}function Le(n){console.log("%c🔍 [Visibility] Searching for expandable ancestors...","color: #ff9800; font-weight: bold");const e=[];let t=n.parentElement,i=0;for(;t&&t!==document.body;){if(i++,t.tagName.toLowerCase(),t.tagName==="DETAILS"&&!t.open){const r=t.querySelector("summary");console.log(`[Visibility] Found collapsed <details> at depth ${i}`,{element:t,toggle:r}),e.unshift({container:t,toggle:r,kind:"details"})}else if(t.getAttribute("aria-expanded")==="false")console.log(`[Visibility] Found aria-expanded="false" at depth ${i}`,t),e.unshift({container:t,toggle:t,kind:"aria-expanded"});else if(t.id){const r=document.querySelector(`[aria-controls="${t.id}"][aria-expanded="false"]`);r&&(console.log(`[Visibility] Found aria-controls toggle at depth ${i}`,{container:t,toggle:r}),e.unshift({container:t,toggle:r,kind:"aria-expanded"}))}else if(t.getAttribute("role")==="tabpanel"&&t.getAttribute("aria-hidden")==="true"){const r=t.getAttribute("aria-labelledby"),s=r?document.getElementById(r):null;console.log(`[Visibility] Found hidden tabpanel at depth ${i}`,{container:t,tab:s}),e.unshift({container:t,toggle:s,kind:"tabpanel"})}else if(!T(t)){const r=(t.className||"").toString().toLowerCase();if(/sidebar|drawer|offcanvas|off-canvas|dropdown|popover|modal|hamburger|mobile-nav|navbar-links|menu/.test(r)){let s=null;t.id&&(s=document.querySelector(`[aria-controls="${t.id}"]`)),!s&&t.parentElement&&(s=t.parentElement.querySelector('button.navbar-toggle, button.hamburger, [aria-label*="menu" i]')),s||(console.log("[Visibility] No toggle found via parent search, trying global inference..."),s=Es(t)),console.log(`[Visibility] Found hidden container via class pattern at depth ${i}`,{container:t,classes:r,toggle:s}),e.unshift({container:t,toggle:s,kind:"class-pattern"})}}t=t.parentElement}return e.length>0?console.log(`%c✅ [Visibility] Found ${e.length} expandable ancestor(s)`,"color: #4caf50; font-weight: bold",e):console.log("[Visibility] No expandable ancestors found"),e}function Es(n){if(console.log("%c🔍 [Visibility] Inferring toggle for container","color: #ff9800; font-weight: bold",n),n.id){const r=document.querySelector(`[aria-controls="${n.id}"]`);if(r)return console.log(`[Visibility] Found toggle via aria-controls="${n.id}"`,r),r}const e=document.querySelector(`[data-toggle="${n.id}"], [data-target="${n.id}"], [data-open="${n.id}"]`);if(e)return console.log("[Visibility] Found toggle via data-* attribute",e),e;const t=(n.className||"").toLowerCase(),i=[];if(t.includes("menu")&&i.push("menu","nav","navigation"),t.includes("drawer")&&i.push("menu","open","show"),t.includes("sidebar")&&i.push("sidebar","menu","toggle"),t.includes("modal")&&i.push("open","show","modal"),t.includes("dropdown")&&i.push("open","show","dropdown"),i.length>0){const r=document.querySelectorAll('button, [role="button"], a, [role="link"]');for(const s of r){const o=(s.textContent||"").toLowerCase(),a=(s.getAttribute("aria-label")||"").toLowerCase(),l=o+" "+a;for(const c of i)if(l.includes(c))return console.log(`[Visibility] Found toggle via text similarity: "${c}" in "${o}"`,s),s}}if(n.previousElementSibling){const r=n.previousElementSibling;if(r.tagName==="BUTTON"||r.getAttribute("role")==="button")return console.log("[Visibility] Found toggle via previous sibling",r),r;const s=r.querySelector('button, [role="button"]');if(s)return console.log("[Visibility] Found toggle in previous sibling's children",s),s}return console.log("[Visibility] ⚠️ Could not infer toggle for container"),null}async function Ie(n){if(console.log(`%c🔓 [Visibility] Attempting to expand ${n.kind} container...`,"color: #ff5722; font-weight: bold",n.container),n.kind==="details"&&n.container instanceof HTMLDetailsElement){console.log("[Visibility] Opening <details> element directly"),n.container.open=!0;const t=T(n.container);return console.log(`[Visibility] <details> expansion: ${t?"✅ SUCCESS":"❌ FAILED"}`),t}const e=n.toggle??n.container;if(!e)return console.log("%c❌ [Visibility] No toggle found, cannot expand","color: #f44336"),!1;console.log("[Visibility] Clicking toggle element:",e);try{const t={bubbles:!0,cancelable:!0,composed:!0};e.dispatchEvent(new PointerEvent("pointerdown",t)),e.dispatchEvent(new MouseEvent("mousedown",t)),e.dispatchEvent(new PointerEvent("pointerup",t)),e.dispatchEvent(new MouseEvent("mouseup",t)),e.dispatchEvent(new MouseEvent("click",t)),typeof e.click=="function"&&e.click(),console.log("[Visibility] Click events dispatched, waiting for container to become visible...")}catch(t){return console.log("%c❌ [Visibility] Error dispatching click events:","color: #f44336",t),!1}for(let t=0;t<12;t++)if(await new Promise(i=>setTimeout(i,50)),T(n.container))return console.log(`%c✅ [Visibility] Container became visible after ${(t+1)*50}ms`,"color: #4caf50; font-weight: bold"),!0;return console.log("%c❌ [Visibility] Container did not become visible after 600ms","color: #f44336"),!1}const Zt=[/password/i,/passwd/i,/secret/i,/card.?number/i,/credit.?card/i,/cvv/i,/cvc/i,/ccv/i,/ssn/i,/social.?security/i,/pin/i,/token/i,/api.?key/i];class Ss{async execute(e,t){const i=e.action_config;if(this.isSensitiveField(t)){console.warn("[GuideAI] Skipping automation of sensitive field.");return}if(!(i.requires_confirmation&&!await this.showConfirmation(e)))switch(i.action_type){case"click":await this.executeClick(t);break;case"fill":await this.executeFill(t,i.fill_value??"");break;case"select":await this.executeSelect(t,i.select_value??"");break;case"scroll":await this.executeScroll(t);break;case"navigate":this.executeNavigate(i.navigate_url??"");break}}async executeClick(e){e.style.outline="2px solid #3b82f6",await this.delay(200),e.click(),e.dispatchEvent(new MouseEvent("click",{bubbles:!0})),await this.delay(100),e.style.outline=""}async executeFill(e,t){const i=e;if(!this.isSensitiveField(e)){i.focus(),i.dispatchEvent(new Event("focus",{bubbles:!0})),i.value="",i.dispatchEvent(new Event("input",{bubbles:!0}));for(let r=0;r<t.length;r++)i.value+=t[r],i.dispatchEvent(new Event("input",{bubbles:!0})),i.dispatchEvent(new KeyboardEvent("keydown",{key:t[r],bubbles:!0})),i.dispatchEvent(new KeyboardEvent("keyup",{key:t[r],bubbles:!0})),await this.delay(50);i.dispatchEvent(new Event("change",{bubbles:!0}))}}async executeSelect(e,t){const i=e;i.value=t,i.dispatchEvent(new Event("change",{bubbles:!0})),i.dispatchEvent(new Event("input",{bubbles:!0}))}async executeScroll(e){e.scrollIntoView({behavior:"smooth",block:"center"}),await this.delay(500)}executeNavigate(e){e.startsWith("/")||e.startsWith(location.origin)?window.location.href=e:window.open(e,"_blank","noopener")}isSensitiveField(e){const t=e;if(t.type==="password")return!0;const i=[t.name,t.id,t.placeholder,t.autocomplete,e.getAttribute("aria-label")??""];for(const r of i)if(r){for(const s of Zt)if(s.test(r))return!0}if(t.id){const r=document.querySelector(`label[for="${t.id}"]`);if(r!=null&&r.textContent){for(const s of Zt)if(s.test(r.textContent))return!0}}return!1}showConfirmation(e){return new Promise(t=>{const i=document.createElement("div");i.className="guideai-confirm-dialog",i.setAttribute("role","alertdialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    ...
    `,r.style.visibility="hidden",this.shadowRoot.appendChild(r),this.tooltipEl=r,this.positionTooltip(r,t),r.style.visibility="";const m=r.querySelector(".guideai-tooltip-close");m==null||m.addEventListener("click",()=>l.onDismiss());const p=r.querySelector(".guideai-tooltip-next");p==null||p.addEventListener("click",()=>l.onNext());const g=r.querySelector(".guideai-tooltip-back");g==null||g.addEventListener("click",()=>l.onPrev());const b=r.querySelector(".guideai-tooltip-skip");b==null||b.addEventListener("click",()=>l.onSkip()),Ls(r)}reposition(e){let t=null;if(e.target_selector)try{t=document.querySelector(e.target_selector)}catch{}this.tooltipEl&&this.positionTooltip(this.tooltipEl,t),this.highlightEl&&(t?this.updateHighlightPosition(t):this.removeHighlight())}renderHighlight(e){const t=ei(e,4),i=document.createElement("div");i.className="guideai-highlight",i.style.position="fixed",i.style.zIndex="2147483645",i.style.top=`${t.top}px`,i.style.left=`${t.left}px`,i.style.width=`${t.width}px`,i.style.height=`${t.height}px`,i.style.pointerEvents="none",this.shadowRoot.appendChild(i),this.highlightEl=i}updateHighlightPosition(e){if(!this.highlightEl)return;const t=ei(e,4);this.highlightEl.style.top=`${t.top}px`,this.highlightEl.style.left=`${t.left}px`,this.highlightEl.style.width=`${t.width}px`,this.highlightEl.style.height=`${t.height}px`}renderOverlay(){const e=document.createElement("div");e.className="guideai-overlay",this.shadowRoot.appendChild(e),this.overlayEl=e}removeTooltip(){et(this.tooltipEl),this.tooltipEl=null}removeHighlight(){et(this.highlightEl),this.highlightEl=null}removeOverlay(){et(this.overlayEl),this.overlayEl=null}removeAll(){this.removeTooltip(),this.removeHighlight(),this.removeOverlay()}getTooltipEl(){return this.tooltipEl}getHighlightEl(){return this.highlightEl}destroy(){this.removeAll()}positionTooltip(e,t){if(!t){As(e);return}const i=t.getBoundingClientRect(),r=260;e.style.width=`${r}px`;const s=e.getBoundingClientRect().height||160,o=Cs(i,r,s);e.style.transform="",Ts(e,o.position);const a=e.querySelector(".guideai-tooltip-arrow");a&&a.setAttribute("data-placement",o.arrowPlacement)}}const Ps={tier1:40,tier2:35,tier3:25,tier4:15,tier5:8,tier6:20};let tt=null;function Rs(n){tt=n}function le(n){if(!tt)return 1;const e=Ps[n],t=tt[n];return!e||!t?1:t/e}function it(n,e,t){const i=te(n);let r=0;const s=Hs(i,e)*le("tier1");r+=s;const o=Ns(i,e)*le("tier2");r+=o;const a=$s(i,e)*le("tier3");r+=a;const l=Ds(i,e)*le("tier4");r+=l;const c=Os(i,e)*le("tier5");r+=c;const d=Bs(i,e)*le("tier6");return r+=d,t&&(t.tier1=Math.round(s*10)/10,t.tier2=Math.round(o*10)/10,t.tier3=Math.round(a*10)/10,t.tier4=Math.round(l*10)/10,t.tier5=Math.round(c*10)/10,t.tier6=Math.round(d*10)/10),Math.min(100,Math.round(r))}function Hs(n,e){const t=n.tier1_stable,i=e.tier1_stable;let r=0;return i.data_guideai&&t.data_guideai===i.data_guideai?40:(i.data_testid&&t.data_testid===i.data_testid&&(r=Math.max(r,38)),i.id&&t.id===i.id&&(r=Math.max(r,36)),i.name&&t.name===i.name&&(r=Math.max(r,35)),i.aria_label&&t.aria_label===i.aria_label&&(r=Math.max(r,35)),r)}function Ns(n,e){const t=n.tier2_text,i=e.tier2_text;let r=0;if(i.text_content&&t.text_content&&t.text_content===i.text_content)r=Math.max(r,35);else if(i.variants.length>0&&t.text_content){const s=t.text_content.toLowerCase();for(const o of i.variants){if(o===s){r=Math.max(r,30);break}(o.includes(s)||s.includes(o))&&(r=Math.max(r,25))}}return i.placeholder&&t.placeholder===i.placeholder&&(r=Math.max(r,28)),i.label&&t.label&&t.label===i.label&&(r=Math.max(r,25)),r}function $s(n,e){const t=n.tier3_structural,i=e.tier3_structural;let r=0;i.tag&&t.tag===i.tag&&(r+=8),i.role&&t.role===i.role&&(r+=5),i.css_path&&t.css_path&&(t.css_path===i.css_path?r+=8:t.css_path.endsWith(zs(i.css_path))&&(r+=5));const s=Math.abs(t.dom_depth-i.dom_depth);return s===0?r+=4:s<=2&&(r+=2),Math.min(25,r)}function Ds(n,e){const t=n.tier4_context,i=e.tier4_context;let r=0;return i.nearest_heading&&t.nearest_heading&&(t.nearest_heading===i.nearest_heading?r+=6:t.nearest_heading.toLowerCase().includes(i.nearest_heading.toLowerCase())&&(r+=4)),i.form_context&&t.form_context===i.form_context&&(r+=5),i.parent_text&&t.parent_text&&(t.parent_text===i.parent_text?r+=4:(t.parent_text.includes(i.parent_text)||i.parent_text.includes(t.parent_text))&&(r+=2)),Math.min(15,r)}function Os(n,e){const t=n.tier5_position,i=e.tier5_position;let r=0;if(i.bounding_rect&&t.bounding_rect){const s=Fs(t.bounding_rect,i.bounding_rect);s<10?r+=8:s<50?r+=5:s<150&&(r+=3)}return i.relative_position&&t.relative_position===i.relative_position&&(r+=2),Math.min(8,r)}function Bs(n,e){if(!n.tier6_visual||!e.tier6_visual)return 0;const t=n.tier6_visual,i=e.tier6_visual;let r=0;if(i.style_hash&&bn(t.style_hash,i.style_hash)===1&&(r+=8),i.style_vector.length>0&&t.style_vector.length>0){const s=vn(t.style_vector,i.style_vector);s>=.95?r+=12:s>=.85?r+=8:s>=.7&&(r+=5)}if(i.canvas_hash&&t.canvas_hash){const s=wn(t.canvas_hash,i.canvas_hash);s>=.9?r+=10:s>=.8?r+=6:s>=.7&&(r+=3)}return Math.min(20,r)}function zs(n,e){return n.split(" > ").slice(-2).join(" > ")}function Fs(n,e){const t=n.x-e.x,i=n.y-e.y;return Math.sqrt(t*t+i*i)}const rt=50,Gs=["a","button","input","select","textarea","details","summary","label"];function ii(n,e){var l;const t=document.body;if(!t)return{element:null,score:0};const i=qs(n,t);if(i){const c={},d=it(i,n,c);if(d>=rt)return{element:i,score:d,tierScores:c}}let r=null,s=0,o={};const a=(l=n.tier3_structural)==null?void 0:l.tag;if(a){const c=t.querySelectorAll(a);for(let d=0;d<c.length;d++){const u={},h=it(c[d],n,u);h>s&&(s=h,r=c[d],o=u)}}if(s<rt){const c=Gs.join(","),d=t.querySelectorAll(c);for(let u=0;u<d.length;u++){if(a&&d[u].tagName.toLowerCase()===a)continue;const h={},f=it(d[u],n,h);f>s&&(s=f,r=d[u],o=h)}}return s>=rt?{element:r,score:s,tierScores:o}:{element:r,score:s,tierScores:o}}function qs(n,e){const t=n.tier1_stable;if(t.data_guideai){const i=e.querySelector(`[data-guideai="${nt(t.data_guideai)}"]`);if(i)return i}if(t.data_testid){const i=e.querySelector(`[data-testid="${nt(t.data_testid)}"]`);if(i)return i}if(t.id){const i=e.querySelector(`#${Us(t.id)}`);if(i)return i}if(t.name){const i=e.querySelector(`[name="${nt(t.name)}"]`);if(i)return i}return null}function nt(n){return n.replace(/["\\]/g,"\\$&")}function Us(n){return typeof CSS<"u"&&CSS.escape?CSS.escape(n):n.replace(/([^\w-])/g,"\\$1")}function Vs(n,e){if(!n||!e)return 0;const t=z(n),i=z(e);if(t===i)return 1;if(!t||!i)return 0;const r=Ws(t,i),s=js(t,i),o=Ks(t,i);return Math.min(1,r*.35+s*.4+o*.25)}function ri(n,e,t=.45){if(!n||e.length===0)return{element:null,similarity:0};let i=null,r=0;const s=z(n);console.log(`[TextSimilarity] Normalized stored text: "${s}"`),console.log(`[TextSimilarity] Threshold: ${t}, scanning ${e.length} candidates...`);for(let o=0;o<e.length;o++){const a=e[o],l=Ys(a);if(!l)continue;const c=Vs(n,l);(c>.3||o<5)&&console.log(`[TextSimilarity] Candidate ${o}: similarity=${c.toFixed(3)}, text="${l.substring(0,50)}"`),c>r&&(r=c,i=a)}return console.log(`[TextSimilarity] Best match: similarity=${r.toFixed(3)}, threshold=${t}, accepted=${r>=t}`),r>=t?{element:i,similarity:r,score:Math.round(r*100)}:{element:null,similarity:r}}function ni(n){const e=[],t=new Set,i=n.tier2_text;if(i){if(i.text_content){const o=z(i.text_content);o&&!t.has(o)&&(e.push(o),t.add(o))}if(i.placeholder){const o=z(i.placeholder);o&&!t.has(o)&&(e.push(o),t.add(o))}if(i.label){const o=z(i.label);o&&!t.has(o)&&(e.push(o),t.add(o))}if(i.variants&&Array.isArray(i.variants))for(const o of i.variants){const a=z(o);a&&!t.has(a)&&(e.push(a),t.add(a))}}const r=n.tier1_stable;if(r){if(r.aria_label){const o=z(r.aria_label);o&&!t.has(o)&&(e.push(o),t.add(o))}if(r.name){const o=z(r.name);o&&!t.has(o)&&(e.push(o),t.add(o))}}const s=n.tier4_context;if(s&&s.nearest_heading){const o=z(s.nearest_heading);o&&!t.has(o)&&(e.push(o),t.add(o))}return e.filter(Boolean).join(" ")}function z(n){return n.toLowerCase().replace(/[^\w\s]/g," ").replace(/\s+/g," ").trim()}function st(n){return new Set(n.split(" ").filter(e=>e.length>0))}function Ws(n,e){const t=st(n),i=st(e);if(t.size===0||i.size===0)return 0;let r=0;for(const o of t)i.has(o)&&r++;const s=t.size+i.size-r;return s>0?r/s:0}function js(n,e){const t=si(n),i=si(e);if(t.size===0||i.size===0)return 0;let r=0;for(const s of t)i.has(s)&&r++;return 2*r/(t.size+i.size)}function si(n){const e=new Set,t=`  ${n} `;for(let i=0;i<t.length-2;i++)e.add(t.substring(i,i+3));return e}function Ks(n,e){if(n.includes(e)||e.includes(n))return 1;const t=n.length<e.length?n:e,i=n.length<e.length?e:n,r=st(t);let s=0;for(const o of r)i.includes(o)&&s++;return r.size>0?s/r.size:0}function Ys(n){var t;const e=n;return n.getAttribute("aria-label")||n.placeholder||((t=e.textContent)==null?void 0:t.trim())||""}class Xs{constructor(e,t){this.analyzer=e,this.feedbackReporter=t}setAnalyzer(e){this.analyzer=e}findTargetElement(e,t){var s,o,a;const i=e.id??"";if(console.log(`%c🔍 [ElementFinder] Starting element search for step ${i}`,"color: #00bcd4; font-weight: bold"),console.log("[ElementFinder] Step details:",{title:e.content.title,target_selector:e.target_selector,has_fingerprint:((s=e.target_fingerprint)==null?void 0:s.total_score)>0,fingerprint_score:(o=e.target_fingerprint)==null?void 0:o.total_score,action_type:e.action_config.action_type}),this.analyzer){console.log("%c🧠 [ElementFinder] Using DeepUI Analyzer","color: #9c27b0; font-weight: bold");const l=this.analyzer.stepToIntent(e);console.log("[ElementFinder] Analyzer intent:",{text:l.text,actionType:l.actionType,tag:l.tag});const c=this.analyzer.resolveSync(l);if(console.log("[ElementFinder] Analyzer result:",{hasElement:!!c.element,score:c.score,resolvedBy:c.resolvedBy,status:c.status}),c.element){if(console.log("%c✅ [ElementFinder] Element FOUND via Analyzer!","color: #4caf50; font-weight: bold",c.element),c.resolvedBy==="fingerprint"&&this.feedbackReporter&&e.target_fingerprint){const d=te(c.element);this.feedbackReporter.reportSuccess(t,i,c.score,c.tierScores??{},e.target_fingerprint,d)}return c.element}console.log("%c⚠️ [ElementFinder] Analyzer miss, falling back to legacy path","color: #ff9800")}else console.log("[ElementFinder] No analyzer available, using legacy 4-tier fallback");if(console.log("%c📊 [ElementFinder] TIER 1: Fingerprint Matching","color: #3f51b5; font-weight: bold"),e.target_fingerprint&&e.target_fingerprint.total_score>0){console.log(`[ElementFinder] Attempting fingerprint match (score: ${e.target_fingerprint.total_score})`);const l=ii(e.target_fingerprint);if(console.log("[ElementFinder] Fingerprint result:",{found:!!l.element,score:l.score,tierScores:l.tierScores,isVisible:l.element?T(l.element):null}),l.element&&(l.score>=50||l.score>=35&&!T(l.element))){if(console.log(`%c✅ [ElementFinder] Element FOUND via Fingerprint (score: ${l.score})!`,"color: #4caf50; font-weight: bold",l.element),this.feedbackReporter){const d=te(l.element);this.feedbackReporter.reportSuccess(t,i,l.score,l.tierScores??{},e.target_fingerprint,d)}return l.element}else console.log("%c❌ [ElementFinder] Fingerprint match rejected (score too low or not acceptable)","color: #f44336");this.feedbackReporter&&!l.element&&this.feedbackReporter.reportNotFound(t,i,e.target_fingerprint)}else console.log("[ElementFinder] Skipping fingerprint (no fingerprint data or zero score)");if(console.log("%c📊 [ElementFinder] TIER 2: CSS Selector","color: #3f51b5; font-weight: bold"),e.target_selector){console.log(`[ElementFinder] Trying CSS selector: "${e.target_selector}"`);try{const l=document.querySelector(e.target_selector);if(l)return console.log("%c✅ [ElementFinder] Element FOUND via CSS Selector!","color: #4caf50; font-weight: bold",l),l;console.log("%c❌ [ElementFinder] CSS selector returned no match","color: #f44336")}catch(l){console.log("%c❌ [ElementFinder] CSS selector INVALID:","color: #f44336",l)}}else console.log("[ElementFinder] Skipping CSS selector (no target_selector provided)");if(console.log("%c📊 [ElementFinder] TIER 3: Text Similarity Matching","color: #3f51b5; font-weight: bold"),e.target_fingerprint){const l=ni(e.target_fingerprint);if(l){const d=((a=e.target_fingerprint.tier3_structural)==null?void 0:a.tag)||'a, button, input, select, textarea, [role="button"], [role="link"], [role="tab"]';console.log(`[ElementFinder] Searching for text similarity with selector: "${d}"`),console.log("[ElementFinder] Target text features:",l);try{const u=Array.from(document.querySelectorAll(d));console.log(`[ElementFinder] Found ${u.length} candidate elements`);const h=ri(l,u,.45);if(h.element)return console.log(`%c✅ [ElementFinder] Element FOUND via Text Similarity (score: ${h.score})!`,"color: #4caf50; font-weight: bold",h.element),h.element;console.log("%c❌ [ElementFinder] No text similarity match found","color: #f44336")}catch(u){console.log("%c❌ [ElementFinder] Text similarity error:","color: #f44336",u)}}else console.log("[ElementFinder] Skipping text similarity (no text features in fingerprint)")}else console.log("[ElementFinder] Skipping text similarity (no fingerprint)");console.log("%c📊 [ElementFinder] TIER 4: Text Content Search","color: #3f51b5; font-weight: bold");const r=this.findByTextContent(e);return r?console.log("%c✅ [ElementFinder] Element FOUND via Text Content Search!","color: #4caf50; font-weight: bold",r):console.log("%c❌ [ElementFinder] Text content search found nothing","color: #f44336"),r||console.log("%c❌ [ElementFinder] ALL TIERS FAILED - Element not found","color: #f44336; font-weight: bold; font-size: 14px"),r}findByTextContent(e){var s,o,a,l;const t=((s=e.content.title)==null?void 0:s.toLowerCase())||"";if(!t)return console.log("[ElementFinder] Text content search skipped (no title in step)"),null;const r=((a=(o=e.target_fingerprint)==null?void 0:o.tier3_structural)==null?void 0:a.tag)||'a, button, input, select, textarea, [role="button"], [role="link"], [role="tab"]';console.log(`[ElementFinder] Searching for text: "${t}" in selector: "${r}"`);try{const c=document.querySelectorAll(r);console.log(`[ElementFinder] Scanning ${c.length} interactive elements...`);for(let d=0;d<c.length;d++){const u=c[d],h=(u.getAttribute("aria-label")||u.placeholder||((l=u.textContent)==null?void 0:l.trim())||"").toLowerCase();if(h&&(h.includes(t)||t.includes(h)))return console.log(`[ElementFinder] Text match found at index ${d}:`,{elText:h,element:u}),u}console.log(`[ElementFinder] No text matches found in ${c.length} candidates`)}catch(c){console.log("[ElementFinder] Text content search error:",c)}return null}}const Js={pulseMs:15e3,hintMs:3e4,offerHelpMs:6e4};class Qs{constructor(e,t){this.phase="idle",this.retryCount=0,this.timers=[],this.destroyed=!1,this.onPhaseChange=e,this.thresholds={...Js,...t}}start(){this.phase="idle",this.retryCount=0,this.clearTimers(),this.timers.push(setTimeout(()=>this.transitionTo("pulse"),this.thresholds.pulseMs)),this.timers.push(setTimeout(()=>this.transitionTo("hint"),this.thresholds.hintMs)),this.timers.push(setTimeout(()=>this.transitionTo("offer_help"),this.thresholds.offerHelpMs))}recordRetry(){this.destroyed||(this.retryCount++,this.retryCount>=3&&this.phaseOrder(this.phase)<this.phaseOrder("pulse")&&this.transitionTo("pulse"),this.retryCount>=5&&this.phaseOrder(this.phase)<this.phaseOrder("hint")&&this.transitionTo("hint"))}getPhase(){return this.phase}getRetryCount(){return this.retryCount}reset(){this.clearTimers(),this.phase="idle",this.retryCount=0}destroy(){this.destroyed=!0,this.clearTimers()}transitionTo(e){this.destroyed||this.phaseOrder(e)<=this.phaseOrder(this.phase)||(this.phase=e,this.onPhaseChange(e))}phaseOrder(e){switch(e){case"idle":return 0;case"pulse":return 1;case"hint":return 2;case"offer_help":return 3}}clearTimers(){for(const e of this.timers)clearTimeout(e);this.timers=[]}}class Zs{constructor(e,t,i){this.stuckDetector=null,this.retryClickCleanup=null,this.beforeUnloadHandler=null,this.config=e,this.eventBuffer=t,this.refs=i}startStuckDetection(e,t){this.destroyStuckDetector();const i=e.action_config.stuck_thresholds;this.stuckDetector=new Qs(r=>this.handleStuckPhaseChange(r,e),i?{pulseMs:i.pulse_ms,hintMs:i.hint_ms,offerHelpMs:i.offer_help_ms}:void 0),this.stuckDetector.start(),t&&this.setupRetryClickListener(t)}handleStuckPhaseChange(e,t){var s,o;if(this.refs.isDestroyed())return;const i=_(this.config.siteId,"guide_step_stuck",{phase:e,retry_count:((s=this.stuckDetector)==null?void 0:s.getRetryCount())??0});i.guide_id=this.refs.getGuideId(),i.step_index=this.refs.getCurrentStep(),(o=this.eventBuffer)==null||o.push(i);const r=this.refs.getTooltipEl();if(r)switch(r.classList.remove("guideai-minibar--stuck-pulse","guideai-minibar--stuck-hint","guideai-minibar--stuck-offer"),e){case"pulse":r.classList.add("guideai-minibar--stuck-pulse");{const a=this.refs.getHighlightEl();a&&a.classList.add("guideai-highlight--pulse")}break;case"hint":r.classList.add("guideai-minibar--stuck-hint");{const a=r.querySelector(".guideai-minibar-hint");a&&(a.textContent=this.getHintText(t))}break;case"offer_help":r.classList.add("guideai-minibar--stuck-offer");break}}getHintText(e){switch(e.action_config.action_type){case"click":return"Try clicking the highlighted element";case"fill":return"Type in the highlighted field";case"select":return"Choose an option from the dropdown";case"navigate":return"Navigate to the indicated page";default:return"Complete the action to continue"}}setupRetryClickListener(e){this.cleanupRetryClick();const t=this.refs.getShadowRoot(),i=r=>{var o,a,l;if(this.refs.isDestroyed()||!this.stuckDetector||e.contains(r.target)||t.contains(r.target))return;this.stuckDetector.recordRetry();const s=_(this.config.siteId,"guide_step_retry",{retry_count:this.stuckDetector.getRetryCount(),clicked_tag:(a=(o=r.target)==null?void 0:o.tagName)==null?void 0:a.toLowerCase()});s.guide_id=this.refs.getGuideId(),s.step_index=this.refs.getCurrentStep(),(l=this.eventBuffer)==null||l.push(s)};document.addEventListener("click",i,!0),this.retryClickCleanup=()=>{document.removeEventListener("click",i,!0)}}cleanupRetryClick(){this.retryClickCleanup&&(this.retryClickCleanup(),this.retryClickCleanup=null)}destroyStuckDetector(){var t;(t=this.stuckDetector)==null||t.destroy(),this.stuckDetector=null,this.cleanupRetryClick();const e=this.refs.getHighlightEl();e&&e.classList.remove("guideai-highlight--pulse")}setupNavigationPrevention(){this.teardownNavigationPrevention(),this.beforeUnloadHandler=e=>{var i;const t=_(this.config.siteId,"guide_navigation_blocked");t.guide_id=this.refs.getGuideId(),t.step_index=this.refs.getCurrentStep(),(i=this.eventBuffer)==null||i.push(t),e.preventDefault(),e.returnValue=""},window.addEventListener("beforeunload",this.beforeUnloadHandler)}teardownNavigationPrevention(){this.beforeUnloadHandler&&(window.removeEventListener("beforeunload",this.beforeUnloadHandler),this.beforeUnloadHandler=null)}destroy(){this.destroyStuckDetector(),this.teardownNavigationPrevention()}}function eo(n,e){const t=n.action_config.action_type,i=n.action_config.completion_hint;switch(t){case"click":return to(e);case"fill":return io(e);case"select":return ro(e);case"navigate":return no(i);case"none":return i?so():ai();default:return ai()}}function to(n){let e=()=>{};return{promise:new Promise(i=>{if(!n){const s=()=>{i({completed:!0,detail:"document_click"})};document.addEventListener("click",s,{once:!0}),e=()=>document.removeEventListener("click",s);return}const r=()=>{i({completed:!0,detail:"target_click"})};n.addEventListener("click",r,{once:!0}),e=()=>n.removeEventListener("click",r)}),cancel:()=>e()}}function io(n){let e=()=>{};return{promise:new Promise(i=>{if(!n||!(n instanceof HTMLInputElement||n instanceof HTMLTextAreaElement)){i({completed:!0,detail:"no_input_target"});return}const r=n,s=r.value,o=()=>r.value!==s&&r.value.trim().length>0?(i({completed:!0,detail:`filled: "${r.value}"`}),!0):!1,a=()=>{o()&&r.removeEventListener("keydown",l)},l=c=>{c.key==="Enter"&&o()&&r.removeEventListener("blur",a)};r.addEventListener("blur",a),r.addEventListener("keydown",l),e=()=>{r.removeEventListener("blur",a),r.removeEventListener("keydown",l)}}),cancel:()=>e()}}function ro(n){let e=()=>{};return{promise:new Promise(i=>{if(!n){i({completed:!0,detail:"no_select_target"});return}const r=()=>{const s=n.value??"";i({completed:!0,detail:`selected: "${s}"`})};n.addEventListener("change",r,{once:!0}),e=()=>n.removeEventListener("change",r)}),cancel:()=>e()}}function no(n){let e=()=>{};const t=location.href;return{promise:new Promise(r=>{const s=()=>location.href!==t?n&&!location.pathname.includes(n)?!1:(r({completed:!0,detail:`navigated: ${location.pathname}`}),!0):!1,o=()=>{s()};window.addEventListener("popstate",o);const a=history.pushState.bind(history),l=history.replaceState.bind(history);history.pushState=function(...d){a(...d),s()},history.replaceState=function(...d){l(...d),s()};const c=setInterval(()=>{s()},500);e=()=>{window.removeEventListener("popstate",o),history.pushState=a,history.replaceState=l,clearInterval(c)}}),cancel:()=>e()}}function so(n){let e=()=>{};return{promise:new Promise(i=>{let r=!1;const s=v=>{r||(r=!0,e(),i({completed:!0,detail:v}))},o=oi(),a=location.href,l=new MutationObserver(()=>{const v=oi(),k=oo(o,v);if(k){s(`dom_changed: ${k}`);return}if(location.href!==a){s(`url_changed: ${location.pathname}`);return}});l.observe(document.body,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:["class","hidden","aria-hidden","aria-selected","aria-expanded","aria-checked","data-state","data-active","data-selected","data-count","disabled","open"]});const c=window.fetch,d=new Set(["POST","PUT","PATCH","DELETE"]);window.fetch=function(...v){var W;const k=v[0];let C="GET";typeof k=="string"||k instanceof URL?C=(((W=v[1])==null?void 0:W.method)??"GET").toUpperCase():k instanceof Request&&(C=k.method.toUpperCase());const N=c.apply(window,v);return d.has(C)&&N.then(()=>{setTimeout(()=>{r||s(`network_mutation: ${C}`)},200)}).catch(()=>{}),N};const u=XMLHttpRequest.prototype,h=u.open;let f="GET";u.open=function(v,...k){return f=v.toUpperCase(),h.apply(this,[v,...k])};const m=u.send;u.send=function(...v){return d.has(f)&&this.addEventListener("load",()=>{setTimeout(()=>{r||s(`xhr_mutation: ${f}`)},200)},{once:!0}),m.apply(this,v)};const p=v=>{const k=v.target;if(!k)return;const C=k.closest('button, a, [role="button"], input[type="submit"], [data-action]');C&&setTimeout(()=>{var N;if(!r){const W=((N=C.textContent)==null?void 0:N.trim().slice(0,50))??"";s(`user_action_click: "${W}"`)}},500)};document.addEventListener("click",p,!0);const g=history.pushState.bind(history),b=history.replaceState.bind(history),y=()=>{location.href!==a&&!r&&s(`navigated: ${location.pathname}`)};history.pushState=function(...v){g(...v),y()},history.replaceState=function(...v){b(...v),y()},window.addEventListener("popstate",y);const S=setTimeout(()=>{s("timeout")},12e4);e=()=>{l.disconnect(),document.removeEventListener("click",p,!0),window.removeEventListener("popstate",y),window.fetch=c,u.open=h,u.send=m,history.pushState=g,history.replaceState=b,clearTimeout(S)}}),cancel:()=>e()}}function oi(){var i;const n=new Map;let e=0;const t=document.querySelectorAll('span, sup, sub, small, em, strong, b, i, mark, [role="status"], [aria-live], [aria-atomic]');for(let r=0;r<t.length;r++){const s=t[r],o=((i=s.textContent)==null?void 0:i.trim())??"";if(o.length===0||o.length>10)continue;const a=ao(s);n.set(a,o),e++}return{entries:n,totalCount:e}}function oo(n,e){for(const[t,i]of n.entries){const r=e.entries.get(t);if(r!==void 0&&r!==i)return`"${i}" → "${r}" at ${t}`}if(e.totalCount>n.totalCount){for(const[t,i]of e.entries)if(!n.entries.has(t)&&(/\d/.test(i)||i.length<=3))return`new_badge: "${i}" at ${t}`}return null}function ao(n){const e=[];let t=n,i=0;for(;t&&t!==document.body&&i<4;){const r=t.tagName.toLowerCase(),s=t.id?`#${t.id}`:"",o=lo(t);e.unshift(`${r}${s}[${o}]`),t=t.parentElement,i++}return e.join(">")}function lo(n){let e=0,t=n.previousElementSibling;for(;t;)t.tagName===n.tagName&&e++,t=t.previousElementSibling;return e}function ai(){return{promise:Promise.resolve({completed:!0,detail:"manual"}),cancel:()=>{}}}class co{constructor(e,t,i,r){this.actionValidatorCancel=null,this.config=e,this.eventBuffer=t,this.stuckWiring=i,this.refs=r}renderMiniBar(e,t,i){const r=document.createElement("div");r.className="guideai-minibar",r.setAttribute("role","status"),r.setAttribute("aria-label",e.content.title??"Waiting for action");const s=this.refs.getTotalSteps(),o=this.refs.getCurrentStep(),a=(o+1)/s*100,l=o>0,c=e.action_config.allow_skip!==!1;r.innerHTML=`
    ...
    display: none;
  `,Y==null||Y.appendChild(A)),A}function Ho(n){Y=n}function No(n){const e=Ro(),t=n.getBoundingClientRect();e.style.top=`${t.top}px`,e.style.left=`${t.left}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`,e.style.display="block"}function li(){A&&(A.style.display="none")}function $o(){A&&A.parentNode&&A.parentNode.removeChild(A),A=null,Y=null}const Do="guideai-step-badge";let P=null,X=null;function Oo(){return P&&(X!=null&&X.contains(P))||(P=document.createElement("div"),P.className="guideai-badge-container",P.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 0;
    ...
    z-index: 2147483647;
    pointer-events: none;
  `,X==null||X.appendChild(P)),P}function Bo(n){X=n}function zo(n,e){const t=Oo(),i=n.getBoundingClientRect(),r=document.createElement("div");r.className=Do,r.textContent=String(e),r.style.cssText=`
    position: fixed;
    top: ${i.top-8}px;
    left: ${i.right-8}px;
    width: 24px;
    ...
    pointer-events: none;
    user-select: none;
  `,t.appendChild(r)}function ci(){P&&P.parentNode&&P.parentNode.removeChild(P),P=null}function Fo(){ci(),X=null}let fe=!1,me=null,be=0,ye=null,ve=null;function di(n){var t,i;const e=n.composedPath();for(const r of e)if(r instanceof Element&&(((t=r.tagName)==null?void 0:t.toLowerCase())==="guideai-shadow"||(i=r.classList)!=null&&i.contains("guideai-recorder")||r.shadowRoot))return!0;return!1}function ui(n){var t,i,r;if(di(n))return;const e=document.elementFromPoint(n.clientX,n.clientY);e&&((t=e.classList)!=null&&t.contains("guideai-picker-highlight")||(i=e.classList)!=null&&i.contains("guideai-badge-container")||(r=e.closest)!=null&&r.call(e,".guideai-badge-container")||e!==me&&(me=e,No(e)))}function hi(n){if(!fe||!me||di(n))return;n.preventDefault(),n.stopPropagation(),n.stopImmediatePropagation();const e=me,t=yo(e),i=Uo(e),r=Vo(e),s=Wo(e,be+1);be++,zo(e,be),li();const o={title:s,instruction:`Interact with the ${e.tagName.toLowerCase()} element`,actionType:i,targetFingerprint:t,targetPreview:r,pageUrl:window.location.href,timestamp:new Date().toISOString()};ye==null||ye(o)}function gi(n){n.key==="Escape"&&(ne(),ve==null||ve())}function Go(n,e,t,i){fe||(fe=!0,be=i??0,ye=e,ve=t??null,Ho(n),Bo(n),document.addEventListener("mousemove",ui,!0),document.addEventListener("click",hi,!0),document.addEventListener("keydown",gi,!0),document.body.style.cursor="crosshair")}function ne(){fe&&(fe=!1,me=null,ye=null,ve=null,document.removeEventListener("mousemove",ui,!0),document.removeEventListener("click",hi,!0),document.removeEventListener("keydown",gi,!0),document.body.style.cursor="",li(),$o())}function at(){ne(),ci(),Fo()}function qo(n){be=n}function Uo(n){const e=n.tagName.toLowerCase();if(e==="input"){const t=n.type.toLowerCase();return t==="submit"||t==="button"||t==="checkbox"||t==="radio"?"click":"fill"}return e==="textarea"?"fill":e==="select"?"select":e==="a"?"navigate":(e==="button"||n.getAttribute("role")==="button","click")}function Vo(n){var o;const e=n.outerHTML;if(e.length<=200)return e;const t=n.tagName.toLowerCase(),i=Array.from(n.attributes).map(a=>`${a.name}="${a.value}"`).join(" "),r=i?`<${t} ${i}>`:`<${t}>`,s=((o=n.textContent)==null?void 0:o.trim().slice(0,80))??"";return`${r}${s}...</${t}>`}function Wo(n,e){var r;const t=n.tagName.toLowerCase(),i=n.getAttribute("aria-label")??n.getAttribute("placeholder")??n.getAttribute("title")??((r=n.textContent)==null?void 0:r.trim().slice(0,40))??"";return i?`${jo(n)} "${i}"`:`Step ${e}: ${t} element`}function jo(n){const e=n.tagName.toLowerCase();return e==="input"||e==="textarea"?"Fill in":e==="select"?"Select":e==="a"?"Navigate to":"Click"}class Ko{constructor(e){this.el=null,this.stepsEl=null,this.countEl=null,this.titleInput=null,this.callbacks=null,this.saveBtn=null,this.previewBtn=null,this.shadowRoot=e}render(e){var i,r,s,o;if(this.el)return;this.callbacks=e;const t=document.createElement("div");t.className="guideai-recorder",t.setAttribute("role","dialog"),t.setAttribute("aria-label","Guide Recorder"),t.innerHTML=`
    ...
    `}submitSurvey(e,t,i,r){var o;const s=_(this.config.siteId,"survey_response",{survey_type:e,score:t,comment:i||void 0,trigger_context:r||void 0});s.element_text=i||void 0,(o=this.eventBuffer)==null||o.push(s)}remove(){this.dismissTimer&&(clearTimeout(this.dismissTimer),this.dismissTimer=null),this.el&&(this.el.remove(),this.el=null)}destroy(){this.remove()}}const Zo=n=>`guideai_guides_completed_${n}`,ea=n=>`guideai_survey_shown_${n}`;class ta{constructor(e,t,i=3){this.siteId=e,this.renderer=t,this.triggerAfterGuides=i}onGuideCompleted(){try{const e=Zo(this.siteId),t=parseInt(sessionStorage.getItem(e)||"0",10)+1;sessionStorage.setItem(e,String(t));const i=ea(this.siteId);if(sessionStorage.getItem(i))return;if(t>=this.triggerAfterGuides){const r=t===this.triggerAfterGuides?"nps":"csat";setTimeout(()=>{r==="nps"?this.renderer.showNPS("after_guide_completion"):this.renderer.showCSAT("after_guide_completion"),sessionStorage.setItem(i,"true")},2e3)}}catch{}}}const fi=n=>`guideai_usage_feedback_pageviews_${n}`;class ia{constructor(e,t,i={}){this.timer=null,this.siteId=e,this.renderer=t,this.minPageViews=Math.max(1,i.minPageViews??2),this.delayMs=Math.max(1e3,i.delayMs??3e4)}onPageView(){ct(this.siteId)||this.incrementPageViews()<this.minPageViews||(this.timer&&clearTimeout(this.timer),this.timer=setTimeout(()=>{this.timer=null,!ct(this.siteId)&&this.renderer.show(void 0,void 0,{prompt:"How is this experience so far?",title:document.title||void 0,triggerContext:"product_usage"})},this.delayMs))}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null)}incrementPageViews(){try{const t=(parseInt(sessionStorage.getItem(fi(this.siteId))||"0",10)||0)+1;return sessionStorage.setItem(fi(this.siteId),String(t)),t}catch{return this.minPageViews}}}function ra(){return`
/* ============================================================
